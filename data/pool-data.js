...
window.POOL_META = {
  ...
  totalPlayers: 54,
  capacityMax: 75,
  syncedAt: "2026-06-15T21:31:37.124Z",
...
window.POOL_PLAYERS = [
  { name: "Wolsman", matches: 104, winner: true, topscorer: true, paid: true, points: 890, prevPos: 14 },
  { name: "Kleine Flo", matches: 72, winner: true, topscorer: true, paid: true, points: 585, prevPos: 44 },
  { name: "Bertjuh", matches: 72, winner: true, topscorer: true, paid: true, points: 690, prevPos: 32 },
  { name: "Bobcorn", matches: 72, winner: true, topscorer: true, paid: true, points: 590, prevPos: 43 },
  { name: "UedaTopscorer", matches: 72, winner: true, topscorer: true, paid: true, points: 510, prevPos: 48 },
  { name: "Oppie1978", matches: 24, winner: true, topscorer: true, paid: true, points: 735, prevPos: 27 },
  { name: "El-Toro-Loco", matches: 11, winner: false, topscorer: false, paid: true, points: 650, prevPos: 38 },
  { name: "StudentjeIndicium", matches: 72, winner: true, topscorer: true, paid: true, points: 865, prevPos: 15 },
  { name: "Mauricio1980", matches: 72, winner: true, topscorer: true, paid: true, points: 605, prevPos: 41 },
  { name: "AlinevanVuuren", matches: 72, winner: true, topscorer: true, paid: true, points: 825, prevPos: 16 },
  { name: "Wisselbeker", matches: 32, winner: true, topscorer: true, paid: true, points: 905, prevPos: 13 },
  { name: "Robertosxs", matches: 104, winner: true, topscorer: true, paid: true, points: 765, prevPos: 21 },
  { name: "Reboss", matches: 72, winner: true, topscorer: true, paid: true, points: 660, prevPos: 36 },
  { name: "Mobicontrol", matches: 53, winner: true, topscorer: true, paid: true, points: 800, prevPos: 18 },
  { name: "Brokkenpiloot", matches: 24, winner: true, topscorer: true, paid: true, points: 695, prevPos: 31 },
  ...
  { name: "Fseton", matches: 24, winner: true, topscorer: true, paid: true, points: 735, prevPos: 27 },
  { name: "Raymond de Haas", matches: 17, winner: true, topscorer: true, paid: true, points: 480, prevPos: 50 },
  { name: "THEGOAT37", matches: 31, winner: true, topscorer: true, paid: true, points: 910, prevPos: 12 },
  { name: "WesleyMerwe", matches: 27, winner: true, topscorer: true, paid: true, points: 615, prevPos: 40 },
  { name: "Daisy010", matches: 26, winner: true, topscorer: true, paid: true, points: 660, prevPos: 36 },
  { name: "Erol_Ulu", matches: 72, winner: true, topscorer: true, paid: true, points: 1020, prevPos: 6 },
  { name: "Givano", matches: 72, winner: true, topscorer: true, paid: true, points: 650, prevPos: 38 },
  { name: "VanderLans", matches: 16, winner: true, topscorer: true, paid: true, points: 1000, prevPos: 7 },
  { name: "Trauner_in_Oranje", matches: 16, winner: true, topscorer: true, paid: true, points: 775, prevPos: 20 },
  { name: "Keepertje", matches: 72, winner: true, topscorer: true, paid: true, points: 680, prevPos: 34 },
  { name: "John0504", matches: 72, winner: true, topscorer: true, paid: true, points: 495, prevPos: 49 },
  { name: "Rugnummer67", matches: 16, winner: true, topscorer: true, paid: true, points: 595, prevPos: 42 },
  { name: "Norman.P", matches: 16, winner: true, topscorer: true, paid: true, points: 1135, prevPos: 4 },
  { name: "StanleyBoessen", matches: 72, winner: false, topscorer: false, paid: true, points: 745, prevPos: 22 },
  { name: "GonnyDebode", matches: 72, winner: true, topscorer: true, paid: true, points: 720, prevPos: 29 },
  { name: "Marlayne", matches: 33, winner: true, topscorer: true, paid: true, points: 745, prevPos: 22 },
  { name: "Jules-", matches: 72, winner: true, topscorer: true, paid: true, points: 680, prevPos: 34 },
  { name: "Harro1", matches: 72, winner: true, topscorer: true, paid: true, points: 690, prevPos: 32 },
  { name: "JRHJNB", matches: 72, winner: true, topscorer: true, paid: true, points: 740, prevPos: 24 },
  { name: "JoycevanRiet", matches: 72, winner: true, topscorer: true, paid: true, points: 440, prevPos: 51 },
  { name: "Heer", matches: 72, winner: true, topscorer: true, paid: true, points: 795, prevPos: 19 },
  { name: "Pepijndh", matches: 0, winner: false, topscorer: false, paid: true, points: 0, prevPos: 53 },
  { name: "Cornelis2026", matches: 29, winner: true, topscorer: true, paid: true, points: 545, prevPos: 47 },
  { name: "Wkkipje", matches: 19, winner: true, topscorer: true, paid: true, points: 940, prevPos: 8 },
  { name: "MaureenGLA", matches: 72, winner: true, topscorer: true, paid: true, points: 715, prevPos: 30 },
  { name: "GeorgeV.", matches: 72, winner: true, topscorer: true, paid: true, points: 1300, prevPos: 1 },
  { name: "ikgajuichen", matches: 104, winner: true, topscorer: true, paid: true, points: 925, prevPos: 11 },
  { name: "JanCandiano", matches: 72, winner: true, topscorer: true, paid: true, points: 805, prevPos: 17 },
  { name: "Bo.", matches: 72, winner: true, topscorer: true, paid: true, points: 585, prevPos: 44 },
  { name: "Koninkie", matches: 72, winner: true, topscorer: true, paid: true, points: 1085, prevPos: 5 },
  { name: "Martijnmeestervoorspeller", matches: 72, winner: true, topscorer: true, paid: true, points: 940, prevPos: 8 },
  { name: "Crazy Dutchman", matches: 72, winner: true, topscorer: true, paid: true, points: 940, prevPos: 8 },
  { name: "RoanTuit(messi)", matches: 14, winner: true, topscorer: true, paid: true, points: 740, prevPos: 24 },
  ...
  { name: "WillemCo", matches: 23, winner: false, topscorer: false, paid: true, points: 740, prevPos: 24 },
