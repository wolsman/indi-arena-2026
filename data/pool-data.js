...
window.POOL_META = {
  ...
  totalPlayers: 52,
  capacityMax: 75,
  syncedAt: "2026-06-17T22:25:09.018Z",
...
window.POOL_PLAYERS = [
  { name: "Wolsman", matches: 104, winner: true, topscorer: true, paid: true, points: 1430, prevPos: 16 },
  { name: "Kleine Flo", matches: 72, winner: true, topscorer: true, paid: true, points: 1125, prevPos: 42 },
  { name: "Bertjuh", matches: 72, winner: true, topscorer: true, paid: true, points: 1370, prevPos: 23 },
  { name: "Bobcorn", matches: 72, winner: true, topscorer: true, paid: true, points: 1090, prevPos: 40 },
  { name: "UedaTopscorer", matches: 72, winner: true, topscorer: true, paid: true, points: 965, prevPos: 47 },
  { name: "Oppie1978", matches: 24, winner: true, topscorer: true, paid: true, points: 1440, prevPos: 10 },
  ...
  { name: "Mauricio1980", matches: 72, winner: true, topscorer: true, paid: true, points: 1140, prevPos: 41 },
  { name: "AlinevanVuuren", matches: 72, winner: true, topscorer: true, paid: true, points: 1485, prevPos: 14 },
  { name: "Wisselbeker", matches: 32, winner: true, topscorer: true, paid: true, points: 1635, prevPos: 2 },
  { name: "Robertosxs", matches: 104, winner: true, topscorer: true, paid: true, points: 1345, prevPos: 25 },
  { name: "Reboss", matches: 72, winner: true, topscorer: true, paid: true, points: 1055, prevPos: 44 },
  { name: "Mobicontrol-Xavier", matches: 53, winner: true, topscorer: true, paid: true, points: 1420, prevPos: 18 },
  { name: "Brokkenpiloot", matches: 53, winner: true, topscorer: true, paid: true, points: 1410, prevPos: 19 },
  ...
  { name: "Fseton", matches: 45, winner: true, topscorer: true, paid: true, points: 1170, prevPos: 38 },
  { name: "Raymond de Haas", matches: 29, winner: true, topscorer: true, paid: true, points: 895, prevPos: 50 },
  { name: "THEGOAT37", matches: 45, winner: true, topscorer: true, paid: true, points: 1465, prevPos: 14 },
  { name: "WesleyMerwe", matches: 27, winner: true, topscorer: true, paid: true, points: 1050, prevPos: 45 },
  { name: "Daisy010", matches: 30, winner: true, topscorer: true, paid: true, points: 1295, prevPos: 29 },
  { name: "Erol_Ulu", matches: 72, winner: true, topscorer: true, paid: true, points: 1640, prevPos: 3 },
  { name: "Givano", matches: 72, winner: true, topscorer: true, paid: true, points: 1410, prevPos: 19 },
  { name: "JanvdL", matches: 24, winner: true, topscorer: true, paid: true, points: 1705, prevPos: 1 },
  { name: "Trauner_in_Oranje", matches: 24, winner: true, topscorer: true, paid: true, points: 1155, prevPos: 32 },
  { name: "Keepertje", matches: 72, winner: true, topscorer: true, paid: true, points: 1005, prevPos: 43 },
  { name: "John0504", matches: 72, winner: true, topscorer: true, paid: true, points: 990, prevPos: 46 },
  { name: "Rugnummer67", matches: 25, winner: true, topscorer: true, paid: true, points: 1480, prevPos: 12 },
  { name: "Norman.P", matches: 26, winner: true, topscorer: true, paid: true, points: 1570, prevPos: 7 },
  { name: "StanleyBoessen", matches: 72, winner: false, topscorer: false, paid: true, points: 1170, prevPos: 33 },
  { name: "GonnyDebode", matches: 72, winner: true, topscorer: true, paid: true, points: 1220, prevPos: 30 },
  { name: "Marlayne", matches: 37, winner: true, topscorer: true, paid: true, points: 1100, prevPos: 37 },
  { name: "Jules-", matches: 72, winner: true, topscorer: true, paid: true, points: 1220, prevPos: 34 },
  { name: "Harro1", matches: 72, winner: true, topscorer: true, paid: true, points: 1170, prevPos: 38 },
  { name: "JRHJNB", matches: 72, winner: true, topscorer: true, paid: true, points: 1260, prevPos: 31 },
  { name: "JoycevanRiet", matches: 72, winner: true, topscorer: true, paid: true, points: 1180, prevPos: 36 },
  { name: "Heer", matches: 72, winner: true, topscorer: true, paid: true, points: 1315, prevPos: 21 },
  ...
  { name: "MaureenGLA", matches: 72, winner: true, topscorer: true, paid: true, points: 1310, prevPos: 28 },
  { name: "GeorgeV.", matches: 72, winner: true, topscorer: true, paid: true, points: 1620, prevPos: 4 },
  { name: "ikgajuichen", matches: 104, winner: true, topscorer: true, paid: true, points: 1370, prevPos: 23 },
  { name: "JanCandiano", matches: 72, winner: true, topscorer: true, paid: true, points: 1340, prevPos: 26 },
  ...
  { name: "Martijnmeestervoorspeller", matches: 72, winner: true, topscorer: true, paid: true, points: 1425, prevPos: 17 },
  { name: "Crazy Dutchman", matches: 72, winner: true, topscorer: true, paid: true, points: 1595, prevPos: 6 },
  { name: "RoanTuit(messi)", matches: 20, winner: true, topscorer: true, paid: true, points: 1140, prevPos: 35 },
  { name: "Christopheramboz", matches: 34, winner: true, topscorer: true, paid: true, points: 1525, prevPos: 9 },
  { name: "WillemCo", matches: 30, winner: false, topscorer: false, paid: true, points: 1400, prevPos: 22 },
