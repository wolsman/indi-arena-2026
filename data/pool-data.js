...
window.POOL_META = {
  ...
  totalPlayers: 52,
  capacityMax: 75,
  syncedAt: "2026-06-30T20:01:29.593Z",
...
window.POOL_PLAYERS = [
  { name: "Wolsman", matches: 104, winner: true, topscorer: true, paid: true, points: 5720, prevPos: 4 },
  { name: "Kleine Flo", matches: 82, winner: true, topscorer: true, paid: true, points: 5250, prevPos: 18 },
  { name: "Bertjuh", matches: 88, winner: true, topscorer: true, paid: true, points: 4635, prevPos: 39 },
  { name: "Bobcorn", matches: 89, winner: true, topscorer: true, paid: true, points: 5190, prevPos: 22 },
  { name: "UedaTopscorer", matches: 88, winner: true, topscorer: true, paid: true, points: 4490, prevPos: 42 },
  { name: "Oppie1978", matches: 87, winner: true, topscorer: true, paid: true, points: 5495, prevPos: 10 },
  { name: "El-Toro-Loco", matches: 80, winner: false, topscorer: false, paid: true, points: 4965, prevPos: 27 },
  { name: "StudentjeIndicium", matches: 72, winner: true, topscorer: true, paid: true, points: 4475, prevPos: 43 },
  { name: "Mauricio1980", matches: 88, winner: true, topscorer: true, paid: true, points: 5400, prevPos: 14 },
  { name: "AlinevanVuuren", matches: 88, winner: true, topscorer: true, paid: true, points: 4880, prevPos: 30 },
  { name: "Wisselbeker", matches: 88, winner: true, topscorer: true, paid: true, points: 5275, prevPos: 17 },
  { name: "Robertosxs", matches: 104, winner: true, topscorer: true, paid: true, points: 5850, prevPos: 2 },
  { name: "Reboss", matches: 72, winner: true, topscorer: true, paid: true, points: 4880, prevPos: 30 },
  { name: "Mobicontrol-van-Riet", matches: 91, winner: true, topscorer: true, paid: true, points: 5965, prevPos: 1 },
  { name: "Brokkenpiloot", matches: 88, winner: true, topscorer: true, paid: true, points: 5030, prevPos: 25 },
  { name: "Katinkadeb", matches: 88, winner: true, topscorer: true, paid: true, points: 4595, prevPos: 41 },
  { name: "BornBjorg", matches: 71, winner: true, topscorer: true, paid: true, points: 4620, prevPos: 40 },
  { name: "Fseton", matches: 88, winner: true, topscorer: true, paid: true, points: 4730, prevPos: 36 },
  { name: "Raymond de Haas", matches: 88, winner: true, topscorer: true, paid: true, points: 5305, prevPos: 16 },
  { name: "THEGOAT37", matches: 88, winner: true, topscorer: true, paid: true, points: 5795, prevPos: 3 },
  { name: "WesleyMerwe", matches: 87, winner: true, topscorer: true, paid: true, points: 5420, prevPos: 13 },
  { name: "Daisy010", matches: 87, winner: true, topscorer: true, paid: true, points: 5225, prevPos: 19 },
  { name: "Erol_Ulu", matches: 88, winner: true, topscorer: true, paid: true, points: 5515, prevPos: 9 },
  { name: "Givano", matches: 88, winner: true, topscorer: true, paid: true, points: 5685, prevPos: 6 },
  { name: "JanvdL", matches: 80, winner: true, topscorer: true, paid: true, points: 5490, prevPos: 11 },
  { name: "Trauner_in_Oranje", matches: 79, winner: true, topscorer: true, paid: true, points: 4935, prevPos: 28 },
  ...
  { name: "Norman.P", matches: 77, winner: true, topscorer: true, paid: true, points: 5390, prevPos: 15 },
  { name: "StanleyBoessen", matches: 72, winner: false, topscorer: false, paid: true, points: 4175, prevPos: 48 },
  { name: "GonnyDebode", matches: 88, winner: true, topscorer: true, paid: true, points: 4140, prevPos: 50 },
  { name: "Marlayne", matches: 88, winner: true, topscorer: true, paid: true, points: 4200, prevPos: 47 },
  { name: "Jules-", matches: 89, winner: true, topscorer: true, paid: true, points: 5655, prevPos: 7 },
  { name: "Harro1", matches: 72, winner: true, topscorer: true, paid: true, points: 4865, prevPos: 32 },
  { name: "JRHJNB", matches: 88, winner: true, topscorer: true, paid: true, points: 5040, prevPos: 24 },
  { name: "JoycevanRiet", matches: 87, winner: true, topscorer: true, paid: true, points: 4350, prevPos: 44 },
  { name: "Heer", matches: 87, winner: true, topscorer: true, paid: true, points: 5435, prevPos: 12 },
  { name: "Cornelis2026", matches: 87, winner: true, topscorer: true, paid: true, points: 4145, prevPos: 49 },
  { name: "Wkkipje", matches: 82, winner: true, topscorer: true, paid: true, points: 4735, prevPos: 35 },
  { name: "MaureenGLA", matches: 88, winner: true, topscorer: true, paid: true, points: 4725, prevPos: 37 },
  { name: "GeorgeV.", matches: 82, winner: true, topscorer: true, paid: true, points: 5645, prevPos: 8 },
  { name: "ikgajuichen", matches: 104, winner: true, topscorer: true, paid: true, points: 4830, prevPos: 33 },
  { name: "JanCandiano", matches: 88, winner: true, topscorer: true, paid: true, points: 5010, prevPos: 26 },
  { name: "Bo.", matches: 86, winner: true, topscorer: true, paid: true, points: 5200, prevPos: 21 },
  { name: "Koninkie", matches: 88, winner: true, topscorer: true, paid: true, points: 5715, prevPos: 5 },
  { name: "Martijnmeestervoorspeller", matches: 87, winner: true, topscorer: true, paid: true, points: 5225, prevPos: 19 },
  { name: "Crazy Dutchman", matches: 86, winner: true, topscorer: true, paid: true, points: 5170, prevPos: 23 },
  { name: "RoanTuit(messi)", matches: 57, winner: true, topscorer: true, paid: true, points: 4080, prevPos: 51 },
  { name: "Christopheramboz", matches: 88, winner: true, topscorer: true, paid: true, points: 4915, prevPos: 29 },
  { name: "WillemCo", matches: 75, winner: false, topscorer: false, paid: true, points: 4220, prevPos: 46 },
  { name: "Nelson1983", matches: 75, winner: false, topscorer: false, paid: true, points: 4235, prevPos: 45 }
];
