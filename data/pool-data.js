...
window.POOL_META = {
  ...
  totalPlayers: 56,
  capacityMax: 75,
  syncedAt: "2026-06-14T22:31:18.147Z",
...
window.POOL_PLAYERS = [
  { name: "Wolsman", matches: 104, winner: true, topscorer: true, paid: true, points: 810, prevPos: 7 },
  { name: "Kleine Flo", matches: 72, winner: true, topscorer: true, paid: true, points: 470, prevPos: 38 },
  { name: "Bertjuh", matches: 72, winner: true, topscorer: true, paid: true, points: 650, prevPos: 15 },
  { name: "Bobcorn", matches: 72, winner: true, topscorer: true, paid: true, points: 475, prevPos: 37 },
  { name: "UedaTopscorer", matches: 72, winner: true, topscorer: true, paid: true, points: 395, prevPos: 46 },
  { name: "Oppie1978", matches: 24, winner: true, topscorer: true, paid: true, points: 600, prevPos: 25 },
  { name: "El-Toro-Loco", matches: 11, winner: false, topscorer: false, paid: true, points: 630, prevPos: 19 },
  { name: "StudentjeIndicium", matches: 72, winner: true, topscorer: true, paid: true, points: 730, prevPos: 19 },
  { name: "Mauricio1980", matches: 72, winner: true, topscorer: true, paid: true, points: 545, prevPos: 28 },
  { name: "AlinevanVuuren", matches: 72, winner: true, topscorer: true, paid: true, points: 510, prevPos: 35 },
  { name: "Wisselbeker", matches: 26, winner: true, topscorer: true, paid: true, points: 790, prevPos: 8 },
  { name: "Roantuit", matches: 0, winner: false, topscorer: false, paid: true, points: 0, prevPos: 51 },
  { name: "Robertosxs", matches: 104, winner: true, topscorer: true, paid: true, points: 650, prevPos: 15 },
  { name: "Reboss", matches: 72, winner: true, topscorer: true, paid: true, points: 525, prevPos: 31 },
  { name: "Mobicontrol", matches: 53, winner: true, topscorer: true, paid: true, points: 610, prevPos: 22 },
  { name: "Brokkenpiloot", matches: 24, winner: true, topscorer: true, paid: true, points: 560, prevPos: 27 },
  { name: "Katinkadeb", matches: 72, winner: true, topscorer: true, paid: true, points: 470, prevPos: 38 },
  { name: "BornBjorg", matches: 24, winner: true, topscorer: true, paid: true, points: 885, prevPos: 3 },
  { name: "Fseton", matches: 24, winner: true, topscorer: true, paid: true, points: 545, prevPos: 28 },
  { name: "Raymond de Haas", matches: 14, winner: true, topscorer: true, paid: true, points: 420, prevPos: 45 },
  { name: "ScheidsTon", matches: 0, winner: false, topscorer: false, paid: true, points: 0, prevPos: 51 },
  { name: "THEGOAT37", matches: 31, winner: true, topscorer: true, paid: true, points: 650, prevPos: 15 },
  { name: "WesleyMerwe", matches: 27, winner: true, topscorer: true, paid: true, points: 460, prevPos: 48 },
  { name: "Daisy010", matches: 18, winner: true, topscorer: true, paid: true, points: 365, prevPos: 47 },
  { name: "Erol_Ulu", matches: 72, winner: true, topscorer: true, paid: true, points: 885, prevPos: 9 },
  { name: "Givano", matches: 72, winner: true, topscorer: true, paid: true, points: 440, prevPos: 43 },
  { name: "VanderLans", matches: 15, winner: true, topscorer: true, paid: true, points: 865, prevPos: 4 },
  { name: "Trauner_in_Oranje", matches: 12, winner: true, topscorer: true, paid: true, points: 620, prevPos: 21 },
  { name: "Keepertje", matches: 72, winner: true, topscorer: true, paid: true, points: 345, prevPos: 50 },
  { name: "John0504", matches: 72, winner: true, topscorer: true, paid: true, points: 360, prevPos: 48 },
  { name: "Rugnummer67", matches: 16, winner: true, topscorer: true, paid: true, points: 460, prevPos: 42 },
  { name: "Norman.P", matches: 13, winner: true, topscorer: true, paid: true, points: 1040, prevPos: 2 },
  { name: "StanleyBoessen", matches: 72, winner: false, topscorer: false, paid: true, points: 665, prevPos: 14 },
  { name: "GonnyDebode", matches: 72, winner: true, topscorer: true, paid: true, points: 525, prevPos: 31 },
  { name: "Marlayne", matches: 33, winner: true, topscorer: true, paid: true, points: 570, prevPos: 38 },
  { name: "Jules-", matches: 72, winner: true, topscorer: true, paid: true, points: 545, prevPos: 28 },
  { name: "Harro1", matches: 72, winner: true, topscorer: true, paid: true, points: 610, prevPos: 22 },
  { name: "JRHJNB", matches: 72, winner: true, topscorer: true, paid: true, points: 625, prevPos: 31 },
  { name: "JoycevanRiet", matches: 72, winner: true, topscorer: true, paid: true, points: 0, prevPos: 51 },
  { name: "Heer", matches: 72, winner: true, topscorer: true, paid: true, points: 755, prevPos: 11 },
  { name: "Pepijndh", matches: 0, winner: false, topscorer: false, paid: true, points: 0, prevPos: 51 },
  { name: "Cornelis2026", matches: 29, winner: true, topscorer: true, paid: true, points: 485, prevPos: 36 },
  { name: "Wkkipje", matches: 19, winner: true, topscorer: true, paid: true, points: 645, prevPos: 18 },
  { name: "MaureenGLA", matches: 72, winner: true, topscorer: true, paid: true, points: 600, prevPos: 25 },
  { name: "GeorgeV.", matches: 72, winner: true, topscorer: true, paid: true, points: 805, prevPos: 13 },
  { name: "ikgajuichen", matches: 104, winner: true, topscorer: true, paid: true, points: 810, prevPos: 12 },
  { name: "JanCandiano", matches: 72, winner: true, topscorer: true, paid: true, points: 435, prevPos: 44 },
  { name: "Bo.", matches: 72, winner: true, topscorer: true, paid: true, points: 525, prevPos: 31 },
  { name: "Koninkie", matches: 72, winner: true, topscorer: true, paid: true, points: 770, prevPos: 10 },
  { name: "Martijnmeestervoorspeller", matches: 72, winner: true, topscorer: true, paid: true, points: 825, prevPos: 5 },
  { name: "Crazy Dutchman", matches: 72, winner: true, topscorer: true, paid: true, points: 825, prevPos: 5 },
  { name: "RoanTuit(messi)", matches: 13, winner: true, topscorer: true, paid: true, points: 605, prevPos: 24 },
  { name: "Christopheramboz", matches: 17, winner: true, topscorer: true, paid: true, points: 1005, prevPos: 1 },
