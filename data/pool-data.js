...
window.POOL_META = {
  ...
  totalPlayers: 52,
  capacityMax: 75,
  syncedAt: "2026-06-21T18:09:27.269Z",
...
window.POOL_PLAYERS = [
  ...
  { name: "Kleine Flo", matches: 72, winner: true, topscorer: true, paid: true, points: 2330, prevPos: 31 },
  { name: "Bertjuh", matches: 72, winner: true, topscorer: true, paid: true, points: 2490, prevPos: 19 },
  { name: "Bobcorn", matches: 72, winner: true, topscorer: true, paid: true, points: 2385, prevPos: 25 },
  ...
  { name: "AlinevanVuuren", matches: 72, winner: true, topscorer: true, paid: true, points: 2480, prevPos: 22 },
  { name: "Wisselbeker", matches: 48, winner: true, topscorer: true, paid: true, points: 2780, prevPos: 6 },
  { name: "Robertosxs", matches: 104, winner: true, topscorer: true, paid: true, points: 2580, prevPos: 16 },
  ...
  { name: "Katinkadeb", matches: 72, winner: true, topscorer: true, paid: true, points: 2485, prevPos: 27 },
  { name: "BornBjorg", matches: 24, winner: true, topscorer: true, paid: true, points: 1710, prevPos: 49 },
  { name: "Fseton", matches: 50, winner: true, topscorer: true, paid: true, points: 2330, prevPos: 31 },
  { name: "Raymond de Haas", matches: 46, winner: true, topscorer: true, paid: true, points: 2400, prevPos: 26 },
  { name: "THEGOAT37", matches: 70, winner: true, topscorer: true, paid: true, points: 2600, prevPos: 20 },
  { name: "WesleyMerwe", matches: 43, winner: true, topscorer: true, paid: true, points: 2235, prevPos: 35 },
  { name: "Daisy010", matches: 50, winner: true, topscorer: true, paid: true, points: 2395, prevPos: 24 },
  ...
  { name: "Trauner_in_Oranje", matches: 40, winner: true, topscorer: true, paid: true, points: 2340, prevPos: 28 },
  { name: "Keepertje", matches: 72, winner: true, topscorer: true, paid: true, points: 1675, prevPos: 50 },
  ...
  { name: "Norman.P", matches: 37, winner: true, topscorer: true, paid: true, points: 2645, prevPos: 13 },
  ...
  { name: "JRHJNB", matches: 72, winner: true, topscorer: true, paid: true, points: 2440, prevPos: 29 },
  ...
  { name: "Wkkipje", matches: 38, winner: true, topscorer: true, paid: true, points: 2185, prevPos: 36 },
  { name: "MaureenGLA", matches: 72, winner: true, topscorer: true, paid: true, points: 2315, prevPos: 29 },
  { name: "GeorgeV.", matches: 72, winner: true, topscorer: true, paid: true, points: 2765, prevPos: 7 },
  { name: "ikgajuichen", matches: 104, winner: true, topscorer: true, paid: true, points: 2610, prevPos: 14 },
  { name: "JanCandiano", matches: 72, winner: true, topscorer: true, paid: true, points: 2470, prevPos: 21 },
  { name: "Bo.", matches: 72, winner: true, topscorer: true, paid: true, points: 2285, prevPos: 34 },
  { name: "Koninkie", matches: 72, winner: true, topscorer: true, paid: true, points: 2635, prevPos: 11 },
  { name: "Martijnmeestervoorspeller", matches: 72, winner: true, topscorer: true, paid: true, points: 2765, prevPos: 5 },
  { name: "Crazy Dutchman", matches: 72, winner: true, topscorer: true, paid: true, points: 3095, prevPos: 1 },
  { name: "RoanTuit(messi)", matches: 30, winner: true, topscorer: true, paid: true, points: 1670, prevPos: 51 },
  { name: "Christopheramboz", matches: 42, winner: true, topscorer: true, paid: true, points: 2530, prevPos: 17 },
  { name: "WillemCo", matches: 41, winner: false, topscorer: false, paid: true, points: 2065, prevPos: 40 },
  { name: "Nelson1983", matches: 34, winner: false, topscorer: false, paid: true, points: 1730, prevPos: 52 }
];
