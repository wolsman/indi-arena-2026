...
window.POOL_META = {
  ...
  totalPlayers: 55,
  capacityMax: 75,
  syncedAt: "2026-06-12T19:01:35.424Z",
...
window.POOL_PLAYERS = [
  ...
  { name: "UedaTopscorer", matches: 72, winner: true, topscorer: true, paid: true, points: 220, prevPos: 9 },
  { name: "Oppie1978", matches: 24, winner: true, topscorer: true, paid: true, points: 115, prevPos: 29 },
  { name: "El-Toro-Loco", matches: 11, winner: false, topscorer: false, paid: true, points: 95, prevPos: 41 },
  { name: "StudentjeIndicium", matches: 72, winner: true, topscorer: true, paid: true, points: 220, prevPos: 9 },
  { name: "Mauricio1980", matches: 72, winner: true, topscorer: true, paid: true, points: 220, prevPos: 9 },
  { name: "AlinevanVuuren", matches: 72, winner: true, topscorer: true, paid: true, points: 115, prevPos: 29 },
  { name: "Wisselbeker", matches: 10, winner: true, topscorer: true, paid: true, points: 200, prevPos: 23 },
  { name: "Roantuit", matches: 0, winner: false, topscorer: false, paid: true, points: 0, prevPos: 51 },
  { name: "Robertosxs", matches: 104, winner: true, topscorer: true, paid: true, points: 220, prevPos: 9 },
  { name: "Reboss", matches: 72, winner: true, topscorer: true, paid: true, points: 220, prevPos: 9 },
  { name: "Mobicontrol", matches: 53, winner: true, topscorer: true, paid: true, points: 220, prevPos: 9 },
  { name: "Brokkenpiloot", matches: 17, winner: true, topscorer: true, paid: true, points: 295, prevPos: 6 },
  { name: "Katinkadeb", matches: 72, winner: true, topscorer: true, paid: true, points: 220, prevPos: 9 },
  { name: "BornBjorg", matches: 24, winner: true, topscorer: true, paid: true, points: 95, prevPos: 41 },
  { name: "Fseton", matches: 10, winner: true, topscorer: true, paid: true, points: 115, prevPos: 29 },
  { name: "Raymond de Haas", matches: 14, winner: true, topscorer: true, paid: true, points: 115, prevPos: 29 },
  { name: "ScheidsTon", matches: 0, winner: false, topscorer: false, paid: true, points: 0, prevPos: 51 },
  { name: "THEGOAT37", matches: 31, winner: true, topscorer: true, paid: true, points: 115, prevPos: 29 },
  ...
  { name: "Erol_Ulu", matches: 72, winner: true, topscorer: true, paid: true, points: 220, prevPos: 9 },
  { name: "Givano", matches: 72, winner: true, topscorer: true, paid: true, points: 115, prevPos: 29 },
  { name: "VanderLans", matches: 9, winner: true, topscorer: true, paid: true, points: 95, prevPos: 41 },
  ...
  { name: "Rugnummer67", matches: 5, winner: true, topscorer: true, paid: true, points: 115, prevPos: 29 },
  { name: "Norman.P", matches: 4, winner: true, topscorer: true, paid: true, points: 295, prevPos: 6 },
  { name: "StanleyBoessen", matches: 72, winner: false, topscorer: false, paid: true, points: 95, prevPos: 41 },
  { name: "GonnyDebode", matches: 72, winner: true, topscorer: true, paid: true, points: 200, prevPos: 23 },
  { name: "Marlayne", matches: 26, winner: true, topscorer: true, paid: true, points: 95, prevPos: 41 },
  { name: "Jules-", matches: 72, winner: true, topscorer: true, paid: true, points: 40, prevPos: 48 },
  { name: "Harro1", matches: 72, winner: true, topscorer: true, paid: true, points: 200, prevPos: 23 },
  { name: "JRHJNB", matches: 72, winner: true, topscorer: true, paid: true, points: 220, prevPos: 9 },
  { name: "JoycevanRiet", matches: 72, winner: true, topscorer: true, paid: true, points: 115, prevPos: 29 },
  { name: "Heer", matches: 72, winner: true, topscorer: true, paid: true, points: 220, prevPos: 9 },
  ...
  { name: "Wkkipje", matches: 10, winner: true, topscorer: true, paid: true, points: 220, prevPos: 9 },
  { name: "MaureenGLA", matches: 72, winner: true, topscorer: true, paid: true, points: 115, prevPos: 29 },
  { name: "GeorgeV.", matches: 72, winner: true, topscorer: true, paid: true, points: 115, prevPos: 29 },
  { name: "ikgajuichen", matches: 104, winner: true, topscorer: true, paid: true, points: 400, prevPos: 1 },
  { name: "JanCandiano", matches: 20, winner: true, topscorer: true, paid: true, points: 170, prevPos: 27 },
  { name: "Bo.", matches: 72, winner: true, topscorer: true, paid: true, points: 220, prevPos: 9 },
  { name: "Koninkie", matches: 72, winner: true, topscorer: true, paid: true, points: 115, prevPos: 29 },
  { name: "Martijnmeestervoorspeller", matches: 72, winner: true, topscorer: true, paid: true, points: 400, prevPos: 1 },
  { name: "Crazy Dutchman", matches: 72, winner: true, topscorer: true, paid: true, points: 400, prevPos: 1 },
  { name: "RoanTuit(messi)", matches: 7, winner: true, topscorer: true, paid: true, points: 220, prevPos: 9 },
  { name: "Christopheramboz", matches: 9, winner: true, topscorer: true, paid: true, points: 400, prevPos: 1 },
  { name: "Frenk010fr", matches: 0, winner: false, topscorer: false, paid: false, points: 0, prevPos: 51 },
  { name: "WillemCo", matches: 8, winner: false, topscorer: false, paid: false, points: 0, prevPos: 51 }
];
