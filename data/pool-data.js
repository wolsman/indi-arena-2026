...
window.POOL_META = {
  ...
  totalPlayers: 52,
  capacityMax: 75,
  syncedAt: "2026-06-19T04:01:37.773Z",
...
window.POOL_PLAYERS = [
  { name: "Wolsman", matches: 104, winner: true, topscorer: true, paid: true, points: 1715, prevPos: 21 },
  { name: "Kleine Flo", matches: 72, winner: true, topscorer: true, paid: true, points: 1560, prevPos: 39 },
  { name: "Bertjuh", matches: 72, winner: true, topscorer: true, paid: true, points: 1730, prevPos: 26 },
  { name: "Bobcorn", matches: 72, winner: true, topscorer: true, paid: true, points: 1755, prevPos: 24 },
  { name: "UedaTopscorer", matches: 72, winner: true, topscorer: true, paid: true, points: 1325, prevPos: 49 },
  { name: "Oppie1978", matches: 37, winner: true, topscorer: true, paid: true, points: 2095, prevPos: 6 },
  { name: "El-Toro-Loco", matches: 21, winner: false, topscorer: false, paid: true, points: 1240, prevPos: 51 },
  { name: "StudentjeIndicium", matches: 72, winner: true, topscorer: true, paid: true, points: 1775, prevPos: 17 },
  { name: "Mauricio1980", matches: 72, winner: true, topscorer: true, paid: true, points: 1570, prevPos: 33 },
  { name: "AlinevanVuuren", matches: 72, winner: true, topscorer: true, paid: true, points: 1715, prevPos: 21 },
  { name: "Wisselbeker", matches: 32, winner: true, topscorer: true, paid: true, points: 1920, prevPos: 9 },
  { name: "Robertosxs", matches: 104, winner: true, topscorer: true, paid: true, points: 1765, prevPos: 20 },
  { name: "Reboss", matches: 72, winner: true, topscorer: true, paid: true, points: 1360, prevPos: 47 },
  { name: "Mobicontrol-Xavier", matches: 53, winner: true, topscorer: true, paid: true, points: 1760, prevPos: 18 },
  { name: "Brokkenpiloot", matches: 53, winner: true, topscorer: true, paid: true, points: 1970, prevPos: 10 },
  { name: "Katinkadeb", matches: 72, winner: true, topscorer: true, paid: true, points: 1685, prevPos: 23 },
  { name: "BornBjorg", matches: 24, winner: true, topscorer: true, paid: true, points: 1710, prevPos: 15 },
  { name: "Fseton", matches: 45, winner: true, topscorer: true, paid: true, points: 1635, prevPos: 29 },
  { name: "Raymond de Haas", matches: 42, winner: true, topscorer: true, paid: true, points: 1525, prevPos: 38 },
  { name: "THEGOAT37", matches: 45, winner: true, topscorer: true, paid: true, points: 1580, prevPos: 25 },
  { name: "WesleyMerwe", matches: 31, winner: true, topscorer: true, paid: true, points: 1505, prevPos: 42 },
  { name: "Daisy010", matches: 40, winner: true, topscorer: true, paid: true, points: 1780, prevPos: 19 },
  { name: "Erol_Ulu", matches: 72, winner: true, topscorer: true, paid: true, points: 2020, prevPos: 4 },
  { name: "Givano", matches: 72, winner: true, topscorer: true, paid: true, points: 2170, prevPos: 3 },
  { name: "JanvdL", matches: 27, winner: true, topscorer: true, paid: true, points: 2065, prevPos: 7 },
  { name: "Trauner_in_Oranje", matches: 28, winner: true, topscorer: true, paid: true, points: 1590, prevPos: 36 },
  { name: "Keepertje", matches: 72, winner: true, topscorer: true, paid: true, points: 1180, prevPos: 50 },
  { name: "John0504", matches: 72, winner: true, topscorer: true, paid: true, points: 1350, prevPos: 48 },
  { name: "Rugnummer67", matches: 33, winner: true, topscorer: true, paid: true, points: 1925, prevPos: 11 },
  { name: "Norman.P", matches: 28, winner: true, topscorer: true, paid: true, points: 1930, prevPos: 13 },
  { name: "StanleyBoessen", matches: 72, winner: false, topscorer: false, paid: true, points: 1505, prevPos: 32 },
  { name: "GonnyDebode", matches: 72, winner: true, topscorer: true, paid: true, points: 1430, prevPos: 41 },
  { name: "Marlayne", matches: 37, winner: true, topscorer: true, paid: true, points: 1310, prevPos: 46 },
  { name: "Jules-", matches: 72, winner: true, topscorer: true, paid: true, points: 1560, prevPos: 35 },
  { name: "Harro1", matches: 72, winner: true, topscorer: true, paid: true, points: 1380, prevPos: 40 },
  { name: "JRHJNB", matches: 72, winner: true, topscorer: true, paid: true, points: 1565, prevPos: 34 },
  { name: "JoycevanRiet", matches: 72, winner: true, topscorer: true, paid: true, points: 1370, prevPos: 44 },
  { name: "Heer", matches: 72, winner: true, topscorer: true, paid: true, points: 1900, prevPos: 15 },
  { name: "Cornelis2026", matches: 42, winner: true, topscorer: true, paid: true, points: 1495, prevPos: 36 },
  { name: "Wkkipje", matches: 24, winner: true, topscorer: true, paid: true, points: 1625, prevPos: 28 },
  { name: "MaureenGLA", matches: 72, winner: true, topscorer: true, paid: true, points: 1650, prevPos: 30 },
  { name: "GeorgeV.", matches: 72, winner: true, topscorer: true, paid: true, points: 2030, prevPos: 2 },
  { name: "ikgajuichen", matches: 104, winner: true, topscorer: true, paid: true, points: 2000, prevPos: 8 },
  { name: "JanCandiano", matches: 72, winner: true, topscorer: true, paid: true, points: 1720, prevPos: 27 },
  { name: "Bo.", matches: 72, winner: true, topscorer: true, paid: true, points: 1445, prevPos: 44 },
  { name: "Koninkie", matches: 72, winner: true, topscorer: true, paid: true, points: 1890, prevPos: 11 },
  { name: "Martijnmeestervoorspeller", matches: 72, winner: true, topscorer: true, paid: true, points: 2110, prevPos: 5 },
  ...
  { name: "Christopheramboz", matches: 34, winner: true, topscorer: true, paid: true, points: 1885, prevPos: 14 },
  { name: "WillemCo", matches: 30, winner: false, topscorer: false, paid: true, points: 1515, prevPos: 31 },
