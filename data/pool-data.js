...
window.POOL_META = {
  ...
  totalPlayers: 52,
  capacityMax: 75,
  syncedAt: "2026-06-21T14:33:27.782Z",
...
window.POOL_PLAYERS = [
  ...
  { name: "Kleine Flo", matches: 72, winner: true, topscorer: true, paid: true, points: 2235, prevPos: 31 },
  { name: "Bertjuh", matches: 72, winner: true, topscorer: true, paid: true, points: 2415, prevPos: 19 },
  { name: "Bobcorn", matches: 72, winner: true, topscorer: true, paid: true, points: 2310, prevPos: 25 },
  { name: "UedaTopscorer", matches: 72, winner: true, topscorer: true, paid: true, points: 1735, prevPos: 48 },
  { name: "Oppie1978", matches: 52, winner: true, topscorer: true, paid: true, points: 2625, prevPos: 9 },
  { name: "El-Toro-Loco", matches: 33, winner: false, topscorer: false, paid: true, points: 1925, prevPos: 42 },
  { name: "StudentjeIndicium", matches: 72, winner: true, topscorer: true, paid: true, points: 2230, prevPos: 33 },
  { name: "Mauricio1980", matches: 72, winner: true, topscorer: true, paid: true, points: 2370, prevPos: 23 },
  { name: "AlinevanVuuren", matches: 72, winner: true, topscorer: true, paid: true, points: 2385, prevPos: 22 },
  { name: "Wisselbeker", matches: 48, winner: true, topscorer: true, paid: true, points: 2685, prevPos: 6 },
  { name: "Robertosxs", matches: 104, winner: true, topscorer: true, paid: true, points: 2505, prevPos: 16 },
  { name: "Reboss", matches: 72, winner: true, topscorer: true, paid: true, points: 2055, prevPos: 38 },
  { name: "Mobicontrol-Xavier", matches: 53, winner: true, topscorer: true, paid: true, points: 2560, prevPos: 11 },
  { name: "Brokkenpiloot", matches: 53, winner: true, topscorer: true, paid: true, points: 2665, prevPos: 8 },
  { name: "Katinkadeb", matches: 72, winner: true, topscorer: true, paid: true, points: 2285, prevPos: 27 },
  ...
  { name: "Givano", matches: 72, winner: true, topscorer: true, paid: true, points: 2705, prevPos: 3 },
  { name: "JanvdL", matches: 40, winner: true, topscorer: true, paid: true, points: 2615, prevPos: 10 },
  { name: "Trauner_in_Oranje", matches: 40, winner: true, topscorer: true, paid: true, points: 2245, prevPos: 28 },
  { name: "Keepertje", matches: 72, winner: true, topscorer: true, paid: true, points: 1580, prevPos: 50 },
  { name: "John0504", matches: 72, winner: true, topscorer: true, paid: true, points: 1860, prevPos: 45 },
  { name: "Rugnummer67", matches: 42, winner: true, topscorer: true, paid: true, points: 2435, prevPos: 18 },
  { name: "Norman.P", matches: 37, winner: true, topscorer: true, paid: true, points: 2550, prevPos: 13 },
  { name: "StanleyBoessen", matches: 72, winner: false, topscorer: false, paid: true, points: 2010, prevPos: 39 },
  { name: "GonnyDebode", matches: 72, winner: true, topscorer: true, paid: true, points: 1875, prevPos: 44 },
  { name: "Marlayne", matches: 60, winner: true, topscorer: true, paid: true, points: 1770, prevPos: 47 },
  { name: "Jules-", matches: 72, winner: true, topscorer: true, paid: true, points: 2110, prevPos: 36 },
  { name: "Harro1", matches: 72, winner: true, topscorer: true, paid: true, points: 1885, prevPos: 43 },
  { name: "JRHJNB", matches: 72, winner: true, topscorer: true, paid: true, points: 2240, prevPos: 29 },
  { name: "JoycevanRiet", matches: 72, winner: true, topscorer: true, paid: true, points: 1970, prevPos: 41 },
  { name: "Heer", matches: 72, winner: true, topscorer: true, paid: true, points: 2700, prevPos: 4 },
  { name: "Cornelis2026", matches: 42, winner: true, topscorer: true, paid: true, points: 1835, prevPos: 46 },
  { name: "Wkkipje", matches: 38, winner: true, topscorer: true, paid: true, points: 2110, prevPos: 36 },
  { name: "MaureenGLA", matches: 72, winner: true, topscorer: true, paid: true, points: 2240, prevPos: 29 },
  { name: "GeorgeV.", matches: 72, winner: true, topscorer: true, paid: true, points: 2670, prevPos: 7 },
  { name: "ikgajuichen", matches: 104, winner: true, topscorer: true, paid: true, points: 2515, prevPos: 14 },
  { name: "JanCandiano", matches: 72, winner: true, topscorer: true, paid: true, points: 2395, prevPos: 21 },
  ...
  { name: "WillemCo", matches: 41, winner: false, topscorer: false, paid: true, points: 1990, prevPos: 40 },
