...
window.POOL_META = {
  ...
  totalPlayers: 52,
  capacityMax: 75,
  syncedAt: "2026-06-20T22:20:38.009Z",
...
window.POOL_PLAYERS = [
  { name: "Wolsman", matches: 104, winner: true, topscorer: true, paid: true, points: 2400, prevPos: 19 },
  { name: "Kleine Flo", matches: 72, winner: true, topscorer: true, paid: true, points: 2140, prevPos: 34 },
  { name: "Bertjuh", matches: 72, winner: true, topscorer: true, paid: true, points: 2395, prevPos: 20 },
  { name: "Bobcorn", matches: 72, winner: true, topscorer: true, paid: true, points: 2135, prevPos: 27 },
  { name: "UedaTopscorer", matches: 72, winner: true, topscorer: true, paid: true, points: 1715, prevPos: 50 },
  { name: "Oppie1978", matches: 52, winner: true, topscorer: true, paid: true, points: 2530, prevPos: 6 },
  { name: "El-Toro-Loco", matches: 33, winner: false, topscorer: false, paid: true, points: 1810, prevPos: 43 },
  { name: "StudentjeIndicium", matches: 72, winner: true, topscorer: true, paid: true, points: 2135, prevPos: 27 },
  { name: "Mauricio1980", matches: 72, winner: true, topscorer: true, paid: true, points: 2255, prevPos: 22 },
  { name: "AlinevanVuuren", matches: 72, winner: true, topscorer: true, paid: true, points: 2210, prevPos: 23 },
  { name: "Wisselbeker", matches: 48, winner: true, topscorer: true, paid: true, points: 2490, prevPos: 9 },
  { name: "Robertosxs", matches: 104, winner: true, topscorer: true, paid: true, points: 2410, prevPos: 13 },
  { name: "Reboss", matches: 72, winner: true, topscorer: true, paid: true, points: 1940, prevPos: 39 },
  ...
  { name: "BornBjorg", matches: 24, winner: true, topscorer: true, paid: true, points: 1710, prevPos: 44 },
  { name: "Fseton", matches: 50, winner: true, topscorer: true, paid: true, points: 2120, prevPos: 36 },
  { name: "Raymond de Haas", matches: 46, winner: true, topscorer: true, paid: true, points: 2190, prevPos: 24 },
  { name: "THEGOAT37", matches: 45, winner: true, topscorer: true, paid: true, points: 2285, prevPos: 25 },
  { name: "WesleyMerwe", matches: 43, winner: true, topscorer: true, paid: true, points: 2045, prevPos: 32 },
  { name: "Daisy010", matches: 50, winner: true, topscorer: true, paid: true, points: 2125, prevPos: 30 },
  { name: "Erol_Ulu", matches: 72, winner: true, topscorer: true, paid: true, points: 2705, prevPos: 2 },
  { name: "Givano", matches: 72, winner: true, topscorer: true, paid: true, points: 2530, prevPos: 6 },
  { name: "JanvdL", matches: 40, winner: true, topscorer: true, paid: true, points: 2520, prevPos: 8 },
  { name: "Trauner_in_Oranje", matches: 36, winner: true, topscorer: true, paid: true, points: 2130, prevPos: 29 },
  ...
  { name: "Rugnummer67", matches: 42, winner: true, topscorer: true, paid: true, points: 2340, prevPos: 16 },
  { name: "Norman.P", matches: 34, winner: true, topscorer: true, paid: true, points: 2455, prevPos: 10 },
  { name: "StanleyBoessen", matches: 72, winner: false, topscorer: false, paid: true, points: 1935, prevPos: 37 },
  { name: "GonnyDebode", matches: 72, winner: true, topscorer: true, paid: true, points: 1755, prevPos: 47 },
  { name: "Marlayne", matches: 47, winner: true, topscorer: true, paid: true, points: 1650, prevPos: 48 },
  { name: "Jules-", matches: 72, winner: true, topscorer: true, paid: true, points: 2015, prevPos: 34 },
  { name: "Harro1", matches: 72, winner: true, topscorer: true, paid: true, points: 1885, prevPos: 41 },
  { name: "JRHJNB", matches: 72, winner: true, topscorer: true, paid: true, points: 2125, prevPos: 30 },
  { name: "JoycevanRiet", matches: 72, winner: true, topscorer: true, paid: true, points: 1770, prevPos: 46 },
  ...
  { name: "Wkkipje", matches: 38, winner: true, topscorer: true, paid: true, points: 2035, prevPos: 33 },
  { name: "MaureenGLA", matches: 72, winner: true, topscorer: true, paid: true, points: 2240, prevPos: 21 },
  { name: "GeorgeV.", matches: 72, winner: true, topscorer: true, paid: true, points: 2555, prevPos: 11 },
  { name: "ikgajuichen", matches: 104, winner: true, topscorer: true, paid: true, points: 2400, prevPos: 14 },
  { name: "JanCandiano", matches: 72, winner: true, topscorer: true, paid: true, points: 2300, prevPos: 18 },
  { name: "Bo.", matches: 72, winner: true, topscorer: true, paid: true, points: 2075, prevPos: 38 },
  { name: "Koninkie", matches: 72, winner: true, topscorer: true, paid: true, points: 2365, prevPos: 15 },
  ...
  { name: "RoanTuit(messi)", matches: 24, winner: true, topscorer: true, paid: true, points: 1575, prevPos: 48 },
  { name: "Christopheramboz", matches: 42, winner: true, topscorer: true, paid: true, points: 2340, prevPos: 16 },
