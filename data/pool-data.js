...
window.POOL_META = {
  ...
  totalPlayers: 52,
  capacityMax: 75,
  syncedAt: "2026-06-30T08:42:11.807Z",
...
window.POOL_PLAYERS = [
  { name: "Wolsman", matches: 104, winner: true, topscorer: true, paid: true, points: 5520, prevPos: 12 },
  { name: "Kleine Flo", matches: 82, winner: true, topscorer: true, paid: true, points: 5050, prevPos: 33 },
  { name: "Bertjuh", matches: 88, winner: true, topscorer: true, paid: true, points: 4635, prevPos: 37 },
  { name: "Bobcorn", matches: 88, winner: true, topscorer: true, paid: true, points: 4990, prevPos: 24 },
  { name: "UedaTopscorer", matches: 88, winner: true, topscorer: true, paid: true, points: 4290, prevPos: 45 },
  { name: "Oppie1978", matches: 87, winner: true, topscorer: true, paid: true, points: 5295, prevPos: 5 },
  { name: "El-Toro-Loco", matches: 71, winner: false, topscorer: false, paid: true, points: 4765, prevPos: 38 },
  { name: "StudentjeIndicium", matches: 72, winner: true, topscorer: true, paid: true, points: 4475, prevPos: 32 },
  { name: "Mauricio1980", matches: 88, winner: true, topscorer: true, paid: true, points: 5305, prevPos: 22 },
  { name: "AlinevanVuuren", matches: 88, winner: true, topscorer: true, paid: true, points: 4785, prevPos: 34 },
  { name: "Wisselbeker", matches: 88, winner: true, topscorer: true, paid: true, points: 5075, prevPos: 8 },
  { name: "Robertosxs", matches: 104, winner: true, topscorer: true, paid: true, points: 5650, prevPos: 19 },
  { name: "Reboss", matches: 72, winner: true, topscorer: true, paid: true, points: 4880, prevPos: 27 },
  { name: "Mobicontrol-van-Riet", matches: 91, winner: true, topscorer: true, paid: true, points: 5870 },
  { name: "Brokkenpiloot", matches: 88, winner: true, topscorer: true, paid: true, points: 5010, prevPos: 10 },
  { name: "Katinkadeb", matches: 88, winner: true, topscorer: true, paid: true, points: 4595, prevPos: 29 },
  { name: "BornBjorg", matches: 71, winner: true, topscorer: true, paid: true, points: 4420, prevPos: 52 },
  { name: "Fseton", matches: 88, winner: true, topscorer: true, paid: true, points: 4530, prevPos: 28 },
  { name: "Raymond de Haas", matches: 81, winner: true, topscorer: true, paid: true, points: 5105, prevPos: 17 },
  { name: "THEGOAT37", matches: 88, winner: true, topscorer: true, paid: true, points: 5775, prevPos: 11 },
  { name: "WesleyMerwe", matches: 87, winner: true, topscorer: true, paid: true, points: 5220, prevPos: 25 },
  { name: "Daisy010", matches: 87, winner: true, topscorer: true, paid: true, points: 5225, prevPos: 15 },
  { name: "Erol_Ulu", matches: 88, winner: true, topscorer: true, paid: true, points: 5495, prevPos: 1 },
  { name: "Givano", matches: 88, winner: true, topscorer: true, paid: true, points: 5485, prevPos: 2 },
  { name: "JanvdL", matches: 75, winner: true, topscorer: true, paid: true, points: 5395, prevPos: 3 },
  { name: "Trauner_in_Oranje", matches: 76, winner: true, topscorer: true, paid: true, points: 4840, prevPos: 16 },
  { name: "Keepertje", matches: 88, winner: true, topscorer: true, paid: true, points: 3495, prevPos: 51 },
  { name: "John0504", matches: 88, winner: true, topscorer: true, paid: true, points: 4690, prevPos: 42 },
  { name: "Rugnummer67", matches: 84, winner: true, topscorer: true, paid: true, points: 4575, prevPos: 30 },
  { name: "Norman.P", matches: 75, winner: true, topscorer: true, paid: true, points: 5315, prevPos: 13 },
  { name: "StanleyBoessen", matches: 72, winner: false, topscorer: false, paid: true, points: 4175, prevPos: 43 },
  { name: "GonnyDebode", matches: 88, winner: true, topscorer: true, paid: true, points: 4065, prevPos: 46 },
  { name: "Marlayne", matches: 88, winner: true, topscorer: true, paid: true, points: 4180, prevPos: 49 },
  { name: "Jules-", matches: 89, winner: true, topscorer: true, paid: true, points: 5455, prevPos: 26 },
  { name: "Harro1", matches: 72, winner: true, topscorer: true, paid: true, points: 4865, prevPos: 40 },
  { name: "JRHJNB", matches: 88, winner: true, topscorer: true, paid: true, points: 4840, prevPos: 31 },
  { name: "JoycevanRiet", matches: 87, winner: true, topscorer: true, paid: true, points: 4255, prevPos: 47 },
  { name: "Heer", matches: 87, winner: true, topscorer: true, paid: true, points: 5415, prevPos: 5 },
  { name: "Cornelis2026", matches: 87, winner: true, topscorer: true, paid: true, points: 4145, prevPos: 44 },
  ...
  { name: "GeorgeV.", matches: 79, winner: true, topscorer: true, paid: true, points: 5445, prevPos: 18 },
  { name: "ikgajuichen", matches: 104, winner: true, topscorer: true, paid: true, points: 4810, prevPos: 23 },
  { name: "JanCandiano", matches: 88, winner: true, topscorer: true, paid: true, points: 4915, prevPos: 19 },
  { name: "Bo.", matches: 78, winner: true, topscorer: true, paid: true, points: 5000, prevPos: 34 },
  { name: "Koninkie", matches: 88, winner: true, topscorer: true, paid: true, points: 5695, prevPos: 7 },
  { name: "Martijnmeestervoorspeller", matches: 87, winner: true, topscorer: true, paid: true, points: 5205, prevPos: 14 },
  { name: "Crazy Dutchman", matches: 86, winner: true, topscorer: true, paid: true, points: 5150, prevPos: 8 },
  { name: "RoanTuit(messi)", matches: 57, winner: true, topscorer: true, paid: true, points: 4080, prevPos: 48 },
  { name: "Christopheramboz", matches: 88, winner: true, topscorer: true, paid: true, points: 4915, prevPos: 21 },
  { name: "WillemCo", matches: 74, winner: false, topscorer: false, paid: true, points: 4145, prevPos: 41 },
  { name: "Nelson1983", matches: 75, winner: false, topscorer: false, paid: true, points: 4035, prevPos: 50 }
];
