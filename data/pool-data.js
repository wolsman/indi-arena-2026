...
window.POOL_META = {
  ...
  totalPlayers: 52,
  capacityMax: 75,
  syncedAt: "2026-06-19T21:19:48.734Z",
...
window.POOL_PLAYERS = [
  { name: "Wolsman", matches: 104, winner: true, topscorer: true, paid: true, points: 1810, prevPos: 23 },
  { name: "Kleine Flo", matches: 72, winner: true, topscorer: true, paid: true, points: 1655, prevPos: 34 },
  { name: "Bertjuh", matches: 72, winner: true, topscorer: true, paid: true, points: 1825, prevPos: 21 },
  ...
  { name: "Oppie1978", matches: 52, winner: true, topscorer: true, paid: true, points: 2170, prevPos: 4 },
  ...
  { name: "Mauricio1980", matches: 72, winner: true, topscorer: true, paid: true, points: 1665, prevPos: 32 },
  { name: "AlinevanVuuren", matches: 72, winner: true, topscorer: true, paid: true, points: 1810, prevPos: 23 },
  { name: "Wisselbeker", matches: 48, winner: true, topscorer: true, paid: true, points: 2120, prevPos: 12 },
  { name: "Robertosxs", matches: 104, winner: true, topscorer: true, paid: true, points: 1965, prevPos: 18 },
  { name: "Reboss", matches: 72, winner: true, topscorer: true, paid: true, points: 1455, prevPos: 46 },
  { name: "Mobicontrol-Xavier", matches: 53, winner: true, topscorer: true, paid: true, points: 1855, prevPos: 19 },
  { name: "Brokkenpiloot", matches: 53, winner: true, topscorer: true, paid: true, points: 2065, prevPos: 9 },
  { name: "Katinkadeb", matches: 72, winner: true, topscorer: true, paid: true, points: 1885, prevPos: 26 },
  ...
  { name: "THEGOAT37", matches: 45, winner: true, topscorer: true, paid: true, points: 1675, prevPos: 31 },
  { name: "WesleyMerwe", matches: 43, winner: true, topscorer: true, paid: true, points: 1705, prevPos: 38 },
  { name: "Daisy010", matches: 50, winner: true, topscorer: true, paid: true, points: 1800, prevPos: 16 },
  { name: "Erol_Ulu", matches: 72, winner: true, topscorer: true, paid: true, points: 2220, prevPos: 7 },
  ...
  { name: "Trauner_in_Oranje", matches: 32, winner: true, topscorer: true, paid: true, points: 1685, prevPos: 30 },
  ...
  { name: "Rugnummer67", matches: 33, winner: true, topscorer: true, paid: true, points: 2000, prevPos: 11 },
  { name: "Norman.P", matches: 32, winner: true, topscorer: true, paid: true, points: 2025, prevPos: 10 },
  { name: "StanleyBoessen", matches: 72, winner: false, topscorer: false, paid: true, points: 1600, prevPos: 38 },
  { name: "GonnyDebode", matches: 72, winner: true, topscorer: true, paid: true, points: 1525, prevPos: 43 },
  { name: "Marlayne", matches: 37, winner: true, topscorer: true, paid: true, points: 1385, prevPos: 49 },
  { name: "Jules-", matches: 72, winner: true, topscorer: true, paid: true, points: 1655, prevPos: 34 },
  { name: "Harro1", matches: 72, winner: true, topscorer: true, paid: true, points: 1475, prevPos: 44 },
  { name: "JRHJNB", matches: 72, winner: true, topscorer: true, paid: true, points: 1660, prevPos: 33 },
  { name: "JoycevanRiet", matches: 72, winner: true, topscorer: true, paid: true, points: 1465, prevPos: 45 },
  { name: "Heer", matches: 72, winner: true, topscorer: true, paid: true, points: 2100, prevPos: 13 },
  { name: "Cornelis2026", matches: 42, winner: true, topscorer: true, paid: true, points: 1590, prevPos: 40 },
  { name: "Wkkipje", matches: 24, winner: true, topscorer: true, paid: true, points: 1645, prevPos: 29 },
  { name: "MaureenGLA", matches: 72, winner: true, topscorer: true, paid: true, points: 1850, prevPos: 27 },
  { name: "GeorgeV.", matches: 72, winner: true, topscorer: true, paid: true, points: 2125, prevPos: 6 },
  { name: "ikgajuichen", matches: 104, winner: true, topscorer: true, paid: true, points: 2000, prevPos: 8 },
  { name: "JanCandiano", matches: 72, winner: true, topscorer: true, paid: true, points: 1815, prevPos: 22 },
  { name: "Bo.", matches: 72, winner: true, topscorer: true, paid: true, points: 1645, prevPos: 42 },
  { name: "Koninkie", matches: 72, winner: true, topscorer: true, paid: true, points: 1985, prevPos: 14 },
  { name: "Martijnmeestervoorspeller", matches: 72, winner: true, topscorer: true, paid: true, points: 2130, prevPos: 3 },
  ...
  { name: "WillemCo", matches: 30, winner: false, topscorer: false, paid: true, points: 1590, prevPos: 37 },
