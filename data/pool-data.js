...
window.POOL_META = {
  ...
  totalPlayers: 55,
  capacityMax: 75,
  syncedAt: "2026-06-14T06:31:33.137Z",
...
window.POOL_PLAYERS = [
  { name: "Wolsman", matches: 104, winner: true, topscorer: true, paid: true, points: 715, prevPos: 3 },
  { name: "Kleine Flo", matches: 72, winner: true, topscorer: true, paid: true, points: 375, prevPos: 36 },
  { name: "Bertjuh", matches: 72, winner: true, topscorer: true, paid: true, points: 555, prevPos: 15 },
  { name: "Bobcorn", matches: 72, winner: true, topscorer: true, paid: true, points: 455, prevPos: 27 },
  { name: "UedaTopscorer", matches: 72, winner: true, topscorer: true, paid: true, points: 300, prevPos: 45 },
  { name: "Oppie1978", matches: 24, winner: true, topscorer: true, paid: true, points: 305, prevPos: 44 },
  { name: "El-Toro-Loco", matches: 11, winner: false, topscorer: false, paid: true, points: 535, prevPos: 22 },
  { name: "StudentjeIndicium", matches: 72, winner: true, topscorer: true, paid: true, points: 535, prevPos: 17 },
  { name: "Mauricio1980", matches: 72, winner: true, topscorer: true, paid: true, points: 450, prevPos: 28 },
  { name: "AlinevanVuuren", matches: 72, winner: true, topscorer: true, paid: true, points: 290, prevPos: 48 },
  ...
  { name: "Mobicontrol", matches: 53, winner: true, topscorer: true, paid: true, points: 515, prevPos: 22 },
  { name: "Brokkenpiloot", matches: 24, winner: true, topscorer: true, paid: true, points: 465, prevPos: 26 },
  { name: "Katinkadeb", matches: 72, winner: true, topscorer: true, paid: true, points: 375, prevPos: 39 },
  { name: "BornBjorg", matches: 24, winner: true, topscorer: true, paid: true, points: 610, prevPos: 12 },
  { name: "Fseton", matches: 17, winner: true, topscorer: true, paid: true, points: 450, prevPos: 28 },
  { name: "Raymond de Haas", matches: 14, winner: true, topscorer: true, paid: true, points: 345, prevPos: 41 },
  { name: "ScheidsTon", matches: 0, winner: false, topscorer: false, paid: true, points: 0, prevPos: 51 },
  { name: "THEGOAT37", matches: 31, winner: true, topscorer: true, paid: true, points: 575, prevPos: 14 },
  { name: "WesleyMerwe", matches: 27, winner: true, topscorer: true, paid: true, points: 285, prevPos: 46 },
  { name: "Daisy010", matches: 15, winner: true, topscorer: true, paid: true, points: 250, prevPos: 49 },
  { name: "Erol_Ulu", matches: 72, winner: true, topscorer: true, paid: true, points: 710, prevPos: 4 },
  { name: "Givano", matches: 72, winner: true, topscorer: true, paid: true, points: 345, prevPos: 41 },
  { name: "VanderLans", matches: 11, winner: true, topscorer: true, paid: true, points: 590, prevPos: 13 },
  { name: "Trauner_in_Oranje", matches: 8, winner: true, topscorer: true, paid: true, points: 545, prevPos: 21 },
  { name: "Keepertje", matches: 72, winner: true, topscorer: true, paid: true, points: 250, prevPos: 51 },
  { name: "John0504", matches: 72, winner: true, topscorer: true, paid: true, points: 285, prevPos: 46 },
  { name: "Rugnummer67", matches: 9, winner: true, topscorer: true, paid: true, points: 345, prevPos: 43 },
  { name: "Norman.P", matches: 8, winner: true, topscorer: true, paid: true, points: 865, prevPos: 1 },
  { name: "StanleyBoessen", matches: 72, winner: false, topscorer: false, paid: true, points: 550, prevPos: 19 },
  { name: "GonnyDebode", matches: 72, winner: true, topscorer: true, paid: true, points: 410, prevPos: 34 },
  { name: "Marlayne", matches: 33, winner: true, topscorer: true, paid: true, points: 375, prevPos: 39 },
  { name: "Jules-", matches: 72, winner: true, topscorer: true, paid: true, points: 450, prevPos: 28 },
  { name: "Harro1", matches: 72, winner: true, topscorer: true, paid: true, points: 535, prevPos: 17 },
  { name: "JRHJNB", matches: 72, winner: true, topscorer: true, paid: true, points: 450, prevPos: 28 },
  { name: "JoycevanRiet", matches: 72, winner: true, topscorer: true, paid: true, points: 0, prevPos: 49 },
  { name: "Heer", matches: 72, winner: true, topscorer: true, paid: true, points: 660, prevPos: 8 },
  { name: "Pepijndh", matches: 0, winner: false, topscorer: false, paid: true, points: 0, prevPos: 51 },
  { name: "Cornelis2026", matches: 29, winner: true, topscorer: true, paid: true, points: 390, prevPos: 35 },
  { name: "Wkkipje", matches: 19, winner: true, topscorer: true, paid: true, points: 550, prevPos: 19 },
  { name: "MaureenGLA", matches: 72, winner: true, topscorer: true, paid: true, points: 505, prevPos: 25 },
  { name: "GeorgeV.", matches: 72, winner: true, topscorer: true, paid: true, points: 630, prevPos: 11 },
  { name: "ikgajuichen", matches: 104, winner: true, topscorer: true, paid: true, points: 635, prevPos: 9 },
  { name: "JanCandiano", matches: 28, winner: true, topscorer: true, paid: true, points: 360, prevPos: 38 },
  { name: "Bo.", matches: 72, winner: true, topscorer: true, paid: true, points: 430, prevPos: 32 },
  { name: "Koninkie", matches: 72, winner: true, topscorer: true, paid: true, points: 655, prevPos: 9 },
  { name: "Martijnmeestervoorspeller", matches: 72, winner: true, topscorer: true, paid: true, points: 710, prevPos: 4 },
  { name: "Crazy Dutchman", matches: 72, winner: true, topscorer: true, paid: true, points: 710, prevPos: 4 },
  ...
  { name: "WillemCo", matches: 8, winner: false, topscorer: false, paid: false, points: 370, prevPos: 37 }
];
...
window.POOL_HISTORY = {"Wolsman":[420,495,495,515,715,715],"Kleine Flo":[240,260,260,280,375,375],"Bertjuh":[220,315,335,355,555,555],"Bobcorn":[135,155,155,255,455,455],"UedaTopscorer":[240,260,260,280,300,300],"Oppie1978":[135,230,230,230,305,305],"El-Toro-Loco":[295,295,295,315,515,535],"StudentjeIndicium":[420,515,515,515,535,535],"Mauricio1980":[240,335,335,355,450,450],"AlinevanVuuren":[115,135,155,175,270,290],"Wisselbeker":[400,475,475,495,695,695],"Roantuit":[0,0,0,0,0,0],"Robertosxs":[240,335,335,355,555,555],"Reboss":[240,315,315,335,430,430],"Mobicontrol":[240,315,315,315,515,515],"Brokkenpiloot":[295,370,370,370,465,465],"Katinkadeb":[240,335,335,335,355,375],"BornBjorg":[295,370,390,410,610,610],"Fseton":[135,230,230,250,450,450],"Raymond de Haas":[135,230,250,250,345,345],"ScheidsTon":[0,0,0,0,0,0],"THEGOAT37":[135,155,355,375,575,575],"WesleyMerwe":[190,265,265,265,285,285],"Daisy010":[40,0,135,155,250,250],"Erol_Ulu":[240,315,515,615,710,710],"Givano":[135,230,230,250,345,345],"VanderLans":[295,370,370,390,590,590],"Trauner_in_Oranje":[295,390,410,430,525,545],"Keepertje":[0,135,0,0,0,250],"John0504":[95,190,210,210,285,285],"Rugnummer67":[135,210,210,230,325,345],"Norman.P":[495,570,570,770,865,865],"StanleyBoessen":[195,290,490,510,530,550],"GonnyDebode":[220,295,295,315,410,410],"Marlayne":[115,135,135,155,355,375],"Jules-":[240,335,335,355,450,450],"Harro1":[220,220,240,440,535,535],"JRHJNB":[240,335,335,355,450,450],"JoycevanRiet":[135,135,135,155,250,0],"Heer":[420,440,440,460,660,660],"Pepijndh":[0,0,0,0,0,0],"Cornelis2026":[75,275,295,315,390,390],"Wkkipje":[320,395,415,435,530,550],"MaureenGLA":[115,190,390,410,505,505],"GeorgeV.":[135,230,230,430,630,630],"ikgajuichen":[420,440,440,540,635,635],"JanCandiano":[170,265,265,265,360,360],"Bo.":[240,335,335,335,430,430],"Koninkie":[215,235,235,435,635,655],"Martijnmeestervoorspeller":[420,515,535,635,710,710],"Crazy Dutchman":[420,515,535,635,710,710],"RoanTuit(messi)":[220,315,315,415,510,510],"Christopheramboz":[420,515,535,635,730,730],"Frenk010fr":[0,0,0,0,0,0],"WillemCo":[200,275,275,275,370,370]};
