...
window.POOL_META = {
  ...
  totalPlayers: 52,
  capacityMax: 75,
  syncedAt: "2026-06-24T04:01:29.174Z",
...
window.POOL_PLAYERS = [
  { name: "Wolsman", matches: 104, winner: true, topscorer: true, paid: true, points: 3435, prevPos: 11 },
  { name: "Kleine Flo", matches: 72, winner: true, topscorer: true, paid: true, points: 3025, prevPos: 35 },
  { name: "Bertjuh", matches: 72, winner: true, topscorer: true, paid: true, points: 2930, prevPos: 35 },
  { name: "Bobcorn", matches: 72, winner: true, topscorer: true, paid: true, points: 3230, prevPos: 22 },
  { name: "UedaTopscorer", matches: 72, winner: true, topscorer: true, paid: true, points: 2650, prevPos: 48 },
  { name: "Oppie1978", matches: 52, winner: true, topscorer: true, paid: true, points: 3645, prevPos: 4 },
  { name: "El-Toro-Loco", matches: 49, winner: false, topscorer: false, paid: true, points: 2905, prevPos: 42 },
  { name: "StudentjeIndicium", matches: 72, winner: true, topscorer: true, paid: true, points: 3040, prevPos: 32 },
  { name: "Mauricio1980", matches: 72, winner: true, topscorer: true, paid: true, points: 3290, prevPos: 24 },
  { name: "AlinevanVuuren", matches: 72, winner: true, topscorer: true, paid: true, points: 3020, prevPos: 26 },
  { name: "Wisselbeker", matches: 48, winner: true, topscorer: true, paid: true, points: 3570, prevPos: 6 },
  ...
  { name: "Mobicontrol-Xavier", matches: 56, winner: true, topscorer: true, paid: true, points: 3650, prevPos: 10 },
  { name: "Brokkenpiloot", matches: 72, winner: true, topscorer: true, paid: true, points: 3495, prevPos: 8 },
  { name: "Katinkadeb", matches: 72, winner: true, topscorer: true, paid: true, points: 3085, prevPos: 37 },
  { name: "BornBjorg", matches: 55, winner: true, topscorer: true, paid: true, points: 2260, prevPos: 52 },
  { name: "Fseton", matches: 72, winner: true, topscorer: true, paid: true, points: 3095, prevPos: 31 },
  { name: "Raymond de Haas", matches: 62, winner: true, topscorer: true, paid: true, points: 3330, prevPos: 17 },
  { name: "THEGOAT37", matches: 70, winner: true, topscorer: true, paid: true, points: 3450, prevPos: 13 },
  { name: "WesleyMerwe", matches: 53, winner: true, topscorer: true, paid: true, points: 3180, prevPos: 30 },
  { name: "Daisy010", matches: 58, winner: true, topscorer: true, paid: true, points: 3365, prevPos: 16 },
  { name: "Erol_Ulu", matches: 72, winner: true, topscorer: true, paid: true, points: 3705, prevPos: 2 },
  { name: "Givano", matches: 72, winner: true, topscorer: true, paid: true, points: 3695, prevPos: 6 },
  { name: "JanvdL", matches: 51, winner: true, topscorer: true, paid: true, points: 3665, prevPos: 3 },
  { name: "Trauner_in_Oranje", matches: 48, winner: true, topscorer: true, paid: true, points: 3360, prevPos: 21 },
  { name: "Keepertje", matches: 72, winner: true, topscorer: true, paid: true, points: 2290, prevPos: 51 },
  { name: "John0504", matches: 72, winner: true, topscorer: true, paid: true, points: 2810, prevPos: 41 },
  { name: "Rugnummer67", matches: 51, winner: true, topscorer: true, paid: true, points: 3080, prevPos: 29 },
  { name: "Norman.P", matches: 47, winner: true, topscorer: true, paid: true, points: 3430, prevPos: 12 },
  { name: "StanleyBoessen", matches: 72, winner: false, topscorer: false, paid: true, points: 2690, prevPos: 44 },
  ...
  { name: "Jules-", matches: 72, winner: true, topscorer: true, paid: true, points: 3175, prevPos: 25 },
  { name: "Harro1", matches: 72, winner: true, topscorer: true, paid: true, points: 2820, prevPos: 39 },
  { name: "JRHJNB", matches: 72, winner: true, topscorer: true, paid: true, points: 3075, prevPos: 28 },
  { name: "JoycevanRiet", matches: 72, winner: true, topscorer: true, paid: true, points: 2595, prevPos: 45 },
  { name: "Heer", matches: 72, winner: true, topscorer: true, paid: true, points: 3645, prevPos: 9 },
  { name: "Cornelis2026", matches: 72, winner: true, topscorer: true, paid: true, points: 2685, prevPos: 43 },
  { name: "Wkkipje", matches: 66, winner: true, topscorer: true, paid: true, points: 2890, prevPos: 38 },
  { name: "MaureenGLA", matches: 72, winner: true, topscorer: true, paid: true, points: 2955, prevPos: 34 },
  { name: "GeorgeV.", matches: 72, winner: true, topscorer: true, paid: true, points: 3325, prevPos: 13 },
  { name: "ikgajuichen", matches: 104, winner: true, topscorer: true, paid: true, points: 3255, prevPos: 20 },
  { name: "JanCandiano", matches: 72, winner: true, topscorer: true, paid: true, points: 3315, prevPos: 23 },
  { name: "Bo.", matches: 72, winner: true, topscorer: true, paid: true, points: 3020, prevPos: 32 },
  { name: "Koninkie", matches: 72, winner: true, topscorer: true, paid: true, points: 3635, prevPos: 5 },
  { name: "Martijnmeestervoorspeller", matches: 72, winner: true, topscorer: true, paid: true, points: 3410, prevPos: 15 },
  { name: "Crazy Dutchman", matches: 72, winner: true, topscorer: true, paid: true, points: 3570, prevPos: 1 },
  { name: "RoanTuit(messi)", matches: 37, winner: true, topscorer: true, paid: true, points: 2575, prevPos: 47 },
  { name: "Christopheramboz", matches: 55, winner: true, topscorer: true, paid: true, points: 3300, prevPos: 18 },
  { name: "WillemCo", matches: 46, winner: false, topscorer: false, paid: true, points: 2815, prevPos: 40 },
  { name: "Nelson1983", matches: 38, winner: false, topscorer: false, paid: true, points: 2340, prevPos: 49 }
];
