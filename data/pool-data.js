...
window.POOL_META = {
  ...
  totalPlayers: 52,
  capacityMax: 75,
  syncedAt: "2026-06-20T05:31:25.386Z",
...
window.POOL_PLAYERS = [
  ...
  { name: "Kleine Flo", matches: 72, winner: true, topscorer: true, paid: true, points: 1845, prevPos: 33 },
  ...
  { name: "UedaTopscorer", matches: 72, winner: true, topscorer: true, paid: true, points: 1495, prevPos: 50 },
  { name: "Oppie1978", matches: 52, winner: true, topscorer: true, paid: true, points: 2340, prevPos: 6 },
  { name: "El-Toro-Loco", matches: 33, winner: false, topscorer: false, paid: true, points: 1640, prevPos: 44 },
  { name: "StudentjeIndicium", matches: 72, winner: true, topscorer: true, paid: true, points: 1985, prevPos: 26 },
  { name: "Mauricio1980", matches: 72, winner: true, topscorer: true, paid: true, points: 2065, prevPos: 21 },
  { name: "AlinevanVuuren", matches: 72, winner: true, topscorer: true, paid: true, points: 2020, prevPos: 24 },
  { name: "Wisselbeker", matches: 48, winner: true, topscorer: true, paid: true, points: 2320, prevPos: 9 },
  { name: "Robertosxs", matches: 104, winner: true, topscorer: true, paid: true, points: 2260, prevPos: 13 },
  { name: "Reboss", matches: 72, winner: true, topscorer: true, paid: true, points: 1770, prevPos: 40 },
  { name: "Mobicontrol-Xavier", matches: 53, winner: true, topscorer: true, paid: true, points: 2255, prevPos: 12 },
  ...
  { name: "Fseton", matches: 47, winner: true, topscorer: true, paid: true, points: 1845, prevPos: 33 },
  { name: "Raymond de Haas", matches: 46, winner: true, topscorer: true, paid: true, points: 2020, prevPos: 36 },
  { name: "THEGOAT37", matches: 45, winner: true, topscorer: true, paid: true, points: 1990, prevPos: 25 },
  { name: "WesleyMerwe", matches: 43, winner: true, topscorer: true, paid: true, points: 1895, prevPos: 31 },
  { name: "Daisy010", matches: 50, winner: true, topscorer: true, paid: true, points: 1935, prevPos: 30 },
  { name: "Erol_Ulu", matches: 72, winner: true, topscorer: true, paid: true, points: 2410, prevPos: 4 },
  { name: "Givano", matches: 72, winner: true, topscorer: true, paid: true, points: 2340, prevPos: 6 },
  { name: "JanvdL", matches: 32, winner: true, topscorer: true, paid: true, points: 2350, prevPos: 8 },
  { name: "Trauner_in_Oranje", matches: 32, winner: true, topscorer: true, paid: true, points: 1960, prevPos: 27 },
  ...
  { name: "Rugnummer67", matches: 33, winner: true, topscorer: true, paid: true, points: 2170, prevPos: 17 },
  { name: "Norman.P", matches: 32, winner: true, topscorer: true, paid: true, points: 2340, prevPos: 9 },
  { name: "StanleyBoessen", matches: 72, winner: false, topscorer: false, paid: true, points: 1840, prevPos: 36 },
  { name: "GonnyDebode", matches: 72, winner: true, topscorer: true, paid: true, points: 1640, prevPos: 44 },
  { name: "Marlayne", matches: 37, winner: true, topscorer: true, paid: true, points: 1480, prevPos: 49 },
  { name: "Jules-", matches: 72, winner: true, topscorer: true, paid: true, points: 1845, prevPos: 33 },
  { name: "Harro1", matches: 72, winner: true, topscorer: true, paid: true, points: 1695, prevPos: 43 },
  { name: "JRHJNB", matches: 72, winner: true, topscorer: true, paid: true, points: 1955, prevPos: 29 },
  { name: "JoycevanRiet", matches: 72, winner: true, topscorer: true, paid: true, points: 1580, prevPos: 47 },
  { name: "Heer", matches: 72, winner: true, topscorer: true, paid: true, points: 2415, prevPos: 3 },
  { name: "Cornelis2026", matches: 42, winner: true, topscorer: true, paid: true, points: 1740, prevPos: 41 },
  { name: "Wkkipje", matches: 38, winner: true, topscorer: true, paid: true, points: 1865, prevPos: 32 },
  { name: "MaureenGLA", matches: 72, winner: true, topscorer: true, paid: true, points: 2070, prevPos: 22 },
  { name: "GeorgeV.", matches: 72, winner: true, topscorer: true, paid: true, points: 2335, prevPos: 11 },
  ...
  { name: "Martijnmeestervoorspeller", matches: 72, winner: true, topscorer: true, paid: true, points: 2405, prevPos: 2 },
  { name: "Crazy Dutchman", matches: 72, winner: true, topscorer: true, paid: true, points: 2755, prevPos: 1 },
  { name: "RoanTuit(messi)", matches: 23, winner: true, topscorer: true, paid: true, points: 1480, prevPos: 48 },
  { name: "Christopheramboz", matches: 34, winner: true, topscorer: true, paid: true, points: 2170, prevPos: 16 },
  { name: "WillemCo", matches: 30, winner: false, topscorer: false, paid: true, points: 1800, prevPos: 38 },
