...
window.POOL_META = {
  ...
  totalPlayers: 55,
  capacityMax: 75,
  syncedAt: "2026-06-12T23:02:49.825Z",
...
window.POOL_PLAYERS = [
  { name: "Wolsman", matches: 104, winner: true, topscorer: true, paid: true, points: 420, prevPos: 2 },
  { name: "Kleine Flo", matches: 72, winner: true, topscorer: true, paid: true, points: 240, prevPos: 16 },
  { name: "Bertjuh", matches: 72, winner: true, topscorer: true, paid: true, points: 220, prevPos: 27 },
  { name: "Bobcorn", matches: 72, winner: true, topscorer: true, paid: true, points: 135, prevPos: 36 },
  { name: "UedaTopscorer", matches: 72, winner: true, topscorer: true, paid: true, points: 240, prevPos: 16 },
  { name: "Oppie1978", matches: 24, winner: true, topscorer: true, paid: true, points: 135, prevPos: 36 },
  { name: "El-Toro-Loco", matches: 11, winner: false, topscorer: false, paid: true, points: 295, prevPos: 11 },
  { name: "StudentjeIndicium", matches: 72, winner: true, topscorer: true, paid: true, points: 420, prevPos: 2 },
  { name: "Mauricio1980", matches: 72, winner: true, topscorer: true, paid: true, points: 240, prevPos: 16 },
  { name: "AlinevanVuuren", matches: 72, winner: true, topscorer: true, paid: true, points: 115, prevPos: 45 },
  { name: "Wisselbeker", matches: 10, winner: true, topscorer: true, paid: true, points: 400, prevPos: 9 },
  { name: "Roantuit", matches: 0, winner: false, topscorer: false, paid: true, points: 0, prevPos: 51 },
  { name: "Robertosxs", matches: 104, winner: true, topscorer: true, paid: true, points: 240, prevPos: 16 },
  { name: "Reboss", matches: 72, winner: true, topscorer: true, paid: true, points: 240, prevPos: 16 },
  { name: "Mobicontrol", matches: 53, winner: true, topscorer: true, paid: true, points: 240, prevPos: 16 },
  { name: "Brokkenpiloot", matches: 17, winner: true, topscorer: true, paid: true, points: 295, prevPos: 11 },
  { name: "Katinkadeb", matches: 72, winner: true, topscorer: true, paid: true, points: 240, prevPos: 16 },
  { name: "BornBjorg", matches: 24, winner: true, topscorer: true, paid: true, points: 295, prevPos: 11 },
  { name: "Fseton", matches: 17, winner: true, topscorer: true, paid: true, points: 135, prevPos: 36 },
  { name: "Raymond de Haas", matches: 14, winner: true, topscorer: true, paid: true, points: 135, prevPos: 36 },
  { name: "ScheidsTon", matches: 0, winner: false, topscorer: false, paid: true, points: 0, prevPos: 51 },
  { name: "THEGOAT37", matches: 31, winner: true, topscorer: true, paid: true, points: 135, prevPos: 36 },
  { name: "WesleyMerwe", matches: 10, winner: true, topscorer: true, paid: true, points: 190, prevPos: 34 },
  { name: "Daisy010", matches: 15, winner: true, topscorer: true, paid: true, points: 40, prevPos: 50 },
  { name: "Erol_Ulu", matches: 72, winner: true, topscorer: true, paid: true, points: 240, prevPos: 16 },
  { name: "Givano", matches: 72, winner: true, topscorer: true, paid: true, points: 135, prevPos: 36 },
  { name: "VanderLans", matches: 9, winner: true, topscorer: true, paid: true, points: 295, prevPos: 11 },
  { name: "Trauner_in_Oranje", matches: 5, winner: true, topscorer: true, paid: true, points: 295, prevPos: 11 },
  { name: "Keepertje", matches: 72, winner: true, topscorer: true, paid: true, points: 0, prevPos: 51 },
  { name: "John0504", matches: 72, winner: true, topscorer: true, paid: true, points: 95, prevPos: 48 },
  { name: "Rugnummer67", matches: 5, winner: true, topscorer: true, paid: true, points: 135, prevPos: 36 },
  { name: "Norman.P", matches: 4, winner: true, topscorer: true, paid: true, points: 495, prevPos: 1 },
  { name: "StanleyBoessen", matches: 72, winner: false, topscorer: false, paid: true, points: 195, prevPos: 33 },
  { name: "GonnyDebode", matches: 72, winner: true, topscorer: true, paid: true, points: 220, prevPos: 27 },
  { name: "Marlayne", matches: 26, winner: true, topscorer: true, paid: true, points: 115, prevPos: 45 },
  { name: "Jules-", matches: 72, winner: true, topscorer: true, paid: true, points: 240, prevPos: 16 },
  { name: "Harro1", matches: 72, winner: true, topscorer: true, paid: true, points: 220, prevPos: 27 },
  { name: "JRHJNB", matches: 72, winner: true, topscorer: true, paid: true, points: 240, prevPos: 16 },
  { name: "JoycevanRiet", matches: 72, winner: true, topscorer: true, paid: true, points: 135, prevPos: 36 },
  { name: "Heer", matches: 72, winner: true, topscorer: true, paid: true, points: 420, prevPos: 2 },
  { name: "Pepijndh", matches: 0, winner: false, topscorer: false, paid: true, points: 0, prevPos: 51 },
  { name: "Cornelis2026", matches: 29, winner: true, topscorer: true, paid: true, points: 75, prevPos: 49 },
  { name: "Wkkipje", matches: 10, winner: true, topscorer: true, paid: true, points: 320, prevPos: 10 },
  { name: "MaureenGLA", matches: 72, winner: true, topscorer: true, paid: true, points: 115, prevPos: 45 },
  { name: "GeorgeV.", matches: 72, winner: true, topscorer: true, paid: true, points: 135, prevPos: 36 },
  { name: "ikgajuichen", matches: 104, winner: true, topscorer: true, paid: true, points: 420, prevPos: 2 },
  { name: "JanCandiano", matches: 20, winner: true, topscorer: true, paid: true, points: 170, prevPos: 35 },
  { name: "Bo.", matches: 72, winner: true, topscorer: true, paid: true, points: 240, prevPos: 16 },
  { name: "Koninkie", matches: 72, winner: true, topscorer: true, paid: true, points: 215, prevPos: 31 },
  { name: "Martijnmeestervoorspeller", matches: 72, winner: true, topscorer: true, paid: true, points: 420, prevPos: 2 },
  { name: "Crazy Dutchman", matches: 72, winner: true, topscorer: true, paid: true, points: 420, prevPos: 2 },
  { name: "RoanTuit(messi)", matches: 7, winner: true, topscorer: true, paid: true, points: 220, prevPos: 27 },
  { name: "Christopheramboz", matches: 9, winner: true, topscorer: true, paid: true, points: 420, prevPos: 2 },
  { name: "Frenk010fr", matches: 0, winner: false, topscorer: false, paid: false, points: 0, prevPos: 51 },
  { name: "WillemCo", matches: 8, winner: false, topscorer: false, paid: false, points: 200, prevPos: 32 }
];
...
window.POOL_HISTORY = {"Wolsman":[420],"Kleine Flo":[240],"Bertjuh":[220],"Bobcorn":[135],"UedaTopscorer":[240],"Oppie1978":[135],"El-Toro-Loco":[295],"StudentjeIndicium":[420],"Mauricio1980":[240],"AlinevanVuuren":[115],"Wisselbeker":[400],"Roantuit":[0],"Robertosxs":[240],"Reboss":[240],"Mobicontrol":[240],"Brokkenpiloot":[295],"Katinkadeb":[240],"BornBjorg":[295],"Fseton":[135],"Raymond de Haas":[135],"ScheidsTon":[0],"THEGOAT37":[135],"WesleyMerwe":[190],"Daisy010":[40],"Erol_Ulu":[240],"Givano":[135],"VanderLans":[295],"Trauner_in_Oranje":[295],"Keepertje":[0],"John0504":[95],"Rugnummer67":[135],"Norman.P":[495],"StanleyBoessen":[195],"GonnyDebode":[220],"Marlayne":[115],"Jules-":[240],"Harro1":[220],"JRHJNB":[240],"JoycevanRiet":[135],"Heer":[420],"Pepijndh":[0],"Cornelis2026":[75],"Wkkipje":[320],"MaureenGLA":[115],"GeorgeV.":[135],"ikgajuichen":[420],"JanCandiano":[170],"Bo.":[240],"Koninkie":[215],"Martijnmeestervoorspeller":[420],"Crazy Dutchman":[420],"RoanTuit(messi)":[220],"Christopheramboz":[420],"Frenk010fr":[0],"WillemCo":[200]};
