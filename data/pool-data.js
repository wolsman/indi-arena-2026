...
window.POOL_META = {
  ...
  totalPlayers: 56,
  capacityMax: 75,
  syncedAt: "2026-06-14T20:31:23.321Z",
...
window.POOL_PLAYERS = [
  { name: "Wolsman", matches: 104, winner: true, topscorer: true, paid: true, points: 790, prevPos: 5 },
  { name: "Kleine Flo", matches: 72, winner: true, topscorer: true, paid: true, points: 450, prevPos: 39 },
  { name: "Bertjuh", matches: 72, winner: true, topscorer: true, paid: true, points: 630, prevPos: 16 },
  { name: "Bobcorn", matches: 72, winner: true, topscorer: true, paid: true, points: 475, prevPos: 35 },
  { name: "UedaTopscorer", matches: 72, winner: true, topscorer: true, paid: true, points: 375, prevPos: 46 },
  { name: "Oppie1978", matches: 24, winner: true, topscorer: true, paid: true, points: 400, prevPos: 45 },
  { name: "El-Toro-Loco", matches: 11, winner: false, topscorer: false, paid: true, points: 610, prevPos: 21 },
  { name: "StudentjeIndicium", matches: 72, winner: true, topscorer: true, paid: true, points: 630, prevPos: 16 },
  { name: "Mauricio1980", matches: 72, winner: true, topscorer: true, paid: true, points: 525, prevPos: 27 },
  { name: "AlinevanVuuren", matches: 72, winner: true, topscorer: true, paid: true, points: 490, prevPos: 34 },
  { name: "Wisselbeker", matches: 26, winner: true, topscorer: true, paid: true, points: 770, prevPos: 7 },
  { name: "Roantuit", matches: 0, winner: false, topscorer: false, paid: true, points: 0, prevPos: 51 },
  { name: "Robertosxs", matches: 104, winner: true, topscorer: true, paid: true, points: 630, prevPos: 16 },
  { name: "Reboss", matches: 72, winner: true, topscorer: true, paid: true, points: 505, prevPos: 31 },
  { name: "Mobicontrol", matches: 53, winner: true, topscorer: true, paid: true, points: 590, prevPos: 24 },
  { name: "Brokkenpiloot", matches: 24, winner: true, topscorer: true, paid: true, points: 540, prevPos: 26 },
  { name: "Katinkadeb", matches: 72, winner: true, topscorer: true, paid: true, points: 450, prevPos: 39 },
  { name: "BornBjorg", matches: 24, winner: true, topscorer: true, paid: true, points: 685, prevPos: 12 },
  { name: "Fseton", matches: 24, winner: true, topscorer: true, paid: true, points: 525, prevPos: 27 },
  ...
  { name: "Daisy010", matches: 18, winner: true, topscorer: true, paid: true, points: 345, prevPos: 49 },
  { name: "Erol_Ulu", matches: 72, winner: true, topscorer: true, paid: true, points: 785, prevPos: 6 },
  { name: "Givano", matches: 72, winner: true, topscorer: true, paid: true, points: 420, prevPos: 43 },
  { name: "VanderLans", matches: 15, winner: true, topscorer: true, paid: true, points: 665, prevPos: 13 },
  { name: "Trauner_in_Oranje", matches: 12, winner: true, topscorer: true, paid: true, points: 620, prevPos: 20 },
  { name: "Keepertje", matches: 72, winner: true, topscorer: true, paid: true, points: 325, prevPos: 50 },
  { name: "John0504", matches: 72, winner: true, topscorer: true, paid: true, points: 360, prevPos: 47 },
  { name: "Rugnummer67", matches: 16, winner: true, topscorer: true, paid: true, points: 440, prevPos: 41 },
  { name: "Norman.P", matches: 13, winner: true, topscorer: true, paid: true, points: 940, prevPos: 1 },
  { name: "StanleyBoessen", matches: 72, winner: false, topscorer: false, paid: true, points: 645, prevPos: 15 },
  { name: "GonnyDebode", matches: 72, winner: true, topscorer: true, paid: true, points: 505, prevPos: 31 },
  { name: "Marlayne", matches: 33, winner: true, topscorer: true, paid: true, points: 470, prevPos: 36 },
  { name: "Jules-", matches: 72, winner: true, topscorer: true, paid: true, points: 525, prevPos: 27 },
  ...
  { name: "Heer", matches: 72, winner: true, topscorer: true, paid: true, points: 735, prevPos: 9 },
  { name: "Pepijndh", matches: 0, winner: false, topscorer: false, paid: true, points: 0, prevPos: 51 },
  { name: "Cornelis2026", matches: 29, winner: true, topscorer: true, paid: true, points: 465, prevPos: 37 },
  { name: "Wkkipje", matches: 19, winner: true, topscorer: true, paid: true, points: 625, prevPos: 19 },
  { name: "MaureenGLA", matches: 72, winner: true, topscorer: true, paid: true, points: 580, prevPos: 25 },
  ...
  { name: "Bo.", matches: 72, winner: true, topscorer: true, paid: true, points: 505, prevPos: 31 },
  { name: "Koninkie", matches: 72, winner: true, topscorer: true, paid: true, points: 750, prevPos: 8 },
  { name: "Martijnmeestervoorspeller", matches: 72, winner: true, topscorer: true, paid: true, points: 805, prevPos: 2 },
  { name: "Crazy Dutchman", matches: 72, winner: true, topscorer: true, paid: true, points: 805, prevPos: 2 },
  { name: "RoanTuit(messi)", matches: 8, winner: true, topscorer: true, paid: true, points: 605, prevPos: 23 },
  { name: "Christopheramboz", matches: 17, winner: true, topscorer: true, paid: true, points: 805, prevPos: 2 },
...
window.POOL_HISTORY = {"Wolsman":[420,495,495,515,715,715,790],"Kleine Flo":[240,260,260,280,375,375,450],"Bertjuh":[220,315,335,355,555,555,630],"Bobcorn":[135,155,155,255,455,455,475],"UedaTopscorer":[240,260,260,280,300,300,375],"Oppie1978":[135,230,230,230,305,305,400],"El-Toro-Loco":[295,295,295,315,515,535,610],"StudentjeIndicium":[420,515,515,515,535,535,630],"Mauricio1980":[240,335,335,355,450,450,525],"AlinevanVuuren":[115,135,155,175,270,290,490],"Wisselbeker":[400,475,475,495,695,695,770],"Roantuit":[0,0,0,0,0,0,0],"Robertosxs":[240,335,335,355,555,555,630],"Reboss":[240,315,315,335,430,430,505],"Mobicontrol":[240,315,315,315,515,515,590],"Brokkenpiloot":[295,370,370,370,465,465,540],"Katinkadeb":[240,335,335,335,355,375,450],"BornBjorg":[295,370,390,410,610,610,685],"Fseton":[135,230,230,250,450,450,525],"Raymond de Haas":[135,230,250,250,345,345,420],"ScheidsTon":[0,0,0,0,0,0,0],"THEGOAT37":[135,155,355,375,575,575,650],"WesleyMerwe":[190,265,265,265,285,285,360],"Daisy010":[40,0,135,155,250,250,345],"Erol_Ulu":[240,315,515,615,710,710,785],"Givano":[135,230,230,250,345,345,420],"VanderLans":[295,370,370,390,590,590,665],"Trauner_in_Oranje":[295,390,410,430,525,545,620],"Keepertje":[0,135,0,0,0,250,325],"John0504":[95,190,210,210,285,285,360],"Rugnummer67":[135,210,210,230,325,345,440],"Norman.P":[495,570,570,770,865,865,940],"StanleyBoessen":[195,290,490,510,530,550,645],"GonnyDebode":[220,295,295,315,410,410,505],"Marlayne":[115,135,135,155,355,375,470],"Jules-":[240,335,335,355,450,450,525],"Harro1":[220,220,240,440,535,535,610],"JRHJNB":[240,335,335,355,450,450,525],"JoycevanRiet":[135,135,135,155,250,0,0],"Heer":[420,440,440,460,660,660,735],"Pepijndh":[0,0,0,0,0,0,0],"Cornelis2026":[75,275,295,315,390,390,465],"Wkkipje":[320,395,415,435,530,550,625],"MaureenGLA":[115,190,390,410,505,505,580],"GeorgeV.":[135,230,230,430,630,630,705],"ikgajuichen":[420,440,440,540,635,635,710],"JanCandiano":[170,265,265,265,360,360,435],"Bo.":[240,335,335,335,430,430,505],"Koninkie":[215,235,235,435,635,655,750],"Martijnmeestervoorspeller":[420,515,535,635,710,710,805],"Crazy Dutchman":[420,515,535,635,710,710,805],"RoanTuit(messi)":[220,315,315,415,510,510,605],"Christopheramboz":[420,515,535,635,730,730,805],"Frenk010fr":[0,0,0,0,0,0,0],"WillemCo":[200,275,275,275,370,370,465],"Nelson1983":[0]};
