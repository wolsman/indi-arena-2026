...
window.POOL_META = {
  ...
  totalPlayers: 52,
  capacityMax: 75,
  syncedAt: "2026-06-18T21:31:56.506Z",
...
window.POOL_PLAYERS = [
  { name: "Wolsman", matches: 104, winner: true, topscorer: true, paid: true, points: 1600, prevPos: 25 },
  { name: "Kleine Flo", matches: 72, winner: true, topscorer: true, paid: true, points: 1390, prevPos: 40 },
  { name: "Bertjuh", matches: 72, winner: true, topscorer: true, paid: true, points: 1560, prevPos: 28 },
  { name: "Bobcorn", matches: 72, winner: true, topscorer: true, paid: true, points: 1585, prevPos: 20 },
  { name: "UedaTopscorer", matches: 72, winner: true, topscorer: true, paid: true, points: 1155, prevPos: 49 },
  { name: "Oppie1978", matches: 37, winner: true, topscorer: true, paid: true, points: 1925, prevPos: 8 },
  ...
  { name: "Mauricio1980", matches: 72, winner: true, topscorer: true, paid: true, points: 1455, prevPos: 31 },
  { name: "AlinevanVuuren", matches: 72, winner: true, topscorer: true, paid: true, points: 1600, prevPos: 25 },
  { name: "Wisselbeker", matches: 32, winner: true, topscorer: true, paid: true, points: 1845, prevPos: 9 },
  { name: "Robertosxs", matches: 104, winner: true, topscorer: true, paid: true, points: 1615, prevPos: 23 },
  ...
  { name: "Brokkenpiloot", matches: 53, winner: true, topscorer: true, paid: true, points: 1800, prevPos: 13 },
  { name: "Katinkadeb", matches: 72, winner: true, topscorer: true, paid: true, points: 1590, prevPos: 18 },
  { name: "BornBjorg", matches: 24, winner: true, topscorer: true, paid: true, points: 1710, prevPos: 12 },
  { name: "Fseton", matches: 45, winner: true, topscorer: true, paid: true, points: 1520, prevPos: 30 },
  { name: "Raymond de Haas", matches: 42, winner: true, topscorer: true, paid: true, points: 1410, prevPos: 34 },
  { name: "THEGOAT37", matches: 45, winner: true, topscorer: true, paid: true, points: 1580, prevPos: 21 },
  { name: "WesleyMerwe", matches: 31, winner: true, topscorer: true, paid: true, points: 1315, prevPos: 44 },
  { name: "Daisy010", matches: 40, winner: true, topscorer: true, paid: true, points: 1630, prevPos: 24 },
  { name: "Erol_Ulu", matches: 72, winner: true, topscorer: true, paid: true, points: 1945, prevPos: 6 },
  { name: "Givano", matches: 72, winner: true, topscorer: true, paid: true, points: 2000, prevPos: 3 },
  { name: "JanvdL", matches: 27, winner: true, topscorer: true, paid: true, points: 1895, prevPos: 4 },
  { name: "Trauner_in_Oranje", matches: 28, winner: true, topscorer: true, paid: true, points: 1420, prevPos: 37 },
  ...
  { name: "Rugnummer67", matches: 33, winner: true, topscorer: true, paid: true, points: 1775, prevPos: 10 },
  { name: "Norman.P", matches: 28, winner: true, topscorer: true, paid: true, points: 1760, prevPos: 15 },
  { name: "StanleyBoessen", matches: 72, winner: false, topscorer: false, paid: true, points: 1485, prevPos: 28 },
  { name: "GonnyDebode", matches: 72, winner: true, topscorer: true, paid: true, points: 1335, prevPos: 38 },
  { name: "Marlayne", matches: 37, winner: true, topscorer: true, paid: true, points: 1290, prevPos: 43 },
  { name: "Jules-", matches: 72, winner: true, topscorer: true, paid: true, points: 1445, prevPos: 36 },
  { name: "Harro1", matches: 72, winner: true, topscorer: true, paid: true, points: 1360, prevPos: 42 },
  { name: "JRHJNB", matches: 72, winner: true, topscorer: true, paid: true, points: 1450, prevPos: 35 },
  { name: "JoycevanRiet", matches: 72, winner: true, topscorer: true, paid: true, points: 1295, prevPos: 44 },
  { name: "Heer", matches: 72, winner: true, topscorer: true, paid: true, points: 1710, prevPos: 14 },
  { name: "Cornelis2026", matches: 42, winner: true, topscorer: true, paid: true, points: 1420, prevPos: 39 },
  { name: "Wkkipje", matches: 24, winner: true, topscorer: true, paid: true, points: 1530, prevPos: 27 },
  { name: "MaureenGLA", matches: 72, winner: true, topscorer: true, paid: true, points: 1500, prevPos: 32 },
  { name: "GeorgeV.", matches: 72, winner: true, topscorer: true, paid: true, points: 2010, prevPos: 2 },
  { name: "ikgajuichen", matches: 104, winner: true, topscorer: true, paid: true, points: 1885, prevPos: 5 },
  { name: "JanCandiano", matches: 72, winner: true, topscorer: true, paid: true, points: 1550, prevPos: 22 },
  { name: "Bo.", matches: 72, winner: true, topscorer: true, paid: true, points: 1295, prevPos: 44 },
  { name: "Koninkie", matches: 72, winner: true, topscorer: true, paid: true, points: 1775, prevPos: 10 },
  { name: "Martijnmeestervoorspeller", matches: 72, winner: true, topscorer: true, paid: true, points: 1940, prevPos: 7 },
  { name: "Crazy Dutchman", matches: 72, winner: true, topscorer: true, paid: true, points: 2290, prevPos: 1 },
  { name: "RoanTuit(messi)", matches: 23, winner: true, topscorer: true, paid: true, points: 1310, prevPos: 41 },
  { name: "Christopheramboz", matches: 34, winner: true, topscorer: true, paid: true, points: 1735, prevPos: 16 },
  { name: "WillemCo", matches: 30, winner: false, topscorer: false, paid: true, points: 1495, prevPos: 33 },
