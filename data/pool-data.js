...
window.POOL_META = {
  ...
  totalPlayers: 54,
  capacityMax: 75,
  syncedAt: "2026-06-16T13:31:35.058Z",
...
window.POOL_PLAYERS = [
  ...
  { name: "VanderLans", matches: 19, winner: true, topscorer: true, paid: true, points: 1040, prevPos: 9 },
...
window.POOL_HENK = {"generatedAt":"2026-06-16","playerTakes":{"GeorgeV.":"George, stiller dan een standbeeld; de koploper die zijn positie versteent met wat knullige missers — Iran-Nieuw-Zeeland? Verkeerde competitie, man!","BornBjorg":"BornBjorg, wie op nummer twee staat, weet dat hij onder druk presteert; maar je Iran-Nieuw-Zeeland 1-0 voorspelling is een schot in eigen doel.","Christopheramboz":"Christopheramboz, met zo'n Zweden-Tunesië blunder heb je meer weg van een mislukte clairvoyant dan een serieuze voetbalanalist.","Norman.P":"Norman.P, met die Iran-Nieuw-Zeeland 1-0 flater wordt je ranking als vierkantje vastgezet als je niet uitkijkt.","Martijnmeestervoorspeller":"Martijn, met zo'n zelfverzekerde naam en een pijnlijke 2-1 tegen Japan sta je toch maar mooi op een dalende lijn.","Crazy Dutchman":"Crazy Dutchman, je voorspellingen zijn net zo wild als je naam, maar met die 2-2 in Japan had je toch iets normaler mogen zijn.","Erol_Ulu":"Erol, knap dat je die 2-2 zag aankomen, maar je plek in de top lijkt ver weg met die 505-trendpunten.","Koninkie":"Koninkie, de koning van de middelmaat heerst over een keizerrijk zonder progressie — 650 trendpunten en toch stilstaan.","VanderLans":"VanderLans, met 650 trendpunten maak je evenveel indruk als een wegwerpwaterfles in de woestijn.","Wkkipje":"Wkkipje, met je 2-0 gok tegen Japan zit je duidelijk in een foute fase — misschien tijd voor een strategische reset?","THEGOAT37":"THEGOAT37, een grote naam, maar met 655 trendpunten sta je letterlijk vast in de modder.","Wisselbeker":"Wisselbeker, je hebt het juiste sportseizoen voor een trophy gekozen, nu alleen nog de juiste voorspellingen.","Brokkenpiloot":"Brokkenpiloot, je landingen zijn net zo turbulent als je Iran-Nieuw-Zeeland-inschatting, maar die streak helpt je niet de lucht in.","Heer":"Heer, je naam klinkt respectabel, maar met een 0-0 voorspelling tegen Tunesië trap je jezelf de wijnkelder in.","StudentjeIndicium":"StudentjeIndicium, je Iran-Nieuw-Zeeland gok is je enige hoogvlieger, dus misschien moet je toch eens beter opletten in de lessen.","Oppie1978":"Oppie1978 lijkt te genieten van de onderkant van de top, zolang je Iran-Nieuw-Zeeland resultaten maar goed blijven.","ikgajuichen":"Ik, jij, hij of zij gajuichen een keer, maar voorlopig lijkt het meer een fluister dan een overwinningskreet.","AlinevanVuuren":"Aline, je scoort beter op je misgok tegen de VS dan als voorspeller, dus misschien kun je overstappen op darts.","Mobicontrol-Xavier":"Mobicontrol-Xavier, onbekend is onbemind, maar het trendloze is de stille motor van je ondergang.","MaureenGLA":"Maureen, met zo'n streak kun je beter je app bijwerken dan je voorspellingen.","Wolsman":"Wolsman, met een trend als een opgeblazen fietsband; je blijft op dezelfde plek stilstaan.","JanCandiano":"Jan, je lijkt meer op een vergeten dessert dan een zekere voorspeller — tijd voor een sugar rush.","Daisy010":"Daisy010, je bent beter in bloemen schikken dan in scorebordjournalistiek, gezien je Iran-Nieuw-Zeeland blunder.","Givano":"Givano, met Iran-Nieuw-Zeeland als enige lichtpuntje, is je voorspellende gave meer een ondergaande zon.","GonnyDebode":"Gonny, je 3-2 voorspelling is hilarisch misplaatst — laat je glazen bol maar bij de kringloop.","WillemCo":"WillemCo, Iran's 2-2 is je enige goud, maar Japan heeft je voorspellingen op een zijspoor gezet.","Trauner_in_Oranje":"Trauner_in_Oranje, je Iran-Nieuw-Zeeland voorspelling is net zo accuraat als een regenjas in de zon.","Rugnummer67":"Rugnummer67, blijf maar gerust zitten op de bank; je Iran blunder is even hilarisch als je achternaam.","Bertjuh":"Bertjuh, je trapt vaker naast de bal dan Bayern München, en Tunesië gaf je de rode kaart.","Harro1":"Harro1, je mag dan stilzitten, maar je score heeft het tempo van een bejaarde wandelclub.","Robertosxs":"Robertosxs, de enige beweging die je kent is naar achter, gezien die Iran blunder.","StanleyBoessen":"StanleyBoessen, een streak lijkt meer op een misplaatste make-over dan een triomf, zeker met zulke voorspellingen.","Marlayne":"Marlayne, je voorspellingen zijn net zo elegant als een zwaan, maar je Tunesië 2-2 blunder laat je zinken.","RoanTuit(messi)":"RoanTuit(messi), je streak is net zo sprankelend als spa blauw, maar Iran gaf je een nat pak.","Fseton":"Fseton, je 505 trendpunten zijn net zo indrukwekkend als een kiwi's vliegkunst — tijd voor een upgrade.","JRHJNB":"JRHJNB, je blijft hangen op 385 trendpunten; tijd om je strategie bij te werken!","Mauricio1980":"Mauricio1980, je score is net zo statisch als een schilderij in het Louvre — indrukwekkend maar onbeweeglijk.","Bobcorn":"Bobcorn, je Duitsland-Curaçao blunder is een klassieker, maar een verbetering bleef uit.","Keepertje":"Keepertje, steady met 700, maar je mist evenveel als een keepershandschoen in de wasmachine.","Jules-":"Jules-, trendpunten zo vast als een aquariumvis, terwijl Iran genadeloos je snelheid breekt.","Katinkadeb":"Katinkadeb, met Iran als hoogtepunt klinkt je voorspelling als een vergeten melodie.","Cornelis2026":"Cornelis2026, 350 trendpunten en je denkt aan 2026 — misschien moet je sneller vooruitkijken.","Reboss":"Reboss, je Iran blunder doet meer denken aan een 'reboot' dan een 'boss'.","JoycevanRiet":"Joyce, Paraguay heeft je voorspellingen op een zwart zaadje laten groeien — tijd voor betere grond.","El-Toro-Loco":"El-Toro-Loco, je USA-Paraguay voorspelling is net zo loco als een stier in een fabriek.","WesleyMerwe":"WesleyMerwe, je Iran blunder maakt je naam ironisch — je blijft steken in het plattelandsvoetbal.","Kleine Flo":"Kleine Flo, je USA blunder was eerder een zachte landing dan een touchdown.","Bo.":"Bo., je Zweden-Tunesië inschatting laat meer te raden over dan de achterkant van een Picasso.","John0504":"John0504, je voorspellingen zijn de quiz van een kinderfeestje — simpel en voorspelbaar.","UedaTopscorer":"UedaTopscorer, met 250 trendpunten moet je nog even oefenen voor die topscorertitel.","Raymond de Haas":"Raymond, je Zweden-Tunesië voorspelling is als een voetbal in een bloemenwinkel — compleet verloren.","Nelson1983":"Nelson1983, je staat als een kat in de boom met je voorspellingen; Zweden-Tunesië was een miauw.","Pepijndh":"Pepijndh, op nul blijven hangen is een kunst die je jezelf wel erg eigen hebt gemaakt.","Frenk010fr":"Frenk010fr, je aanwezigheid in deze poule is net zo zichtbaar als een spook op Halloween."},"monoloog":"Kijk, als we dan toch een parade van stilstaand gedoe hebben, laten we even stilstaan bij John0504 op plek 49 — stilstaande auto’s hebben vaak nog meer beweging. Wkkipje bungelt tevreden in de top 10, maar met zijn ene exacte uitslag lijkt hij de blinde kip die ook weleens een graantje meepikt. En wat te zeggen over THEGOAT37; met zulke trendpunten verwacht je vuurwerk, maar het blijft vooral natte vuurpijlen.","hotTakes":["GeorgeV. bovenaan de lijst, maar met die 1320 punten speelt hij gewoon kneiterveilig. Je verwacht een geit, maar krijgt een lam.","Raymond de Haas, met jouw 480 punten ben je meer een parkeerplaats dan een snelweg. Zweden-Tunesië 5-1? Waarschijnlijk had je beter de krant kunnen lezen voor je dat invulde.","WillemCo, met een score van 840 zou je denken dat je iets voorstelt, maar zelfs je exacte uitslagen zijn net zo zeldzaam als een goede horrorfilm.","Oppie1978, op je 16e plek, lijkt je voorspelling op Iran-Nieuw-Zeeland een toevallige flits in de pan. Toevallig geluk valt niet onder analyse.","Katinkadeb, 685 punten en je zit vastgeroest op 41. Ik hoop dat je het in de keuken beter doet dan met je voetbalvoorspellingen."],"dailyTarget":{"name":"Keepertje","lines":["Ah, Keepertje, op plaats 39 en vastgeroest als een vergeten keeper op een modderig veld!","Met die stilstaande beweging lijk je meer op een verkeerskegel dan een strategische meester."]},"targetHistory":["Keepertje"]};
