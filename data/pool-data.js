...
window.POOL_META = {
  ...
  totalPlayers: 52,
  capacityMax: 75,
  syncedAt: "2026-06-20T19:01:37.248Z",
...
window.POOL_PLAYERS = [
  ...
  { name: "Bobcorn", matches: 72, winner: true, topscorer: true, paid: true, points: 2060, prevPos: 28 },
  { name: "UedaTopscorer", matches: 72, winner: true, topscorer: true, paid: true, points: 1515, prevPos: 48 },
  { name: "Oppie1978", matches: 52, winner: true, topscorer: true, paid: true, points: 2435, prevPos: 7 },
  { name: "El-Toro-Loco", matches: 33, winner: false, topscorer: false, paid: true, points: 1715, prevPos: 44 },
  ...
  { name: "AlinevanVuuren", matches: 72, winner: true, topscorer: true, paid: true, points: 2115, prevPos: 24 },
  { name: "Wisselbeker", matches: 48, winner: true, topscorer: true, paid: true, points: 2415, prevPos: 11 },
  { name: "Robertosxs", matches: 104, winner: true, topscorer: true, paid: true, points: 2335, prevPos: 12 },
  { name: "Reboss", matches: 72, winner: true, topscorer: true, paid: true, points: 1845, prevPos: 40 },
  { name: "Mobicontrol-Xavier", matches: 53, winner: true, topscorer: true, paid: true, points: 2350, prevPos: 13 },
  { name: "Brokkenpiloot", matches: 53, winner: true, topscorer: true, paid: true, points: 2475, prevPos: 5 },
  { name: "Katinkadeb", matches: 72, winner: true, topscorer: true, paid: true, points: 2075, prevPos: 23 },
  { name: "BornBjorg", matches: 24, winner: true, topscorer: true, paid: true, points: 1710, prevPos: 42 },
  { name: "Fseton", matches: 47, winner: true, topscorer: true, paid: true, points: 1920, prevPos: 34 },
  { name: "Raymond de Haas", matches: 46, winner: true, topscorer: true, paid: true, points: 2095, prevPos: 24 },
  { name: "THEGOAT37", matches: 45, winner: true, topscorer: true, paid: true, points: 2085, prevPos: 26 },
  { name: "WesleyMerwe", matches: 43, winner: true, topscorer: true, paid: true, points: 1970, prevPos: 32 },
  { name: "Daisy010", matches: 50, winner: true, topscorer: true, paid: true, points: 2030, prevPos: 31 },
  { name: "Erol_Ulu", matches: 72, winner: true, topscorer: true, paid: true, points: 2505, prevPos: 3 },
  { name: "Givano", matches: 72, winner: true, topscorer: true, paid: true, points: 2435, prevPos: 7 },
  { name: "JanvdL", matches: 40, winner: true, topscorer: true, paid: true, points: 2425, prevPos: 6 },
  ...
  { name: "John0504", matches: 72, winner: true, topscorer: true, paid: true, points: 1710, prevPos: 46 },
  { name: "Rugnummer67", matches: 42, winner: true, topscorer: true, paid: true, points: 2245, prevPos: 16 },
  { name: "Norman.P", matches: 33, winner: true, topscorer: true, paid: true, points: 2360, prevPos: 7 },
  { name: "StanleyBoessen", matches: 72, winner: false, topscorer: false, paid: true, points: 1915, prevPos: 37 },
  { name: "GonnyDebode", matches: 72, winner: true, topscorer: true, paid: true, points: 1660, prevPos: 44 },
  { name: "Marlayne", matches: 47, winner: true, topscorer: true, paid: true, points: 1575, prevPos: 49 },
  { name: "Jules-", matches: 72, winner: true, topscorer: true, paid: true, points: 1940, prevPos: 34 },
  { name: "Harro1", matches: 72, winner: true, topscorer: true, paid: true, points: 1790, prevPos: 43 },
  { name: "JRHJNB", matches: 72, winner: true, topscorer: true, paid: true, points: 2030, prevPos: 30 },
  { name: "JoycevanRiet", matches: 72, winner: true, topscorer: true, paid: true, points: 1675, prevPos: 47 },
  { name: "Heer", matches: 72, winner: true, topscorer: true, paid: true, points: 2490, prevPos: 2 },
  ...
  { name: "GeorgeV.", matches: 72, winner: true, topscorer: true, paid: true, points: 2355, prevPos: 10 },
  ...
  { name: "Bo.", matches: 72, winner: true, topscorer: true, paid: true, points: 1875, prevPos: 39 },
  ...
  { name: "RoanTuit(messi)", matches: 24, winner: true, topscorer: true, paid: true, points: 1575, prevPos: 49 },
