...
window.POOL_META = {
  ...
  totalPlayers: 52,
  capacityMax: 75,
  syncedAt: "2026-06-16T21:31:29.061Z",
...
window.POOL_PLAYERS = [
  { name: "Wolsman", matches: 104, winner: true, topscorer: true, paid: true, points: 1005, prevPos: 21 },
  { name: "Kleine Flo", matches: 72, winner: true, topscorer: true, paid: true, points: 700, prevPos: 47 },
  { name: "Bertjuh", matches: 72, winner: true, topscorer: true, paid: true, points: 905, prevPos: 29 },
  ...
  { name: "Oppie1978", matches: 24, winner: true, topscorer: true, paid: true, points: 1155, prevPos: 16 },
  { name: "El-Toro-Loco", matches: 11, winner: false, topscorer: false, paid: true, points: 650, prevPos: 45 },
  { name: "StudentjeIndicium", matches: 72, winner: true, topscorer: true, paid: true, points: 1185, prevPos: 15 },
  { name: "Mauricio1980", matches: 72, winner: true, topscorer: true, paid: true, points: 800, prevPos: 37 },
  { name: "AlinevanVuuren", matches: 72, winner: true, topscorer: true, paid: true, points: 1020, prevPos: 18 },
  { name: "Wisselbeker", matches: 32, winner: true, topscorer: true, paid: true, points: 1225, prevPos: 12 },
  { name: "Robertosxs", matches: 104, winner: true, topscorer: true, paid: true, points: 1005, prevPos: 31 },
  { name: "Reboss", matches: 72, winner: true, topscorer: true, paid: true, points: 735, prevPos: 43 },
  { name: "Mobicontrol-Xavier", matches: 53, winner: true, topscorer: true, paid: true, points: 995, prevPos: 19 },
  { name: "Brokkenpiloot", matches: 53, winner: true, topscorer: true, paid: true, points: 1090, prevPos: 13 },
  { name: "Katinkadeb", matches: 72, winner: true, topscorer: true, paid: true, points: 885, prevPos: 41 },
  { name: "BornBjorg", matches: 24, winner: true, topscorer: true, paid: true, points: 1295, prevPos: 2 },
  { name: "Fseton", matches: 28, winner: true, topscorer: true, paid: true, points: 850, prevPos: 35 },
  { name: "Raymond de Haas", matches: 29, winner: true, topscorer: true, paid: true, points: 575, prevPos: 51 },
  { name: "THEGOAT37", matches: 32, winner: true, topscorer: true, paid: true, points: 1125, prevPos: 11 },
  { name: "WesleyMerwe", matches: 27, winner: true, topscorer: true, paid: true, points: 710, prevPos: 46 },
  { name: "Daisy010", matches: 26, winner: true, topscorer: true, paid: true, points: 955, prevPos: 23 },
  { name: "Erol_Ulu", matches: 72, winner: true, topscorer: true, paid: true, points: 1320, prevPos: 7 },
  { name: "Givano", matches: 72, winner: true, topscorer: true, paid: true, points: 1050, prevPos: 24 },
  { name: "VanderLans", matches: 21, winner: true, topscorer: true, paid: true, points: 1135, prevPos: 9 },
  { name: "Trauner_in_Oranje", matches: 20, winner: true, topscorer: true, paid: true, points: 910, prevPos: 27 },
  { name: "Keepertje", matches: 72, winner: true, topscorer: true, paid: true, points: 720, prevPos: 39 },
  { name: "John0504", matches: 72, winner: true, topscorer: true, paid: true, points: 630, prevPos: 49 },
  { name: "Rugnummer67", matches: 25, winner: true, topscorer: true, paid: true, points: 910, prevPos: 27 },
  { name: "Norman.P", matches: 20, winner: true, topscorer: true, paid: true, points: 1250, prevPos: 4 },
  { name: "StanleyBoessen", matches: 72, winner: false, topscorer: false, paid: true, points: 785, prevPos: 32 },
  { name: "GonnyDebode", matches: 72, winner: true, topscorer: true, paid: true, points: 915, prevPos: 25 },
  { name: "Marlayne", matches: 33, winner: true, topscorer: true, paid: true, points: 860, prevPos: 32 },
  { name: "Jules-", matches: 72, winner: true, topscorer: true, paid: true, points: 795, prevPos: 39 },
  { name: "Harro1", matches: 72, winner: true, topscorer: true, paid: true, points: 905, prevPos: 29 },
  { name: "JRHJNB", matches: 72, winner: true, topscorer: true, paid: true, points: 940, prevPos: 36 },
  { name: "JoycevanRiet", matches: 72, winner: true, topscorer: true, paid: true, points: 860, prevPos: 43 },
  { name: "Heer", matches: 72, winner: true, topscorer: true, paid: true, points: 1070, prevPos: 13 },
  { name: "Cornelis2026", matches: 42, winner: true, topscorer: true, paid: true, points: 760, prevPos: 42 },
  { name: "Wkkipje", matches: 19, winner: true, topscorer: true, paid: true, points: 1240, prevPos: 9 },
  { name: "MaureenGLA", matches: 72, winner: true, topscorer: true, paid: true, points: 990, prevPos: 20 },
  ...
  { name: "JanCandiano", matches: 72, winner: true, topscorer: true, paid: true, points: 1000, prevPos: 22 },
  { name: "Bo.", matches: 72, winner: true, topscorer: true, paid: true, points: 660, prevPos: 48 },
  { name: "Koninkie", matches: 72, winner: true, topscorer: true, paid: true, points: 1160, prevPos: 8 },
  { name: "Martijnmeestervoorspeller", matches: 72, winner: true, topscorer: true, paid: true, points: 1160, prevPos: 5 },
  { name: "Crazy Dutchman", matches: 72, winner: true, topscorer: true, paid: true, points: 1235, prevPos: 5 },
  { name: "RoanTuit(messi)", matches: 18, winner: true, topscorer: true, paid: true, points: 875, prevPos: 34 },
  { name: "Christopheramboz", matches: 22, winner: true, topscorer: true, paid: true, points: 1280, prevPos: 3 },
  { name: "WillemCo", matches: 23, winner: false, topscorer: false, paid: true, points: 935, prevPos: 25 },
