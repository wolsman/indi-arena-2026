...
window.POOL_META = {
  ...
  totalPlayers: 52,
  capacityMax: 75,
  syncedAt: "2026-07-01T19:01:39.725Z",
...
window.POOL_PLAYERS = [
  { name: "Wolsman", matches: 104, winner: true, topscorer: true, paid: true, points: 6110, prevPos: 5 },
  { name: "Kleine Flo", matches: 88, winner: true, topscorer: true, paid: true, points: 5725, prevPos: 13 },
  { name: "Bertjuh", matches: 88, winner: true, topscorer: true, paid: true, points: 5025, prevPos: 35 },
  { name: "Bobcorn", matches: 91, winner: true, topscorer: true, paid: true, points: 5400, prevPos: 23 },
  { name: "UedaTopscorer", matches: 88, winner: true, topscorer: true, paid: true, points: 4985, prevPos: 38 },
  { name: "Oppie1978", matches: 87, winner: true, topscorer: true, paid: true, points: 5990, prevPos: 7 },
  { name: "El-Toro-Loco", matches: 82, winner: false, topscorer: false, paid: true, points: 5230, prevPos: 28 },
  { name: "StudentjeIndicium", matches: 72, winner: true, topscorer: true, paid: true, points: 4475, prevPos: 47 },
  { name: "Mauricio1980", matches: 88, winner: true, topscorer: true, paid: true, points: 5665, prevPos: 14 },
  { name: "AlinevanVuuren", matches: 88, winner: true, topscorer: true, paid: true, points: 5105, prevPos: 30 },
  { name: "Wisselbeker", matches: 88, winner: true, topscorer: true, paid: true, points: 5520, prevPos: 21 },
  { name: "Robertosxs", matches: 104, winner: true, topscorer: true, paid: true, points: 6115, prevPos: 4 },
  { name: "Reboss", matches: 84, winner: true, topscorer: true, paid: true, points: 4975, prevPos: 39 },
  ...
  { name: "BornBjorg", matches: 71, winner: true, topscorer: true, paid: true, points: 4990, prevPos: 37 },
  { name: "Fseton", matches: 88, winner: true, topscorer: true, paid: true, points: 5025, prevPos: 35 },
  { name: "Raymond de Haas", matches: 88, winner: true, topscorer: true, paid: true, points: 5590, prevPos: 17 },
  ...
  { name: "Daisy010", matches: 87, winner: true, topscorer: true, paid: true, points: 5615, prevPos: 16 },
  { name: "Erol_Ulu", matches: 88, winner: true, topscorer: true, paid: true, points: 5800, prevPos: 12 },
  { name: "Givano", matches: 88, winner: true, topscorer: true, paid: true, points: 5970, prevPos: 8 },
  { name: "JanvdL", matches: 87, winner: true, topscorer: true, paid: true, points: 5860, prevPos: 10 },
  { name: "Trauner_in_Oranje", matches: 82, winner: true, topscorer: true, paid: true, points: 5305, prevPos: 27 },
  { name: "Keepertje", matches: 91, winner: true, topscorer: true, paid: true, points: 3780, prevPos: 52 },
  { name: "John0504", matches: 88, winner: true, topscorer: true, paid: true, points: 5050, prevPos: 34 },
  { name: "Rugnummer67", matches: 84, winner: true, topscorer: true, paid: true, points: 4860, prevPos: 41 },
  { name: "Norman.P", matches: 86, winner: true, topscorer: true, paid: true, points: 5580, prevPos: 18 },
  { name: "StanleyBoessen", matches: 72, winner: false, topscorer: false, paid: true, points: 4175, prevPos: 50 },
  { name: "GonnyDebode", matches: 91, winner: true, topscorer: true, paid: true, points: 4635, prevPos: 44 },
  { name: "Marlayne", matches: 88, winner: true, topscorer: true, paid: true, points: 4315, prevPos: 49 },
  { name: "Jules-", matches: 91, winner: true, topscorer: true, paid: true, points: 5920, prevPos: 9 },
  { name: "Harro1", matches: 72, winner: true, topscorer: true, paid: true, points: 4865, prevPos: 40 },
  { name: "JRHJNB", matches: 88, winner: true, topscorer: true, paid: true, points: 5410, prevPos: 22 },
  { name: "JoycevanRiet", matches: 87, winner: true, topscorer: true, paid: true, points: 4520, prevPos: 45 },
  { name: "Heer", matches: 87, winner: true, topscorer: true, paid: true, points: 5550, prevPos: 20 },
  { name: "Cornelis2026", matches: 87, winner: true, topscorer: true, paid: true, points: 4430, prevPos: 48 },
  { name: "Wkkipje", matches: 82, winner: true, topscorer: true, paid: true, points: 5105, prevPos: 30 },
  { name: "MaureenGLA", matches: 88, winner: true, topscorer: true, paid: true, points: 5095, prevPos: 32 },
  { name: "GeorgeV.", matches: 83, winner: true, topscorer: true, paid: true, points: 6045, prevPos: 6 },
  { name: "ikgajuichen", matches: 104, winner: true, topscorer: true, paid: true, points: 5095, prevPos: 32 },
  { name: "JanCandiano", matches: 92, winner: true, topscorer: true, paid: true, points: 5380, prevPos: 25 },
  { name: "Bo.", matches: 86, winner: true, topscorer: true, paid: true, points: 5390, prevPos: 24 },
  { name: "Koninkie", matches: 88, winner: true, topscorer: true, paid: true, points: 6210, prevPos: 3 },
