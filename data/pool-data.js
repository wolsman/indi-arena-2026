...
window.POOL_META = {
  ...
  totalPlayers: 55,
  capacityMax: 75,
  syncedAt: "2026-06-14T03:01:37.084Z",
...
window.POOL_PLAYERS = [
  { name: "Wolsman", matches: 104, winner: true, topscorer: true, paid: true, points: 515, prevPos: 7 },
  { name: "Kleine Flo", matches: 72, winner: true, topscorer: true, paid: true, points: 280, prevPos: 35 },
  { name: "Bertjuh", matches: 72, winner: true, topscorer: true, paid: true, points: 355, prevPos: 19 },
  { name: "Bobcorn", matches: 72, winner: true, topscorer: true, paid: true, points: 255, prevPos: 46 },
  { name: "UedaTopscorer", matches: 72, winner: true, topscorer: true, paid: true, points: 280, prevPos: 35 },
  { name: "Oppie1978", matches: 24, winner: true, topscorer: true, paid: true, points: 230, prevPos: 40 },
  { name: "El-Toro-Loco", matches: 11, winner: false, topscorer: false, paid: true, points: 315, prevPos: 29 },
  { name: "StudentjeIndicium", matches: 72, winner: true, topscorer: true, paid: true, points: 515, prevPos: 5 },
  { name: "Mauricio1980", matches: 72, winner: true, topscorer: true, paid: true, points: 355, prevPos: 19 },
  { name: "AlinevanVuuren", matches: 72, winner: true, topscorer: true, paid: true, points: 175, prevPos: 46 },
  { name: "Wisselbeker", matches: 10, winner: true, topscorer: true, paid: true, points: 495, prevPos: 9 },
  { name: "Roantuit", matches: 0, winner: false, topscorer: false, paid: true, points: 0, prevPos: 51 },
  { name: "Robertosxs", matches: 104, winner: true, topscorer: true, paid: true, points: 355, prevPos: 19 },
  { name: "Reboss", matches: 72, winner: true, topscorer: true, paid: true, points: 335, prevPos: 26 },
  ...
  { name: "BornBjorg", matches: 24, winner: true, topscorer: true, paid: true, points: 410, prevPos: 14 },
  { name: "Fseton", matches: 17, winner: true, topscorer: true, paid: true, points: 250, prevPos: 40 },
  ...
  { name: "THEGOAT37", matches: 31, winner: true, topscorer: true, paid: true, points: 375, prevPos: 18 },
  { name: "WesleyMerwe", matches: 27, winner: true, topscorer: true, paid: true, points: 265, prevPos: 33 },
  { name: "Daisy010", matches: 15, winner: true, topscorer: true, paid: true, points: 155, prevPos: 48 },
  { name: "Erol_Ulu", matches: 72, winner: true, topscorer: true, paid: true, points: 615, prevPos: 5 },
  { name: "Givano", matches: 72, winner: true, topscorer: true, paid: true, points: 250, prevPos: 40 },
  { name: "VanderLans", matches: 11, winner: true, topscorer: true, paid: true, points: 390, prevPos: 16 },
  { name: "Trauner_in_Oranje", matches: 8, winner: true, topscorer: true, paid: true, points: 430, prevPos: 13 },
  ...
  { name: "Rugnummer67", matches: 9, winner: true, topscorer: true, paid: true, points: 230, prevPos: 44 },
  { name: "Norman.P", matches: 8, winner: true, topscorer: true, paid: true, points: 770, prevPos: 1 },
  { name: "StanleyBoessen", matches: 72, winner: false, topscorer: false, paid: true, points: 510, prevPos: 8 },
  { name: "GonnyDebode", matches: 72, winner: true, topscorer: true, paid: true, points: 315, prevPos: 29 },
  { name: "Marlayne", matches: 33, winner: true, topscorer: true, paid: true, points: 155, prevPos: 48 },
  { name: "Jules-", matches: 72, winner: true, topscorer: true, paid: true, points: 355, prevPos: 19 },
  { name: "Harro1", matches: 72, winner: true, topscorer: true, paid: true, points: 440, prevPos: 38 },
  { name: "JRHJNB", matches: 72, winner: true, topscorer: true, paid: true, points: 355, prevPos: 19 },
  { name: "JoycevanRiet", matches: 72, winner: true, topscorer: true, paid: true, points: 155, prevPos: 48 },
  { name: "Heer", matches: 72, winner: true, topscorer: true, paid: true, points: 460, prevPos: 10 },
  { name: "Pepijndh", matches: 0, winner: false, topscorer: false, paid: true, points: 0, prevPos: 51 },
  { name: "Cornelis2026", matches: 29, winner: true, topscorer: true, paid: true, points: 315, prevPos: 29 },
  { name: "Wkkipje", matches: 19, winner: true, topscorer: true, paid: true, points: 435, prevPos: 12 },
  { name: "MaureenGLA", matches: 72, winner: true, topscorer: true, paid: true, points: 410, prevPos: 14 },
  { name: "GeorgeV.", matches: 72, winner: true, topscorer: true, paid: true, points: 430, prevPos: 40 },
  { name: "ikgajuichen", matches: 104, winner: true, topscorer: true, paid: true, points: 540, prevPos: 10 },
  ...
  { name: "Koninkie", matches: 72, winner: true, topscorer: true, paid: true, points: 435, prevPos: 39 },
  { name: "Martijnmeestervoorspeller", matches: 72, winner: true, topscorer: true, paid: true, points: 635, prevPos: 2 },
  { name: "Crazy Dutchman", matches: 72, winner: true, topscorer: true, paid: true, points: 635, prevPos: 2 },
  { name: "RoanTuit(messi)", matches: 7, winner: true, topscorer: true, paid: true, points: 415, prevPos: 26 },
  { name: "Christopheramboz", matches: 17, winner: true, topscorer: true, paid: true, points: 635, prevPos: 2 },
...
window.POOL_RESULTS = {"mexico|zuidafrika":"2-0","zuidkorea|tsjechie":"2-1","canada|bosnie":"1-1","usa|paraguay":"4-1","qatar|zwitserland":"1-1","brazilie|marokko":"1-1"};
...
window.POOL_HISTORY = {"Wolsman":[420,495,495,515],"Kleine Flo":[240,260,260,280],"Bertjuh":[220,315,335,355],"Bobcorn":[135,155,155,255],"UedaTopscorer":[240,260,260,280],"Oppie1978":[135,230,230,230],"El-Toro-Loco":[295,295,295,315],"StudentjeIndicium":[420,515,515,515],"Mauricio1980":[240,335,335,355],"AlinevanVuuren":[115,135,155,175],"Wisselbeker":[400,475,475,495],"Roantuit":[0,0,0,0],"Robertosxs":[240,335,335,355],"Reboss":[240,315,315,335],"Mobicontrol":[240,315,315,315],"Brokkenpiloot":[295,370,370,370],"Katinkadeb":[240,335,335,335],"BornBjorg":[295,370,390,410],"Fseton":[135,230,230,250],"Raymond de Haas":[135,230,250,250],"ScheidsTon":[0,0,0,0],"THEGOAT37":[135,155,355,375],"WesleyMerwe":[190,265,265,265],"Daisy010":[40,0,135,155],"Erol_Ulu":[240,315,515,615],"Givano":[135,230,230,250],"VanderLans":[295,370,370,390],"Trauner_in_Oranje":[295,390,410,430],"Keepertje":[0,135,0,0],"John0504":[95,190,210,210],"Rugnummer67":[135,210,210,230],"Norman.P":[495,570,570,770],"StanleyBoessen":[195,290,490,510],"GonnyDebode":[220,295,295,315],"Marlayne":[115,135,135,155],"Jules-":[240,335,335,355],"Harro1":[220,220,240,440],"JRHJNB":[240,335,335,355],"JoycevanRiet":[135,135,135,155],"Heer":[420,440,440,460],"Pepijndh":[0,0,0,0],"Cornelis2026":[75,275,295,315],"Wkkipje":[320,395,415,435],"MaureenGLA":[115,190,390,410],"GeorgeV.":[135,230,230,430],"ikgajuichen":[420,440,440,540],"JanCandiano":[170,265,265,265],"Bo.":[240,335,335,335],"Koninkie":[215,235,235,435],"Martijnmeestervoorspeller":[420,515,535,635],"Crazy Dutchman":[420,515,535,635],"RoanTuit(messi)":[220,315,315,415],"Christopheramboz":[420,515,535,635],"Frenk010fr":[0,0,0,0],"WillemCo":[200,275,275,275]};
