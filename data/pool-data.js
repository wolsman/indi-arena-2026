...
window.POOL_META = {
  ...
  totalPlayers: 52,
  capacityMax: 75,
  syncedAt: "2026-06-22T19:31:31.405Z",
...
window.POOL_PLAYERS = [
  { name: "Wolsman", matches: 104, winner: true, topscorer: true, paid: true, points: 2780, prevPos: 16 },
  { name: "Kleine Flo", matches: 72, winner: true, topscorer: true, paid: true, points: 2520, prevPos: 31 },
  { name: "Bertjuh", matches: 72, winner: true, topscorer: true, paid: true, points: 2625, prevPos: 24 },
  { name: "Bobcorn", matches: 72, winner: true, topscorer: true, paid: true, points: 2700, prevPos: 27 },
  { name: "UedaTopscorer", matches: 72, winner: true, topscorer: true, paid: true, points: 1985, prevPos: 47 },
  ...
  { name: "StudentjeIndicium", matches: 72, winner: true, topscorer: true, paid: true, points: 2620, prevPos: 33 },
  { name: "Mauricio1980", matches: 72, winner: true, topscorer: true, paid: true, points: 2655, prevPos: 22 },
  { name: "AlinevanVuuren", matches: 72, winner: true, topscorer: true, paid: true, points: 2695, prevPos: 18 },
  { name: "Wisselbeker", matches: 48, winner: true, topscorer: true, paid: true, points: 2915, prevPos: 10 },
  { name: "Robertosxs", matches: 104, winner: true, topscorer: true, paid: true, points: 2820, prevPos: 18 },
  { name: "Reboss", matches: 72, winner: true, topscorer: true, paid: true, points: 2465, prevPos: 38 },
  { name: "Mobicontrol-Xavier", matches: 53, winner: true, topscorer: true, paid: true, points: 2945, prevPos: 7 },
  { name: "Brokkenpiloot", matches: 53, winner: true, topscorer: true, paid: true, points: 2915, prevPos: 10 },
  { name: "Katinkadeb", matches: 72, winner: true, topscorer: true, paid: true, points: 2580, prevPos: 26 },
  { name: "BornBjorg", matches: 55, winner: true, topscorer: true, paid: true, points: 1710, prevPos: 52 },
  { name: "Fseton", matches: 72, winner: true, topscorer: true, paid: true, points: 2645, prevPos: 30 },
  { name: "Raymond de Haas", matches: 49, winner: true, topscorer: true, paid: true, points: 2715, prevPos: 25 },
  { name: "THEGOAT37", matches: 70, winner: true, topscorer: true, paid: true, points: 2895, prevPos: 15 },
  { name: "WesleyMerwe", matches: 43, winner: true, topscorer: true, paid: true, points: 2570, prevPos: 35 },
  { name: "Daisy010", matches: 58, winner: true, topscorer: true, paid: true, points: 2770, prevPos: 20 },
  { name: "Erol_Ulu", matches: 72, winner: true, topscorer: true, paid: true, points: 3210, prevPos: 2 },
  { name: "Givano", matches: 72, winner: true, topscorer: true, paid: true, points: 2990, prevPos: 5 },
  { name: "JanvdL", matches: 45, winner: true, topscorer: true, paid: true, points: 3230, prevPos: 3 },
  { name: "Trauner_in_Oranje", matches: 44, winner: true, topscorer: true, paid: true, points: 2675, prevPos: 28 },
  { name: "Keepertje", matches: 72, winner: true, topscorer: true, paid: true, points: 1790, prevPos: 51 },
  { name: "John0504", matches: 72, winner: true, topscorer: true, paid: true, points: 2070, prevPos: 46 },
  { name: "Rugnummer67", matches: 47, winner: true, topscorer: true, paid: true, points: 2625, prevPos: 23 },
  { name: "Norman.P", matches: 43, winner: true, topscorer: true, paid: true, points: 2935, prevPos: 8 },
  { name: "StanleyBoessen", matches: 72, winner: false, topscorer: false, paid: true, points: 2425, prevPos: 31 },
  { name: "GonnyDebode", matches: 72, winner: true, topscorer: true, paid: true, points: 2120, prevPos: 44 },
  { name: "Marlayne", matches: 60, winner: true, topscorer: true, paid: true, points: 1960, prevPos: 49 },
  { name: "Jules-", matches: 72, winner: true, topscorer: true, paid: true, points: 2500, prevPos: 37 },
  { name: "Harro1", matches: 72, winner: true, topscorer: true, paid: true, points: 2220, prevPos: 45 },
  { name: "JRHJNB", matches: 72, winner: true, topscorer: true, paid: true, points: 2535, prevPos: 29 },
  { name: "JoycevanRiet", matches: 72, winner: true, topscorer: true, paid: true, points: 2160, prevPos: 43 },
  ...
  { name: "Wkkipje", matches: 38, winner: true, topscorer: true, paid: true, points: 2205, prevPos: 41 },
  { name: "MaureenGLA", matches: 72, winner: true, topscorer: true, paid: true, points: 2450, prevPos: 34 },
  { name: "GeorgeV.", matches: 72, winner: true, topscorer: true, paid: true, points: 3000, prevPos: 6 },
  { name: "ikgajuichen", matches: 104, winner: true, topscorer: true, paid: true, points: 2800, prevPos: 14 },
  { name: "JanCandiano", matches: 72, winner: true, topscorer: true, paid: true, points: 2660, prevPos: 21 },
  { name: "Bo.", matches: 72, winner: true, topscorer: true, paid: true, points: 2440, prevPos: 36 },
  { name: "Koninkie", matches: 72, winner: true, topscorer: true, paid: true, points: 2950, prevPos: 13 },
  { name: "Martijnmeestervoorspeller", matches: 72, winner: true, topscorer: true, paid: true, points: 2880, prevPos: 12 },
  { name: "Crazy Dutchman", matches: 72, winner: true, topscorer: true, paid: true, points: 3210, prevPos: 1 },
  { name: "RoanTuit(messi)", matches: 32, winner: true, topscorer: true, paid: true, points: 2090, prevPos: 47 },
  { name: "Christopheramboz", matches: 46, winner: true, topscorer: true, paid: true, points: 2720, prevPos: 17 },
  { name: "WillemCo", matches: 46, winner: false, topscorer: false, paid: true, points: 2235, prevPos: 42 },
