...
window.POOL_META = {
  ...
  totalPlayers: 52,
  capacityMax: 75,
  syncedAt: "2026-07-01T23:01:30.625Z",
...
window.POOL_PLAYERS = [
  ...
  { name: "Bobcorn", matches: 91, winner: true, topscorer: true, paid: true, points: 5475, prevPos: 23 },
  { name: "UedaTopscorer", matches: 88, winner: true, topscorer: true, paid: true, points: 5060, prevPos: 38 },
  { name: "Oppie1978", matches: 87, winner: true, topscorer: true, paid: true, points: 6010, prevPos: 7 },
  ...
  { name: "Mauricio1980", matches: 88, winner: true, topscorer: true, paid: true, points: 5665, prevPos: 15 },
  { name: "AlinevanVuuren", matches: 88, winner: true, topscorer: true, paid: true, points: 5125, prevPos: 30 },
  ...
  { name: "Reboss", matches: 84, winner: true, topscorer: true, paid: true, points: 5050, prevPos: 39 },
  ...
  { name: "Katinkadeb", matches: 88, winner: true, topscorer: true, paid: true, points: 4880, prevPos: 41 },
  { name: "BornBjorg", matches: 71, winner: true, topscorer: true, paid: true, points: 5065, prevPos: 37 },
  { name: "Fseton", matches: 88, winner: true, topscorer: true, paid: true, points: 5045, prevPos: 35 },
  { name: "Raymond de Haas", matches: 88, winner: true, topscorer: true, paid: true, points: 5665, prevPos: 18 },
  ...
  { name: "Daisy010", matches: 87, winner: true, topscorer: true, paid: true, points: 5690, prevPos: 17 },
  { name: "Erol_Ulu", matches: 88, winner: true, topscorer: true, paid: true, points: 5875, prevPos: 12 },
  { name: "Givano", matches: 88, winner: true, topscorer: true, paid: true, points: 6045, prevPos: 8 },
  { name: "JanvdL", matches: 87, winner: true, topscorer: true, paid: true, points: 5860, prevPos: 10 },
  { name: "Trauner_in_Oranje", matches: 82, winner: true, topscorer: true, paid: true, points: 5325, prevPos: 27 },
  { name: "Keepertje", matches: 91, winner: true, topscorer: true, paid: true, points: 3780, prevPos: 52 },
  { name: "John0504", matches: 88, winner: true, topscorer: true, paid: true, points: 5145, prevPos: 34 },
  { name: "Rugnummer67", matches: 84, winner: true, topscorer: true, paid: true, points: 4860, prevPos: 41 },
  { name: "Norman.P", matches: 86, winner: true, topscorer: true, paid: true, points: 5580, prevPos: 19 },
  ...
  { name: "JRHJNB", matches: 88, winner: true, topscorer: true, paid: true, points: 5430, prevPos: 22 },
  ...
  { name: "Cornelis2026", matches: 87, winner: true, topscorer: true, paid: true, points: 4505, prevPos: 48 },
  { name: "Wkkipje", matches: 82, winner: true, topscorer: true, paid: true, points: 5125, prevPos: 30 },
  { name: "MaureenGLA", matches: 88, winner: true, topscorer: true, paid: true, points: 5170, prevPos: 32 },
  { name: "GeorgeV.", matches: 83, winner: true, topscorer: true, paid: true, points: 6065, prevPos: 6 },
  { name: "ikgajuichen", matches: 104, winner: true, topscorer: true, paid: true, points: 5170, prevPos: 32 },
  { name: "JanCandiano", matches: 92, winner: true, topscorer: true, paid: true, points: 5475, prevPos: 25 },
  ...
  { name: "Martijnmeestervoorspeller", matches: 87, winner: true, topscorer: true, paid: true, points: 5645, prevPos: 16 },
  { name: "Crazy Dutchman", matches: 86, winner: true, topscorer: true, paid: true, points: 5590, prevPos: 20 },
