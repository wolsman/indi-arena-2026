...
window.POOL_META = {
  ...
  totalPlayers: 56,
  capacityMax: 75,
  syncedAt: "2026-06-14T19:31:22.494Z",
...
window.POOL_PLAYERS = [
  { name: "Wolsman", matches: 104, winner: true, topscorer: true, paid: true, points: 790, prevPos: 3 },
  { name: "Kleine Flo", matches: 72, winner: true, topscorer: true, paid: true, points: 450, prevPos: 36 },
  { name: "Bertjuh", matches: 72, winner: true, topscorer: true, paid: true, points: 630, prevPos: 15 },
  { name: "Bobcorn", matches: 72, winner: true, topscorer: true, paid: true, points: 475, prevPos: 27 },
  { name: "UedaTopscorer", matches: 72, winner: true, topscorer: true, paid: true, points: 375, prevPos: 45 },
  { name: "Oppie1978", matches: 24, winner: true, topscorer: true, paid: true, points: 400, prevPos: 44 },
  { name: "El-Toro-Loco", matches: 11, winner: false, topscorer: false, paid: true, points: 610, prevPos: 20 },
  { name: "StudentjeIndicium", matches: 72, winner: true, topscorer: true, paid: true, points: 630, prevPos: 20 },
  { name: "Mauricio1980", matches: 72, winner: true, topscorer: true, paid: true, points: 525, prevPos: 28 },
  { name: "AlinevanVuuren", matches: 72, winner: true, topscorer: true, paid: true, points: 490, prevPos: 46 },
  ...
  { name: "Robertosxs", matches: 104, winner: true, topscorer: true, paid: true, points: 630, prevPos: 15 },
  { name: "Reboss", matches: 72, winner: true, topscorer: true, paid: true, points: 505, prevPos: 32 },
  { name: "Mobicontrol", matches: 53, winner: true, topscorer: true, paid: true, points: 590, prevPos: 23 },
  { name: "Brokkenpiloot", matches: 24, winner: true, topscorer: true, paid: true, points: 540, prevPos: 26 },
  { name: "Katinkadeb", matches: 72, winner: true, topscorer: true, paid: true, points: 450, prevPos: 36 },
  { name: "BornBjorg", matches: 24, winner: true, topscorer: true, paid: true, points: 685, prevPos: 12 },
  { name: "Fseton", matches: 24, winner: true, topscorer: true, paid: true, points: 525, prevPos: 28 },
  { name: "Raymond de Haas", matches: 14, winner: true, topscorer: true, paid: true, points: 420, prevPos: 41 },
  ...
  { name: "Erol_Ulu", matches: 72, winner: true, topscorer: true, paid: true, points: 785, prevPos: 4 },
  { name: "Givano", matches: 72, winner: true, topscorer: true, paid: true, points: 420, prevPos: 41 },
  { name: "VanderLans", matches: 15, winner: true, topscorer: true, paid: true, points: 665, prevPos: 13 },
  { name: "Trauner_in_Oranje", matches: 12, winner: true, topscorer: true, paid: true, points: 620, prevPos: 19 },
  { name: "Keepertje", matches: 72, winner: true, topscorer: true, paid: true, points: 325, prevPos: 49 },
  ...
  { name: "StanleyBoessen", matches: 72, winner: false, topscorer: false, paid: true, points: 645, prevPos: 17 },
  { name: "GonnyDebode", matches: 72, winner: true, topscorer: true, paid: true, points: 505, prevPos: 34 },
  { name: "Marlayne", matches: 33, winner: true, topscorer: true, paid: true, points: 470, prevPos: 36 },
  { name: "Jules-", matches: 72, winner: true, topscorer: true, paid: true, points: 525, prevPos: 28 },
  { name: "Harro1", matches: 72, winner: true, topscorer: true, paid: true, points: 610, prevPos: 20 },
  { name: "JRHJNB", matches: 72, winner: true, topscorer: true, paid: true, points: 525, prevPos: 28 },
  { name: "JoycevanRiet", matches: 72, winner: true, topscorer: true, paid: true, points: 0, prevPos: 51 },
  { name: "Heer", matches: 72, winner: true, topscorer: true, paid: true, points: 735, prevPos: 8 },
  { name: "Pepijndh", matches: 0, winner: false, topscorer: false, paid: true, points: 0, prevPos: 51 },
  { name: "Cornelis2026", matches: 29, winner: true, topscorer: true, paid: true, points: 465, prevPos: 35 },
  { name: "Wkkipje", matches: 19, winner: true, topscorer: true, paid: true, points: 625, prevPos: 17 },
  ...
  { name: "JanCandiano", matches: 72, winner: true, topscorer: true, paid: true, points: 435, prevPos: 40 },
  { name: "Bo.", matches: 72, winner: true, topscorer: true, paid: true, points: 505, prevPos: 32 },
  { name: "Koninkie", matches: 72, winner: true, topscorer: true, paid: true, points: 750, prevPos: 9 },
  { name: "Martijnmeestervoorspeller", matches: 72, winner: true, topscorer: true, paid: true, points: 805, prevPos: 4 },
  { name: "Crazy Dutchman", matches: 72, winner: true, topscorer: true, paid: true, points: 805, prevPos: 4 },
  { name: "RoanTuit(messi)", matches: 8, winner: true, topscorer: true, paid: true, points: 605, prevPos: 24 },
  ...
  { name: "WillemCo", matches: 13, winner: false, topscorer: false, paid: true, points: 465, prevPos: 39 },
