...
window.POOL_META = {
  ...
  totalPlayers: 56,
  capacityMax: 75,
  syncedAt: "2026-06-14T22:01:37.638Z",
...
window.POOL_PLAYERS = [
  { name: "Wolsman", matches: 104, winner: true, topscorer: true, paid: true, points: 810, prevPos: 5 },
  ...
  { name: "Bobcorn", matches: 72, winner: true, topscorer: true, paid: true, points: 475, prevPos: 35 },
  { name: "UedaTopscorer", matches: 72, winner: true, topscorer: true, paid: true, points: 395, prevPos: 46 },
  { name: "Oppie1978", matches: 24, winner: true, topscorer: true, paid: true, points: 600, prevPos: 45 },
  { name: "El-Toro-Loco", matches: 11, winner: false, topscorer: false, paid: true, points: 630, prevPos: 21 },
  { name: "StudentjeIndicium", matches: 72, winner: true, topscorer: true, paid: true, points: 630, prevPos: 16 },
  { name: "Mauricio1980", matches: 72, winner: true, topscorer: true, paid: true, points: 545, prevPos: 27 },
  { name: "AlinevanVuuren", matches: 72, winner: true, topscorer: true, paid: true, points: 510, prevPos: 34 },
  { name: "Wisselbeker", matches: 26, winner: true, topscorer: true, paid: true, points: 790, prevPos: 7 },
  ...
  { name: "Mobicontrol", matches: 53, winner: true, topscorer: true, paid: true, points: 610, prevPos: 24 },
  { name: "Brokkenpiloot", matches: 24, winner: true, topscorer: true, paid: true, points: 560, prevPos: 26 },
  { name: "Katinkadeb", matches: 72, winner: true, topscorer: true, paid: true, points: 470, prevPos: 39 },
  { name: "BornBjorg", matches: 24, winner: true, topscorer: true, paid: true, points: 885, prevPos: 12 },
  { name: "Fseton", matches: 24, winner: true, topscorer: true, paid: true, points: 545, prevPos: 27 },
  { name: "Raymond de Haas", matches: 14, winner: true, topscorer: true, paid: true, points: 420, prevPos: 43 },
  { name: "ScheidsTon", matches: 0, winner: false, topscorer: false, paid: true, points: 0, prevPos: 51 },
  { name: "THEGOAT37", matches: 31, winner: true, topscorer: true, paid: true, points: 650, prevPos: 14 },
  { name: "WesleyMerwe", matches: 27, winner: true, topscorer: true, paid: true, points: 360, prevPos: 47 },
  { name: "Daisy010", matches: 18, winner: true, topscorer: true, paid: true, points: 365, prevPos: 49 },
  { name: "Erol_Ulu", matches: 72, winner: true, topscorer: true, paid: true, points: 785, prevPos: 6 },
  { name: "Givano", matches: 72, winner: true, topscorer: true, paid: true, points: 440, prevPos: 43 },
  { name: "VanderLans", matches: 15, winner: true, topscorer: true, paid: true, points: 865, prevPos: 13 },
  { name: "Trauner_in_Oranje", matches: 12, winner: true, topscorer: true, paid: true, points: 620, prevPos: 20 },
  { name: "Keepertje", matches: 72, winner: true, topscorer: true, paid: true, points: 345, prevPos: 50 },
  { name: "John0504", matches: 72, winner: true, topscorer: true, paid: true, points: 360, prevPos: 47 },
  { name: "Rugnummer67", matches: 16, winner: true, topscorer: true, paid: true, points: 460, prevPos: 41 },
  { name: "Norman.P", matches: 13, winner: true, topscorer: true, paid: true, points: 940, prevPos: 1 },
  ...
  { name: "Marlayne", matches: 33, winner: true, topscorer: true, paid: true, points: 470, prevPos: 36 },
  { name: "Jules-", matches: 72, winner: true, topscorer: true, paid: true, points: 545, prevPos: 27 },
  { name: "Harro1", matches: 72, winner: true, topscorer: true, paid: true, points: 610, prevPos: 21 },
  { name: "JRHJNB", matches: 72, winner: true, topscorer: true, paid: true, points: 525, prevPos: 27 },
  { name: "JoycevanRiet", matches: 72, winner: true, topscorer: true, paid: true, points: 0, prevPos: 51 },
  { name: "Heer", matches: 72, winner: true, topscorer: true, paid: true, points: 755, prevPos: 9 },
  ...
  { name: "GeorgeV.", matches: 72, winner: true, topscorer: true, paid: true, points: 705, prevPos: 11 },
  { name: "ikgajuichen", matches: 104, winner: true, topscorer: true, paid: true, points: 710, prevPos: 10 },
  { name: "JanCandiano", matches: 72, winner: true, topscorer: true, paid: true, points: 435, prevPos: 42 },
  { name: "Bo.", matches: 72, winner: true, topscorer: true, paid: true, points: 525, prevPos: 31 },
  { name: "Koninkie", matches: 72, winner: true, topscorer: true, paid: true, points: 770, prevPos: 8 },
  { name: "Martijnmeestervoorspeller", matches: 72, winner: true, topscorer: true, paid: true, points: 825, prevPos: 2 },
  { name: "Crazy Dutchman", matches: 72, winner: true, topscorer: true, paid: true, points: 825, prevPos: 2 },
  { name: "RoanTuit(messi)", matches: 8, winner: true, topscorer: true, paid: true, points: 605, prevPos: 23 },
  ...
  { name: "WillemCo", matches: 13, winner: false, topscorer: false, paid: true, points: 465, prevPos: 37 },
...
window.POOL_RESULTS = {"mexico|zuidafrika":"2-0","zuidkorea|tsjechie":"2-1","canada|bosnie":"1-1","usa|paraguay":"4-1","qatar|zwitserland":"1-1","brazilie|marokko":"1-1","haiti|schotland":"0-1","australie|turkije":"2-0","duitsland|curacao":"7-1"};
...
window.POOL_HISTORY = {"Wolsman":[420,495,495,515,715,715,790,810],"Kleine Flo":[240,260,260,280,375,375,450,470],"Bertjuh":[220,315,335,355,555,555,630,650],"Bobcorn":[135,155,155,255,455,455,475,475],"UedaTopscorer":[240,260,260,280,300,300,375,395],"Oppie1978":[135,230,230,230,305,305,400,600],"El-Toro-Loco":[295,295,295,315,515,535,610,630],"StudentjeIndicium":[420,515,515,515,535,535,630,630],"Mauricio1980":[240,335,335,355,450,450,525,545],"AlinevanVuuren":[115,135,155,175,270,290,490,510],"Wisselbeker":[400,475,475,495,695,695,770,790],"Roantuit":[0,0,0,0,0,0,0,0],"Robertosxs":[240,335,335,355,555,555,630,650],"Reboss":[240,315,315,335,430,430,505,525],"Mobicontrol":[240,315,315,315,515,515,590,610],"Brokkenpiloot":[295,370,370,370,465,465,540,560],"Katinkadeb":[240,335,335,335,355,375,450,470],"BornBjorg":[295,370,390,410,610,610,685,885],"Fseton":[135,230,230,250,450,450,525,545],"Raymond de Haas":[135,230,250,250,345,345,420,420],"ScheidsTon":[0,0,0,0,0,0,0,0],"THEGOAT37":[135,155,355,375,575,575,650,650],"WesleyMerwe":[190,265,265,265,285,285,360,360],"Daisy010":[40,0,135,155,250,250,345,365],"Erol_Ulu":[240,315,515,615,710,710,785,785],"Givano":[135,230,230,250,345,345,420,440],"VanderLans":[295,370,370,390,590,590,665,865],"Trauner_in_Oranje":[295,390,410,430,525,545,620,620],"Keepertje":[0,135,0,0,0,250,325,345],"John0504":[95,190,210,210,285,285,360,360],"Rugnummer67":[135,210,210,230,325,345,440,460],"Norman.P":[495,570,570,770,865,865,940,940],"StanleyBoessen":[195,290,490,510,530,550,645,665],"GonnyDebode":[220,295,295,315,410,410,505,525],"Marlayne":[115,135,135,155,355,375,470,470],"Jules-":[240,335,335,355,450,450,525,545],"Harro1":[220,220,240,440,535,535,610,610],"JRHJNB":[240,335,335,355,450,450,525,525],"JoycevanRiet":[135,135,135,155,250,0,0,0],"Heer":[420,440,440,460,660,660,735,755],"Pepijndh":[0,0,0,0,0,0,0,0],"Cornelis2026":[75,275,295,315,390,390,465,485],"Wkkipje":[320,395,415,435,530,550,625,645],"MaureenGLA":[115,190,390,410,505,505,580,600],"GeorgeV.":[135,230,230,430,630,630,705,705],"ikgajuichen":[420,440,440,540,635,635,710,710],"JanCandiano":[170,265,265,265,360,360,435,435],"Bo.":[240,335,335,335,430,430,505,525],"Koninkie":[215,235,235,435,635,655,750,770],"Martijnmeestervoorspeller":[420,515,535,635,710,710,805,825],"Crazy Dutchman":[420,515,535,635,710,710,805,825],"RoanTuit(messi)":[220,315,315,415,510,510,605,605],"Christopheramboz":[420,515,535,635,730,730,805,1005],"Frenk010fr":[0,0,0,0,0,0,0,0],"WillemCo":[200,275,275,275,370,370,465,465],"Nelson1983":[0,0]};
