...
window.POOL_META = {
  ...
  totalPlayers: 52,
  capacityMax: 75,
  syncedAt: "2026-06-23T12:31:37.383Z",
...
window.POOL_PLAYERS = [
  { name: "Wolsman", matches: 104, winner: true, topscorer: true, paid: true, points: 3130, prevPos: 13 },
  ...
  { name: "Wisselbeker", matches: 48, winner: true, topscorer: true, paid: true, points: 3305, prevPos: 5 },
  ...
  { name: "Raymond de Haas", matches: 62, winner: true, topscorer: true, paid: true, points: 3085, prevPos: 17 },
  ...
  { name: "JanvdL", matches: 51, winner: true, topscorer: true, paid: true, points: 3400, prevPos: 3 },
  { name: "Trauner_in_Oranje", matches: 44, winner: true, topscorer: true, paid: true, points: 2970, prevPos: 21 },
  { name: "Keepertje", matches: 72, winner: true, topscorer: true, paid: true, points: 1925, prevPos: 52 },
  { name: "John0504", matches: 72, winner: true, topscorer: true, paid: true, points: 2545, prevPos: 42 },
  { name: "Rugnummer67", matches: 51, winner: true, topscorer: true, paid: true, points: 2815, prevPos: 27 },
  { name: "Norman.P", matches: 45, winner: true, topscorer: true, paid: true, points: 3125, prevPos: 14 },
  { name: "StanleyBoessen", matches: 72, winner: false, topscorer: false, paid: true, points: 2500, prevPos: 44 },
  { name: "GonnyDebode", matches: 72, winner: true, topscorer: true, paid: true, points: 2255, prevPos: 47 },
  { name: "Marlayne", matches: 60, winner: true, topscorer: true, paid: true, points: 2150, prevPos: 49 },
  { name: "Jules-", matches: 72, winner: true, topscorer: true, paid: true, points: 2870, prevPos: 26 },
  { name: "Harro1", matches: 72, winner: true, topscorer: true, paid: true, points: 2610, prevPos: 39 },
  { name: "JRHJNB", matches: 72, winner: true, topscorer: true, paid: true, points: 2810, prevPos: 29 },
  { name: "JoycevanRiet", matches: 72, winner: true, topscorer: true, paid: true, points: 2405, prevPos: 45 },
  { name: "Heer", matches: 72, winner: true, topscorer: true, paid: true, points: 3235, prevPos: 8 },
  { name: "Cornelis2026", matches: 72, winner: true, topscorer: true, paid: true, points: 2515, prevPos: 43 },
  { name: "Wkkipje", matches: 66, winner: true, topscorer: true, paid: true, points: 2680, prevPos: 38 },
  { name: "MaureenGLA", matches: 72, winner: true, topscorer: true, paid: true, points: 2745, prevPos: 32 },
  { name: "GeorgeV.", matches: 72, winner: true, topscorer: true, paid: true, points: 3135, prevPos: 11 },
  { name: "ikgajuichen", matches: 104, winner: true, topscorer: true, paid: true, points: 2990, prevPos: 20 },
  { name: "JanCandiano", matches: 72, winner: true, topscorer: true, paid: true, points: 2925, prevPos: 23 },
  { name: "Bo.", matches: 72, winner: true, topscorer: true, paid: true, points: 2735, prevPos: 35 },
  { name: "Koninkie", matches: 72, winner: true, topscorer: true, paid: true, points: 3300, prevPos: 6 },
  { name: "Martijnmeestervoorspeller", matches: 72, winner: true, topscorer: true, paid: true, points: 3145, prevPos: 10 },
  ...
  { name: "Christopheramboz", matches: 46, winner: true, topscorer: true, paid: true, points: 3035, prevPos: 18 },
  { name: "WillemCo", matches: 46, winner: false, topscorer: false, paid: true, points: 2585, prevPos: 40 },
