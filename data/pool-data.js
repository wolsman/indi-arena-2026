...
window.POOL_META = {
  ...
  totalPlayers: 55,
  capacityMax: 75,
  syncedAt: "2026-06-13T19:01:36.144Z",
...
window.POOL_PLAYERS = [
  { name: "Wolsman", matches: 104, winner: true, topscorer: true, paid: true, points: 495, prevPos: 6 },
  { name: "Kleine Flo", matches: 72, winner: true, topscorer: true, paid: true, points: 260, prevPos: 33 },
  { name: "Bertjuh", matches: 72, winner: true, topscorer: true, paid: true, points: 315, prevPos: 21 },
  { name: "Bobcorn", matches: 72, winner: true, topscorer: true, paid: true, points: 155, prevPos: 45 },
  { name: "UedaTopscorer", matches: 72, winner: true, topscorer: true, paid: true, points: 260, prevPos: 33 },
  { name: "Oppie1978", matches: 24, winner: true, topscorer: true, paid: true, points: 230, prevPos: 36 },
  { name: "El-Toro-Loco", matches: 11, winner: false, topscorer: false, paid: true, points: 295, prevPos: 26 },
  { name: "StudentjeIndicium", matches: 72, winner: true, topscorer: true, paid: true, points: 515, prevPos: 2 },
  { name: "Mauricio1980", matches: 72, winner: true, topscorer: true, paid: true, points: 335, prevPos: 15 },
  { name: "AlinevanVuuren", matches: 72, winner: true, topscorer: true, paid: true, points: 135, prevPos: 47 },
  { name: "Wisselbeker", matches: 10, winner: true, topscorer: true, paid: true, points: 475, prevPos: 7 },
  { name: "Roantuit", matches: 0, winner: false, topscorer: false, paid: true, points: 0, prevPos: 51 },
  { name: "Robertosxs", matches: 104, winner: true, topscorer: true, paid: true, points: 335, prevPos: 15 },
  { name: "Reboss", matches: 72, winner: true, topscorer: true, paid: true, points: 315, prevPos: 21 },
  { name: "Mobicontrol", matches: 53, winner: true, topscorer: true, paid: true, points: 315, prevPos: 21 },
  { name: "Brokkenpiloot", matches: 17, winner: true, topscorer: true, paid: true, points: 370, prevPos: 12 },
  { name: "Katinkadeb", matches: 72, winner: true, topscorer: true, paid: true, points: 335, prevPos: 15 },
  { name: "BornBjorg", matches: 24, winner: true, topscorer: true, paid: true, points: 370, prevPos: 12 },
  { name: "Fseton", matches: 17, winner: true, topscorer: true, paid: true, points: 230, prevPos: 36 },
  { name: "Raymond de Haas", matches: 14, winner: true, topscorer: true, paid: true, points: 230, prevPos: 36 },
  { name: "ScheidsTon", matches: 0, winner: false, topscorer: false, paid: true, points: 0, prevPos: 51 },
  { name: "THEGOAT37", matches: 31, winner: true, topscorer: true, paid: true, points: 155, prevPos: 45 },
  { name: "WesleyMerwe", matches: 27, winner: true, topscorer: true, paid: true, points: 265, prevPos: 31 },
  { name: "Daisy010", matches: 15, winner: true, topscorer: true, paid: true, points: 0, prevPos: 51 },
  { name: "Erol_Ulu", matches: 72, winner: true, topscorer: true, paid: true, points: 315, prevPos: 21 },
  { name: "Givano", matches: 72, winner: true, topscorer: true, paid: true, points: 230, prevPos: 36 },
  { name: "VanderLans", matches: 11, winner: true, topscorer: true, paid: true, points: 370, prevPos: 12 },
  { name: "Trauner_in_Oranje", matches: 8, winner: true, topscorer: true, paid: true, points: 390, prevPos: 11 },
  { name: "Keepertje", matches: 72, winner: true, topscorer: true, paid: true, points: 135, prevPos: 47 },
  { name: "John0504", matches: 72, winner: true, topscorer: true, paid: true, points: 190, prevPos: 43 },
  { name: "Rugnummer67", matches: 9, winner: true, topscorer: true, paid: true, points: 210, prevPos: 42 },
  { name: "Norman.P", matches: 6, winner: true, topscorer: true, paid: true, points: 570, prevPos: 1 },
  { name: "StanleyBoessen", matches: 72, winner: false, topscorer: false, paid: true, points: 290, prevPos: 28 },
  { name: "GonnyDebode", matches: 72, winner: true, topscorer: true, paid: true, points: 295, prevPos: 26 },
  { name: "Marlayne", matches: 33, winner: true, topscorer: true, paid: true, points: 135, prevPos: 47 },
  { name: "Jules-", matches: 72, winner: true, topscorer: true, paid: true, points: 335, prevPos: 15 },
  { name: "Harro1", matches: 72, winner: true, topscorer: true, paid: true, points: 220, prevPos: 41 },
  { name: "JRHJNB", matches: 72, winner: true, topscorer: true, paid: true, points: 335, prevPos: 15 },
  { name: "JoycevanRiet", matches: 72, winner: true, topscorer: true, paid: true, points: 135, prevPos: 47 },
  ...
  { name: "JanCandiano", matches: 28, winner: true, topscorer: true, paid: true, points: 265, prevPos: 31 },
  { name: "Bo.", matches: 72, winner: true, topscorer: true, paid: true, points: 335, prevPos: 15 },
  { name: "Koninkie", matches: 72, winner: true, topscorer: true, paid: true, points: 235, prevPos: 35 },
...
window.POOL_HISTORY = {"Wolsman":[420,495],"Kleine Flo":[240,260],"Bertjuh":[220,315],"Bobcorn":[135,155],"UedaTopscorer":[240,260],"Oppie1978":[135,230],"El-Toro-Loco":[295,295],"StudentjeIndicium":[420,515],"Mauricio1980":[240,335],"AlinevanVuuren":[115,135],"Wisselbeker":[400,475],"Roantuit":[0,0],"Robertosxs":[240,335],"Reboss":[240,315],"Mobicontrol":[240,315],"Brokkenpiloot":[295,370],"Katinkadeb":[240,335],"BornBjorg":[295,370],"Fseton":[135,230],"Raymond de Haas":[135,230],"ScheidsTon":[0,0],"THEGOAT37":[135,155],"WesleyMerwe":[190,265],"Daisy010":[40,0],"Erol_Ulu":[240,315],"Givano":[135,230],"VanderLans":[295,370],"Trauner_in_Oranje":[295,390],"Keepertje":[0,135],"John0504":[95,190],"Rugnummer67":[135,210],"Norman.P":[495,570],"StanleyBoessen":[195,290],"GonnyDebode":[220,295],"Marlayne":[115,135],"Jules-":[240,335],"Harro1":[220,220],"JRHJNB":[240,335],"JoycevanRiet":[135,135],"Heer":[420,440],"Pepijndh":[0,0],"Cornelis2026":[75,275],"Wkkipje":[320,395],"MaureenGLA":[115,190],"GeorgeV.":[135,230],"ikgajuichen":[420,440],"JanCandiano":[170,265],"Bo.":[240,335],"Koninkie":[215,235],"Martijnmeestervoorspeller":[420,515],"Crazy Dutchman":[420,515],"RoanTuit(messi)":[220,315],"Christopheramboz":[420,515],"Frenk010fr":[0,0],"WillemCo":[200,275]};
