...
window.POOL_META = {
  ...
  totalPlayers: 55,
  capacityMax: 75,
  syncedAt: "2026-06-13T04:31:28.908Z",
...
window.POOL_PLAYERS = [
  { name: "Wolsman", matches: 104, winner: true, topscorer: true, paid: true, points: 495, prevPos: 2 },
  { name: "Kleine Flo", matches: 72, winner: true, topscorer: true, paid: true, points: 260, prevPos: 16 },
  { name: "Bertjuh", matches: 72, winner: true, topscorer: true, paid: true, points: 315, prevPos: 27 },
  { name: "Bobcorn", matches: 72, winner: true, topscorer: true, paid: true, points: 155, prevPos: 36 },
  { name: "UedaTopscorer", matches: 72, winner: true, topscorer: true, paid: true, points: 260, prevPos: 16 },
  ...
  { name: "Mauricio1980", matches: 72, winner: true, topscorer: true, paid: true, points: 335, prevPos: 16 },
  { name: "AlinevanVuuren", matches: 72, winner: true, topscorer: true, paid: true, points: 135, prevPos: 45 },
  ...
  { name: "Robertosxs", matches: 104, winner: true, topscorer: true, paid: true, points: 335, prevPos: 16 },
  { name: "Reboss", matches: 72, winner: true, topscorer: true, paid: true, points: 315, prevPos: 16 },
  { name: "Mobicontrol", matches: 53, winner: true, topscorer: true, paid: true, points: 315, prevPos: 16 },
  { name: "Brokkenpiloot", matches: 17, winner: true, topscorer: true, paid: true, points: 370, prevPos: 11 },
  { name: "Katinkadeb", matches: 72, winner: true, topscorer: true, paid: true, points: 335, prevPos: 16 },
  { name: "BornBjorg", matches: 24, winner: true, topscorer: true, paid: true, points: 370, prevPos: 11 },
  ...
  { name: "THEGOAT37", matches: 31, winner: true, topscorer: true, paid: true, points: 155, prevPos: 36 },
  { name: "WesleyMerwe", matches: 10, winner: true, topscorer: true, paid: true, points: 265, prevPos: 34 },
  { name: "Daisy010", matches: 15, winner: true, topscorer: true, paid: true, points: 0, prevPos: 50 },
  { name: "Erol_Ulu", matches: 72, winner: true, topscorer: true, paid: true, points: 315, prevPos: 16 },
  { name: "Givano", matches: 72, winner: true, topscorer: true, paid: true, points: 230, prevPos: 36 },
  { name: "VanderLans", matches: 9, winner: true, topscorer: true, paid: true, points: 370, prevPos: 11 },
  { name: "Trauner_in_Oranje", matches: 5, winner: true, topscorer: true, paid: true, points: 390, prevPos: 11 },
  { name: "Keepertje", matches: 72, winner: true, topscorer: true, paid: true, points: 135, prevPos: 51 },
  { name: "John0504", matches: 72, winner: true, topscorer: true, paid: true, points: 190, prevPos: 48 },
  { name: "Rugnummer67", matches: 5, winner: true, topscorer: true, paid: true, points: 210, prevPos: 36 },
  { name: "Norman.P", matches: 4, winner: true, topscorer: true, paid: true, points: 570, prevPos: 1 },
  { name: "StanleyBoessen", matches: 72, winner: false, topscorer: false, paid: true, points: 290, prevPos: 33 },
  { name: "GonnyDebode", matches: 72, winner: true, topscorer: true, paid: true, points: 295, prevPos: 27 },
  { name: "Marlayne", matches: 26, winner: true, topscorer: true, paid: true, points: 135, prevPos: 45 },
  { name: "Jules-", matches: 72, winner: true, topscorer: true, paid: true, points: 335, prevPos: 16 },
  { name: "Harro1", matches: 72, winner: true, topscorer: true, paid: true, points: 220, prevPos: 27 },
  { name: "JRHJNB", matches: 72, winner: true, topscorer: true, paid: true, points: 335, prevPos: 16 },
  { name: "JoycevanRiet", matches: 72, winner: true, topscorer: true, paid: true, points: 135, prevPos: 36 },
  { name: "Heer", matches: 72, winner: true, topscorer: true, paid: true, points: 440, prevPos: 2 },
  { name: "Pepijndh", matches: 0, winner: false, topscorer: false, paid: true, points: 0, prevPos: 51 },
  { name: "Cornelis2026", matches: 29, winner: true, topscorer: true, paid: true, points: 275, prevPos: 49 },
  { name: "Wkkipje", matches: 10, winner: true, topscorer: true, paid: true, points: 395, prevPos: 10 },
  { name: "MaureenGLA", matches: 72, winner: true, topscorer: true, paid: true, points: 190, prevPos: 45 },
  { name: "GeorgeV.", matches: 72, winner: true, topscorer: true, paid: true, points: 230, prevPos: 36 },
  { name: "ikgajuichen", matches: 104, winner: true, topscorer: true, paid: true, points: 440, prevPos: 2 },
  { name: "JanCandiano", matches: 20, winner: true, topscorer: true, paid: true, points: 265, prevPos: 35 },
  { name: "Bo.", matches: 72, winner: true, topscorer: true, paid: true, points: 335, prevPos: 16 },
  { name: "Koninkie", matches: 72, winner: true, topscorer: true, paid: true, points: 235, prevPos: 31 },
  ...
  { name: "RoanTuit(messi)", matches: 7, winner: true, topscorer: true, paid: true, points: 315, prevPos: 27 },
