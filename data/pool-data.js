...
window.POOL_META = {
  ...
  totalPlayers: 52,
  capacityMax: 75,
  syncedAt: "2026-06-22T18:01:31.389Z",
...
window.POOL_PLAYERS = [
  ...
  { name: "Kleine Flo", matches: 72, winner: true, topscorer: true, paid: true, points: 2425, prevPos: 31 },
  { name: "Bertjuh", matches: 72, winner: true, topscorer: true, paid: true, points: 2530, prevPos: 24 },
  { name: "Bobcorn", matches: 72, winner: true, topscorer: true, paid: true, points: 2500, prevPos: 27 },
  { name: "UedaTopscorer", matches: 72, winner: true, topscorer: true, paid: true, points: 1890, prevPos: 47 },
  { name: "Oppie1978", matches: 52, winner: true, topscorer: true, paid: true, points: 2935, prevPos: 4 },
  { name: "El-Toro-Loco", matches: 38, winner: false, topscorer: false, paid: true, points: 2215, prevPos: 40 },
  { name: "StudentjeIndicium", matches: 72, winner: true, topscorer: true, paid: true, points: 2420, prevPos: 33 },
  { name: "Mauricio1980", matches: 72, winner: true, topscorer: true, paid: true, points: 2560, prevPos: 22 },
  { name: "AlinevanVuuren", matches: 72, winner: true, topscorer: true, paid: true, points: 2620, prevPos: 18 },
  { name: "Wisselbeker", matches: 48, winner: true, topscorer: true, paid: true, points: 2820, prevPos: 10 },
  { name: "Robertosxs", matches: 104, winner: true, topscorer: true, paid: true, points: 2620, prevPos: 18 },
  { name: "Reboss", matches: 72, winner: true, topscorer: true, paid: true, points: 2265, prevPos: 38 },
  { name: "Mobicontrol-Xavier", matches: 53, winner: true, topscorer: true, paid: true, points: 2850, prevPos: 7 },
  { name: "Brokkenpiloot", matches: 53, winner: true, topscorer: true, paid: true, points: 2820, prevPos: 10 },
  { name: "Katinkadeb", matches: 72, winner: true, topscorer: true, paid: true, points: 2505, prevPos: 26 },
  { name: "BornBjorg", matches: 24, winner: true, topscorer: true, paid: true, points: 1710, prevPos: 52 },
  { name: "Fseton", matches: 72, winner: true, topscorer: true, paid: true, points: 2445, prevPos: 30 },
  { name: "Raymond de Haas", matches: 49, winner: true, topscorer: true, paid: true, points: 2515, prevPos: 25 },
  ...
  { name: "JanvdL", matches: 45, winner: true, topscorer: true, paid: true, points: 3030, prevPos: 3 },
  { name: "Trauner_in_Oranje", matches: 44, winner: true, topscorer: true, paid: true, points: 2475, prevPos: 28 },
  ...
  { name: "Rugnummer67", matches: 47, winner: true, topscorer: true, paid: true, points: 2550, prevPos: 23 },
  { name: "Norman.P", matches: 40, winner: true, topscorer: true, paid: true, points: 2840, prevPos: 8 },
  { name: "StanleyBoessen", matches: 72, winner: false, topscorer: false, paid: true, points: 2425, prevPos: 31 },
  { name: "GonnyDebode", matches: 72, winner: true, topscorer: true, paid: true, points: 2045, prevPos: 44 },
  { name: "Marlayne", matches: 60, winner: true, topscorer: true, paid: true, points: 1885, prevPos: 49 },
  { name: "Jules-", matches: 72, winner: true, topscorer: true, paid: true, points: 2300, prevPos: 37 },
  { name: "Harro1", matches: 72, winner: true, topscorer: true, paid: true, points: 2020, prevPos: 45 },
  { name: "JRHJNB", matches: 72, winner: true, topscorer: true, paid: true, points: 2460, prevPos: 29 },
  { name: "JoycevanRiet", matches: 72, winner: true, topscorer: true, paid: true, points: 2085, prevPos: 43 },
  { name: "Heer", matches: 72, winner: true, topscorer: true, paid: true, points: 2835, prevPos: 9 },
  { name: "Cornelis2026", matches: 42, winner: true, topscorer: true, paid: true, points: 2250, prevPos: 39 },
  { name: "Wkkipje", matches: 38, winner: true, topscorer: true, paid: true, points: 2185, prevPos: 41 },
  { name: "MaureenGLA", matches: 72, winner: true, topscorer: true, paid: true, points: 2375, prevPos: 34 },
  { name: "GeorgeV.", matches: 72, winner: true, topscorer: true, paid: true, points: 2905, prevPos: 6 },
  { name: "ikgajuichen", matches: 104, winner: true, topscorer: true, paid: true, points: 2705, prevPos: 14 },
  { name: "JanCandiano", matches: 72, winner: true, topscorer: true, paid: true, points: 2565, prevPos: 21 },
  { name: "Bo.", matches: 72, winner: true, topscorer: true, paid: true, points: 2345, prevPos: 36 },
  { name: "Koninkie", matches: 72, winner: true, topscorer: true, paid: true, points: 2750, prevPos: 13 },
  { name: "Martijnmeestervoorspeller", matches: 72, winner: true, topscorer: true, paid: true, points: 2805, prevPos: 12 },
  ...
  { name: "Christopheramboz", matches: 46, winner: true, topscorer: true, paid: true, points: 2645, prevPos: 17 },
  { name: "WillemCo", matches: 46, winner: false, topscorer: false, paid: true, points: 2160, prevPos: 42 },
  { name: "Nelson1983", matches: 38, winner: false, topscorer: false, paid: true, points: 1845, prevPos: 50 }
];
