...
window.POOL_META = {
  ...
  totalPlayers: 52,
  capacityMax: 75,
  syncedAt: "2026-06-17T06:31:32.124Z",
...
window.POOL_PLAYERS = [
  ...
  { name: "UedaTopscorer", matches: 72, winner: true, topscorer: true, paid: true, points: 870, prevPos: 49 },
  { name: "Oppie1978", matches: 24, winner: true, topscorer: true, paid: true, points: 1420, prevPos: 12 },
  { name: "El-Toro-Loco", matches: 11, winner: false, topscorer: false, paid: true, points: 650, prevPos: 51 },
  { name: "StudentjeIndicium", matches: 72, winner: true, topscorer: true, paid: true, points: 1470, prevPos: 9 },
  ...
  { name: "Wisselbeker", matches: 32, winner: true, topscorer: true, paid: true, points: 1595, prevPos: 8 },
  { name: "Robertosxs", matches: 104, winner: true, topscorer: true, paid: true, points: 1270, prevPos: 25 },
  { name: "Reboss", matches: 72, winner: true, topscorer: true, paid: true, points: 980, prevPos: 43 },
  { name: "Mobicontrol-Xavier", matches: 53, winner: true, topscorer: true, paid: true, points: 1345, prevPos: 17 },
  { name: "Brokkenpiloot", matches: 53, winner: true, topscorer: true, paid: true, points: 1335, prevPos: 18 },
  { name: "Katinkadeb", matches: 72, winner: true, topscorer: true, paid: true, points: 1255, prevPos: 27 },
  { name: "BornBjorg", matches: 24, winner: true, topscorer: true, paid: true, points: 1540, prevPos: 3 },
  ...
  { name: "THEGOAT37", matches: 32, winner: true, topscorer: true, paid: true, points: 1390, prevPos: 13 },
  { name: "WesleyMerwe", matches: 27, winner: true, topscorer: true, paid: true, points: 975, prevPos: 44 },
  { name: "Daisy010", matches: 30, winner: true, topscorer: true, paid: true, points: 1220, prevPos: 29 },
  { name: "Erol_Ulu", matches: 72, winner: true, topscorer: true, paid: true, points: 1565, prevPos: 1 },
  { name: "Givano", matches: 72, winner: true, topscorer: true, paid: true, points: 1315, prevPos: 21 },
  { name: "VanderLans", matches: 21, winner: true, topscorer: true, paid: true, points: 1630, prevPos: 4 },
  { name: "Trauner_in_Oranje", matches: 20, winner: true, topscorer: true, paid: true, points: 1155, prevPos: 32 },
  { name: "Keepertje", matches: 72, winner: true, topscorer: true, paid: true, points: 985, prevPos: 45 },
  { name: "John0504", matches: 72, winner: true, topscorer: true, paid: true, points: 895, prevPos: 48 },
  { name: "Rugnummer67", matches: 25, winner: true, topscorer: true, paid: true, points: 1385, prevPos: 15 },
  { name: "Norman.P", matches: 22, winner: true, topscorer: true, paid: true, points: 1495, prevPos: 6 },
  ...
  { name: "Harro1", matches: 72, winner: true, topscorer: true, paid: true, points: 1075, prevPos: 35 },
  { name: "JRHJNB", matches: 72, winner: true, topscorer: true, paid: true, points: 1185, prevPos: 30 },
  { name: "JoycevanRiet", matches: 72, winner: true, topscorer: true, paid: true, points: 1105, prevPos: 37 },
  ...
  { name: "MaureenGLA", matches: 72, winner: true, topscorer: true, paid: true, points: 1235, prevPos: 27 },
  { name: "GeorgeV.", matches: 72, winner: true, topscorer: true, paid: true, points: 1545, prevPos: 2 },
  { name: "ikgajuichen", matches: 104, winner: true, topscorer: true, paid: true, points: 1295, prevPos: 21 },
  { name: "JanCandiano", matches: 72, winner: true, topscorer: true, paid: true, points: 1265, prevPos: 26 },
  { name: "Bo.", matches: 72, winner: true, topscorer: true, paid: true, points: 850, prevPos: 47 },
  { name: "Koninkie", matches: 72, winner: true, topscorer: true, paid: true, points: 1405, prevPos: 11 },
  { name: "Martijnmeestervoorspeller", matches: 72, winner: true, topscorer: true, paid: true, points: 1350, prevPos: 19 },
  { name: "Crazy Dutchman", matches: 72, winner: true, topscorer: true, paid: true, points: 1520, prevPos: 5 },
  { name: "RoanTuit(messi)", matches: 18, winner: true, topscorer: true, paid: true, points: 1140, prevPos: 36 },
  { name: "Christopheramboz", matches: 22, winner: true, topscorer: true, paid: true, points: 1430, prevPos: 10 },
  { name: "WillemCo", matches: 23, winner: false, topscorer: false, paid: true, points: 1305, prevPos: 23 },
