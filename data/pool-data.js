...
window.POOL_META = {
  ...
  totalPlayers: 52,
  capacityMax: 75,
  syncedAt: "2026-06-17T04:01:33.159Z",
...
window.POOL_PLAYERS = [
  { name: "Wolsman", matches: 104, winner: true, topscorer: true, paid: true, points: 1280, prevPos: 19 },
  { name: "Kleine Flo", matches: 72, winner: true, topscorer: true, paid: true, points: 975, prevPos: 46 },
  { name: "Bertjuh", matches: 72, winner: true, topscorer: true, paid: true, points: 1200, prevPos: 31 },
  { name: "Bobcorn", matches: 72, winner: true, topscorer: true, paid: true, points: 995, prevPos: 38 },
  { name: "UedaTopscorer", matches: 72, winner: true, topscorer: true, paid: true, points: 795, prevPos: 50 },
  { name: "Oppie1978", matches: 24, winner: true, topscorer: true, paid: true, points: 1325, prevPos: 12 },
  { name: "El-Toro-Loco", matches: 11, winner: false, topscorer: false, paid: true, points: 650, prevPos: 48 },
  { name: "StudentjeIndicium", matches: 72, winner: true, topscorer: true, paid: true, points: 1375, prevPos: 9 },
  { name: "Mauricio1980", matches: 72, winner: true, topscorer: true, paid: true, points: 950, prevPos: 39 },
  { name: "AlinevanVuuren", matches: 72, winner: true, topscorer: true, paid: true, points: 1315, prevPos: 18 },
  { name: "Wisselbeker", matches: 32, winner: true, topscorer: true, paid: true, points: 1395, prevPos: 8 },
  { name: "Robertosxs", matches: 104, winner: true, topscorer: true, paid: true, points: 1195, prevPos: 19 },
  { name: "Reboss", matches: 72, winner: true, topscorer: true, paid: true, points: 905, prevPos: 43 },
  { name: "Mobicontrol-Xavier", matches: 53, winner: true, topscorer: true, paid: true, points: 1270, prevPos: 22 },
  { name: "Brokkenpiloot", matches: 53, winner: true, topscorer: true, paid: true, points: 1260, prevPos: 15 },
  { name: "Katinkadeb", matches: 72, winner: true, topscorer: true, paid: true, points: 1160, prevPos: 33 },
  { name: "BornBjorg", matches: 24, winner: true, topscorer: true, paid: true, points: 1465, prevPos: 3 },
  { name: "Fseton", matches: 28, winner: true, topscorer: true, paid: true, points: 1020, prevPos: 37 },
  { name: "Raymond de Haas", matches: 29, winner: true, topscorer: true, paid: true, points: 745, prevPos: 51 },
  { name: "THEGOAT37", matches: 32, winner: true, topscorer: true, paid: true, points: 1315, prevPos: 14 },
  { name: "WesleyMerwe", matches: 27, winner: true, topscorer: true, paid: true, points: 900, prevPos: 45 },
  { name: "Daisy010", matches: 26, winner: true, topscorer: true, paid: true, points: 1125, prevPos: 24 },
  { name: "Erol_Ulu", matches: 72, winner: true, topscorer: true, paid: true, points: 1490, prevPos: 2 },
  { name: "Givano", matches: 72, winner: true, topscorer: true, paid: true, points: 1220, prevPos: 17 },
  { name: "VanderLans", matches: 21, winner: true, topscorer: true, paid: true, points: 1430, prevPos: 13 },
  { name: "Trauner_in_Oranje", matches: 20, winner: true, topscorer: true, paid: true, points: 1080, prevPos: 29 },
  { name: "Keepertje", matches: 72, winner: true, topscorer: true, paid: true, points: 890, prevPos: 44 },
  { name: "John0504", matches: 72, winner: true, topscorer: true, paid: true, points: 800, prevPos: 49 },
  { name: "Rugnummer67", matches: 25, winner: true, topscorer: true, paid: true, points: 1310, prevPos: 29 },
  { name: "Norman.P", matches: 20, winner: true, topscorer: true, paid: true, points: 1420, prevPos: 5 },
  { name: "StanleyBoessen", matches: 72, winner: false, topscorer: false, paid: true, points: 975, prevPos: 41 },
  { name: "GonnyDebode", matches: 72, winner: true, topscorer: true, paid: true, points: 1105, prevPos: 28 },
  { name: "Marlayne", matches: 33, winner: true, topscorer: true, paid: true, points: 1080, prevPos: 35 },
  { name: "Jules-", matches: 72, winner: true, topscorer: true, paid: true, points: 1070, prevPos: 40 },
  { name: "Harro1", matches: 72, winner: true, topscorer: true, paid: true, points: 1055, prevPos: 31 },
  { name: "JRHJNB", matches: 72, winner: true, topscorer: true, paid: true, points: 1110, prevPos: 26 },
  { name: "JoycevanRiet", matches: 72, winner: true, topscorer: true, paid: true, points: 1030, prevPos: 35 },
  { name: "Heer", matches: 72, winner: true, topscorer: true, paid: true, points: 1240, prevPos: 16 },
  { name: "Cornelis2026", matches: 42, winner: true, topscorer: true, paid: true, points: 835, prevPos: 42 },
  { name: "Wkkipje", matches: 19, winner: true, topscorer: true, paid: true, points: 1410, prevPos: 6 },
  { name: "MaureenGLA", matches: 72, winner: true, topscorer: true, paid: true, points: 1160, prevPos: 23 },
  { name: "GeorgeV.", matches: 72, winner: true, topscorer: true, paid: true, points: 1470, prevPos: 1 },
  { name: "ikgajuichen", matches: 104, winner: true, topscorer: true, paid: true, points: 1220, prevPos: 25 },
  { name: "JanCandiano", matches: 72, winner: true, topscorer: true, paid: true, points: 1170, prevPos: 21 },
  { name: "Bo.", matches: 72, winner: true, topscorer: true, paid: true, points: 830, prevPos: 47 },
  { name: "Koninkie", matches: 72, winner: true, topscorer: true, paid: true, points: 1330, prevPos: 10 },
  { name: "Martijnmeestervoorspeller", matches: 72, winner: true, topscorer: true, paid: true, points: 1255, prevPos: 10 },
  { name: "Crazy Dutchman", matches: 72, winner: true, topscorer: true, paid: true, points: 1425, prevPos: 7 },
  { name: "RoanTuit(messi)", matches: 18, winner: true, topscorer: true, paid: true, points: 1045, prevPos: 34 },
  { name: "Christopheramboz", matches: 22, winner: true, topscorer: true, paid: true, points: 1355, prevPos: 4 },
  { name: "WillemCo", matches: 23, winner: false, topscorer: false, paid: true, points: 1210, prevPos: 27 },
