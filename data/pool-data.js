...
window.POOL_META = {
  ...
  totalPlayers: 52,
  capacityMax: 75,
  syncedAt: "2026-06-23T19:01:46.713Z",
...
window.POOL_PLAYERS = [
  { name: "Wolsman", matches: 104, winner: true, topscorer: true, paid: true, points: 3225, prevPos: 13 },
  { name: "Kleine Flo", matches: 72, winner: true, topscorer: true, paid: true, points: 2835, prevPos: 33 },
  { name: "Bertjuh", matches: 72, winner: true, topscorer: true, paid: true, points: 2835, prevPos: 33 },
  ...
  { name: "El-Toro-Loco", matches: 49, winner: false, topscorer: false, paid: true, points: 2630, prevPos: 41 },
  { name: "StudentjeIndicium", matches: 72, winner: true, topscorer: true, paid: true, points: 2830, prevPos: 35 },
  { name: "Mauricio1980", matches: 72, winner: true, topscorer: true, paid: true, points: 2975, prevPos: 24 },
  { name: "AlinevanVuuren", matches: 72, winner: true, topscorer: true, paid: true, points: 2980, prevPos: 25 },
  { name: "Wisselbeker", matches: 48, winner: true, topscorer: true, paid: true, points: 3380, prevPos: 5 },
  ...
  { name: "Mobicontrol-Xavier", matches: 56, winner: true, topscorer: true, paid: true, points: 3230, prevPos: 11 },
  { name: "Brokkenpiloot", matches: 72, winner: true, topscorer: true, paid: true, points: 3360, prevPos: 7 },
  ...
  { name: "Givano", matches: 72, winner: true, topscorer: true, paid: true, points: 3400, prevPos: 9 },
  ...
  { name: "John0504", matches: 72, winner: true, topscorer: true, paid: true, points: 2640, prevPos: 42 },
  { name: "Rugnummer67", matches: 51, winner: true, topscorer: true, paid: true, points: 2910, prevPos: 27 },
  { name: "Norman.P", matches: 47, winner: true, topscorer: true, paid: true, points: 3220, prevPos: 14 },
  { name: "StanleyBoessen", matches: 72, winner: false, topscorer: false, paid: true, points: 2595, prevPos: 44 },
  { name: "GonnyDebode", matches: 72, winner: true, topscorer: true, paid: true, points: 2330, prevPos: 47 },
  ...
  { name: "Heer", matches: 72, winner: true, topscorer: true, paid: true, points: 3330, prevPos: 8 },
  { name: "Cornelis2026", matches: 72, winner: true, topscorer: true, paid: true, points: 2590, prevPos: 43 },
  { name: "Wkkipje", matches: 66, winner: true, topscorer: true, paid: true, points: 2775, prevPos: 38 },
  { name: "MaureenGLA", matches: 72, winner: true, topscorer: true, paid: true, points: 2820, prevPos: 32 },
  { name: "GeorgeV.", matches: 72, winner: true, topscorer: true, paid: true, points: 3230, prevPos: 11 },
  ...
  { name: "Bo.", matches: 72, winner: true, topscorer: true, paid: true, points: 2830, prevPos: 35 },
  { name: "Koninkie", matches: 72, winner: true, topscorer: true, paid: true, points: 3395, prevPos: 6 },
  { name: "Martijnmeestervoorspeller", matches: 72, winner: true, topscorer: true, paid: true, points: 3220, prevPos: 10 },
  { name: "Crazy Dutchman", matches: 72, winner: true, topscorer: true, paid: true, points: 3570, prevPos: 1 },
  { name: "RoanTuit(messi)", matches: 32, winner: true, topscorer: true, paid: true, points: 2280, prevPos: 46 },
  { name: "Christopheramboz", matches: 46, winner: true, topscorer: true, paid: true, points: 3130, prevPos: 18 },
