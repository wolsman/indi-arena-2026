...
window.POOL_META = {
  ...
  totalPlayers: 52,
  capacityMax: 75,
  syncedAt: "2026-07-01T17:31:29.384Z",
...
window.POOL_PLAYERS = [
  ...
  { name: "Kleine Flo", matches: 88, winner: true, topscorer: true, paid: true, points: 5525, prevPos: 15 },
  { name: "Bertjuh", matches: 88, winner: true, topscorer: true, paid: true, points: 4930, prevPos: 34 },
  { name: "Bobcorn", matches: 91, winner: true, topscorer: true, paid: true, points: 5380, prevPos: 21 },
  { name: "UedaTopscorer", matches: 88, winner: true, topscorer: true, paid: true, points: 4890, prevPos: 37 },
  { name: "Oppie1978", matches: 87, winner: true, topscorer: true, paid: true, points: 5790, prevPos: 9 },
  { name: "El-Toro-Loco", matches: 82, winner: false, topscorer: false, paid: true, points: 5155, prevPos: 27 },
  { name: "StudentjeIndicium", matches: 72, winner: true, topscorer: true, paid: true, points: 4475, prevPos: 44 },
  { name: "Mauricio1980", matches: 88, winner: true, topscorer: true, paid: true, points: 5590, prevPos: 13 },
  { name: "AlinevanVuuren", matches: 88, winner: true, topscorer: true, paid: true, points: 5030, prevPos: 29 },
  ...
  { name: "Reboss", matches: 84, winner: true, topscorer: true, paid: true, points: 4880, prevPos: 38 },
  { name: "Mobicontrol-van-Riet", matches: 91, winner: true, topscorer: true, paid: true, points: 6260, prevPos: 1 },
  { name: "Brokkenpiloot", matches: 88, winner: true, topscorer: true, paid: true, points: 5125, prevPos: 28 },
  { name: "Katinkadeb", matches: 88, winner: true, topscorer: true, paid: true, points: 4765, prevPos: 41 },
  { name: "BornBjorg", matches: 71, winner: true, topscorer: true, paid: true, points: 4915, prevPos: 35 },
  { name: "Fseton", matches: 88, winner: true, topscorer: true, paid: true, points: 4825, prevPos: 40 },
  { name: "Raymond de Haas", matches: 88, winner: true, topscorer: true, paid: true, points: 5495, prevPos: 16 },
  ...
  { name: "Daisy010", matches: 87, winner: true, topscorer: true, paid: true, points: 5415, prevPos: 20 },
  { name: "Erol_Ulu", matches: 88, winner: true, topscorer: true, paid: true, points: 5705, prevPos: 12 },
  { name: "Givano", matches: 88, winner: true, topscorer: true, paid: true, points: 5875, prevPos: 6 },
  { name: "JanvdL", matches: 87, winner: true, topscorer: true, paid: true, points: 5785, prevPos: 10 },
  { name: "Trauner_in_Oranje", matches: 82, winner: true, topscorer: true, paid: true, points: 5230, prevPos: 24 },
  { name: "Keepertje", matches: 91, winner: true, topscorer: true, paid: true, points: 3685, prevPos: 52 },
  { name: "John0504", matches: 88, winner: true, topscorer: true, paid: true, points: 4955, prevPos: 33 },
  { name: "Rugnummer67", matches: 84, winner: true, topscorer: true, paid: true, points: 4765, prevPos: 41 },
  { name: "Norman.P", matches: 86, winner: true, topscorer: true, paid: true, points: 5485, prevPos: 17 },
  { name: "StanleyBoessen", matches: 72, winner: false, topscorer: false, paid: true, points: 4175, prevPos: 50 },
  { name: "GonnyDebode", matches: 91, winner: true, topscorer: true, paid: true, points: 4435, prevPos: 46 },
  { name: "Marlayne", matches: 88, winner: true, topscorer: true, paid: true, points: 4315, prevPos: 48 },
  { name: "Jules-", matches: 91, winner: true, topscorer: true, paid: true, points: 5845, prevPos: 7 },
  ...
  { name: "Heer", matches: 87, winner: true, topscorer: true, paid: true, points: 5530, prevPos: 14 },
  { name: "Cornelis2026", matches: 87, winner: true, topscorer: true, paid: true, points: 4335, prevPos: 47 },
  { name: "Wkkipje", matches: 82, winner: true, topscorer: true, paid: true, points: 4905, prevPos: 36 },
  { name: "MaureenGLA", matches: 88, winner: true, topscorer: true, paid: true, points: 5020, prevPos: 31 },
  { name: "GeorgeV.", matches: 83, winner: true, topscorer: true, paid: true, points: 5845, prevPos: 7 },
  { name: "ikgajuichen", matches: 104, winner: true, topscorer: true, paid: true, points: 5000, prevPos: 32 },
  { name: "JanCandiano", matches: 92, winner: true, topscorer: true, paid: true, points: 5180, prevPos: 26 },
  { name: "Bo.", matches: 86, winner: true, topscorer: true, paid: true, points: 5295, prevPos: 23 },
  { name: "Koninkie", matches: 88, winner: true, topscorer: true, paid: true, points: 6010, prevPos: 5 },
  { name: "Martijnmeestervoorspeller", matches: 87, winner: true, topscorer: true, paid: true, points: 5425, prevPos: 19 },
  { name: "Crazy Dutchman", matches: 86, winner: true, topscorer: true, paid: true, points: 5370, prevPos: 22 },
  ...
  { name: "WillemCo", matches: 81, winner: false, topscorer: false, paid: true, points: 4295, prevPos: 49 },
  { name: "Nelson1983", matches: 75, winner: false, topscorer: false, paid: true, points: 4530, prevPos: 43 }
];
