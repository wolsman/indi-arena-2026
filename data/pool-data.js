...
window.POOL_META = {
  ...
  totalPlayers: 54,
  capacityMax: 75,
  syncedAt: "2026-06-12T09:30:51.072Z",
...
window.POOL_PLAYERS = [
  { name: "Wolsman", matches: 104, winner: true, topscorer: true, paid: true, points: 400 },
  { name: "Kleine Flo", matches: 72, winner: true, topscorer: true, paid: true, points: 220 },
  { name: "Bertjuh", matches: 72, winner: true, topscorer: true, paid: true, points: 200 },
  { name: "Bobcorn", matches: 72, winner: true, topscorer: true, paid: true, points: 115 },
  { name: "UedaTopscorer", matches: 72, winner: true, topscorer: true, paid: true, points: 220 },
  { name: "Oppie1978", matches: 24, winner: true, topscorer: true, paid: true, points: 115 },
  { name: "El-Toro-Loco", matches: 11, winner: false, topscorer: false, paid: true, points: 95 },
  { name: "StudentjeIndicium", matches: 14, winner: true, topscorer: true, paid: true, points: 220 },
  { name: "Mauricio1980", matches: 72, winner: true, topscorer: true, paid: true, points: 220 },
  { name: "AlinevanVuuren", matches: 72, winner: true, topscorer: true, paid: true, points: 115 },
  ...
  { name: "Robertosxs", matches: 104, winner: true, topscorer: true, paid: true, points: 220 },
  { name: "Reboss", matches: 72, winner: true, topscorer: true, paid: true, points: 220 },
  { name: "Mobicontrol", matches: 53, winner: true, topscorer: true, paid: true, points: 220 },
  { name: "Brokkenpiloot", matches: 17, winner: true, topscorer: true, paid: true, points: 295 },
  { name: "Katinkadeb", matches: 72, winner: true, topscorer: true, paid: true, points: 220 },
  { name: "BornBjorg", matches: 24, winner: true, topscorer: true, paid: true, points: 95 },
  { name: "Fseton", matches: 10, winner: true, topscorer: true, paid: true, points: 115 },
  { name: "Raymond de Haas", matches: 10, winner: true, topscorer: true, paid: true, points: 115 },
  { name: "ScheidsTon", matches: 0, winner: false, topscorer: false, paid: true, points: 0 },
  { name: "THEGOAT37", matches: 31, winner: true, topscorer: true, paid: true, points: 115 },
  { name: "WesleyMerwe", matches: 10, winner: true, topscorer: true, paid: true, points: 170 },
  { name: "Daisy010", matches: 14, winner: true, topscorer: true, paid: true, points: 40 },
  { name: "Erol_Ulu", matches: 72, winner: true, topscorer: true, paid: true, points: 220 },
  { name: "Givano", matches: 72, winner: true, topscorer: true, paid: true, points: 115 },
  { name: "VanderLans", matches: 9, winner: true, topscorer: true, paid: true, points: 95 },
  { name: "Trauner_in_Oranje", matches: 2, winner: true, topscorer: true, paid: true, points: 275 },
  { name: "Keepertje", matches: 72, winner: true, topscorer: true, paid: true, points: 20 },
  { name: "John0504", matches: 72, winner: true, topscorer: true, paid: true, points: 75 },
  { name: "Rugnummer67", matches: 5, winner: true, topscorer: true, paid: true, points: 115 },
  { name: "Norman.P", matches: 2, winner: true, topscorer: true, paid: true, points: 295 },
  { name: "StanleyBoessen", matches: 72, winner: false, topscorer: false, paid: true, points: 95 },
  { name: "GonnyDebode", matches: 72, winner: true, topscorer: true, paid: true, points: 200 },
  { name: "Marlayne", matches: 26, winner: true, topscorer: true, paid: true, points: 95 },
  { name: "Jules-", matches: 72, winner: true, topscorer: true, paid: true, points: 40 },
  { name: "Harro1", matches: 72, winner: true, topscorer: true, paid: true, points: 200 },
  { name: "JRHJNB", matches: 72, winner: true, topscorer: true, paid: true, points: 220 },
  { name: "JoycevanRiet", matches: 72, winner: true, topscorer: true, paid: true, points: 115 },
  { name: "Heer", matches: 72, winner: true, topscorer: true, paid: true, points: 220 },
  ...
  { name: "Wkkipje", matches: 10, winner: true, topscorer: true, paid: true, points: 220 },
  { name: "MaureenGLA", matches: 72, winner: true, topscorer: true, paid: true, points: 115 },
  { name: "GeorgeV.", matches: 72, winner: true, topscorer: true, paid: true, points: 115 },
  { name: "ikgajuichen", matches: 104, winner: true, topscorer: true, paid: true, points: 400 },
  { name: "JanCandiano", matches: 20, winner: true, topscorer: true, paid: true, points: 170 },
  { name: "Bo.", matches: 72, winner: true, topscorer: true, paid: true, points: 220 },
  { name: "Koninkie", matches: 72, winner: true, topscorer: true, paid: true, points: 115 },
  { name: "Martijnmeestervoorspeller", matches: 72, winner: true, topscorer: true, paid: true, points: 400 },
  { name: "Crazy Dutchman", matches: 72, winner: true, topscorer: true, paid: true, points: 400 },
  { name: "RoanTuit(messi)", matches: 7, winner: true, topscorer: true, paid: true, points: 220 },
  { name: "Christopheramboz", matches: 9, winner: true, topscorer: true, paid: true, points: 400 },
