...
window.POOL_META = {
  ...
  totalPlayers: 53,
  capacityMax: 75,
  syncedAt: "2026-06-11T18:10:04.913Z",
...
window.POOL_PLAYERS = [
  { name: "Wolsman", matches: 104, winner: true, topscorer: true, paid: true, points: 0 },
  ...
  { name: "BornBjorg", matches: 24, winner: true, topscorer: true, paid: true, points: 0 },
  { name: "Fseton", matches: 10, winner: true, topscorer: true, paid: true, points: 0 },
  { name: "Raymond de Haas", matches: 10, winner: true, topscorer: true, paid: true, points: 0 },
  ...
  { name: "Norman.P", matches: 1, winner: true, topscorer: true, paid: true, points: 0 },
  ...
  { name: "Jules-", matches: 72, winner: true, topscorer: true, paid: true, points: 0 },
  { name: "Harro1", matches: 72, winner: true, topscorer: true, paid: true, points: 0 },
  { name: "JRHJNB", matches: 72, winner: true, topscorer: true, paid: true, points: 0 },
  ...
  { name: "RoanTuit(messi)", matches: 0, winner: false, topscorer: false, paid: true, points: 0 },
