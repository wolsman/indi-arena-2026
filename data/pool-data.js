...
window.POOL_META = {
  ...
  totalPlayers: 52,
  capacityMax: 75,
  syncedAt: "2026-06-18T04:31:25.009Z",
...
window.POOL_PLAYERS = [
  ...
  { name: "Bertjuh", matches: 72, winner: true, topscorer: true, paid: true, points: 1465, prevPos: 26 },
  ...
  { name: "StudentjeIndicium", matches: 72, winner: true, topscorer: true, paid: true, points: 1565, prevPos: 19 },
  { name: "Mauricio1980", matches: 72, winner: true, topscorer: true, paid: true, points: 1415, prevPos: 29 },
  { name: "AlinevanVuuren", matches: 72, winner: true, topscorer: true, paid: true, points: 1505, prevPos: 14 },
  { name: "Wisselbeker", matches: 32, winner: true, topscorer: true, paid: true, points: 1805, prevPos: 4 },
  { name: "Robertosxs", matches: 104, winner: true, topscorer: true, paid: true, points: 1440, prevPos: 28 },
  { name: "Reboss", matches: 72, winner: true, topscorer: true, paid: true, points: 1150, prevPos: 45 },
  ...
  { name: "Katinkadeb", matches: 72, winner: true, topscorer: true, paid: true, points: 1550, prevPos: 20 },
  { name: "BornBjorg", matches: 24, winner: true, topscorer: true, paid: true, points: 1710, prevPos: 6 },
  { name: "Fseton", matches: 45, winner: true, topscorer: true, paid: true, points: 1445, prevPos: 27 },
  { name: "Raymond de Haas", matches: 29, winner: true, topscorer: true, paid: true, points: 1190, prevPos: 44 },
  { name: "THEGOAT37", matches: 45, winner: true, topscorer: true, paid: true, points: 1560, prevPos: 17 },
  { name: "WesleyMerwe", matches: 27, winner: true, topscorer: true, paid: true, points: 1220, prevPos: 43 },
  { name: "Daisy010", matches: 30, winner: true, topscorer: true, paid: true, points: 1515, prevPos: 31 },
  ...
  { name: "JanvdL", matches: 24, winner: true, topscorer: true, paid: true, points: 1875, prevPos: 2 },
  { name: "Trauner_in_Oranje", matches: 24, winner: true, topscorer: true, paid: true, points: 1325, prevPos: 35 },
  { name: "Keepertje", matches: 72, winner: true, topscorer: true, paid: true, points: 1045, prevPos: 46 },
  { name: "John0504", matches: 72, winner: true, topscorer: true, paid: true, points: 1085, prevPos: 48 },
  { name: "Rugnummer67", matches: 25, winner: true, topscorer: true, paid: true, points: 1575, prevPos: 15 },
  ...
  { name: "GonnyDebode", matches: 72, winner: true, topscorer: true, paid: true, points: 1335, prevPos: 36 },
  ...
  { name: "Harro1", matches: 72, winner: true, topscorer: true, paid: true, points: 1265, prevPos: 42 },
  { name: "JRHJNB", matches: 72, winner: true, topscorer: true, paid: true, points: 1355, prevPos: 34 },
  { name: "JoycevanRiet", matches: 72, winner: true, topscorer: true, paid: true, points: 1200, prevPos: 40 },
  { name: "Heer", matches: 72, winner: true, topscorer: true, paid: true, points: 1590, prevPos: 13 },
  { name: "Cornelis2026", matches: 42, winner: true, topscorer: true, paid: true, points: 1225, prevPos: 46 },
  { name: "Wkkipje", matches: 19, winner: true, topscorer: true, paid: true, points: 1410, prevPos: 25 },
  { name: "MaureenGLA", matches: 72, winner: true, topscorer: true, paid: true, points: 1425, prevPos: 30 },
  { name: "GeorgeV.", matches: 72, winner: true, topscorer: true, paid: true, points: 1715, prevPos: 5 },
  { name: "ikgajuichen", matches: 104, winner: true, topscorer: true, paid: true, points: 1665, prevPos: 10 },
  { name: "JanCandiano", matches: 72, winner: true, topscorer: true, paid: true, points: 1530, prevPos: 22 },
  { name: "Bo.", matches: 72, winner: true, topscorer: true, paid: true, points: 1020, prevPos: 50 },
  { name: "Koninkie", matches: 72, winner: true, topscorer: true, paid: true, points: 1575, prevPos: 18 },
  { name: "Martijnmeestervoorspeller", matches: 72, winner: true, topscorer: true, paid: true, points: 1825, prevPos: 7 },
  ...
  { name: "WillemCo", matches: 30, winner: false, topscorer: false, paid: true, points: 1420, prevPos: 24 },
