...
window.POOL_META = {
  ...
  totalPlayers: 56,
  capacityMax: 75,
  syncedAt: "2026-06-15T05:01:22.684Z",
...
window.POOL_PLAYERS = [
  { name: "Wolsman", matches: 104, winner: true, topscorer: true, paid: true, points: 850, prevPos: 8 },
  { name: "Kleine Flo", matches: 72, winner: true, topscorer: true, paid: true, points: 565, prevPos: 39 },
  { name: "Bertjuh", matches: 72, winner: true, topscorer: true, paid: true, points: 670, prevPos: 16 },
  { name: "Bobcorn", matches: 72, winner: true, topscorer: true, paid: true, points: 570, prevPos: 38 },
  { name: "UedaTopscorer", matches: 72, winner: true, topscorer: true, paid: true, points: 490, prevPos: 47 },
  { name: "Oppie1978", matches: 24, winner: true, topscorer: true, paid: true, points: 695, prevPos: 26 },
  { name: "El-Toro-Loco", matches: 11, winner: false, topscorer: false, paid: true, points: 650, prevPos: 20 },
  { name: "StudentjeIndicium", matches: 72, winner: true, topscorer: true, paid: true, points: 825, prevPos: 14 },
  { name: "Mauricio1980", matches: 72, winner: true, topscorer: true, paid: true, points: 565, prevPos: 30 },
  { name: "AlinevanVuuren", matches: 72, winner: true, topscorer: true, paid: true, points: 805, prevPos: 36 },
  { name: "Wisselbeker", matches: 26, winner: true, topscorer: true, paid: true, points: 885, prevPos: 11 },
  { name: "Roantuit", matches: 0, winner: false, topscorer: false, paid: true, points: 0, prevPos: 51 },
  { name: "Robertosxs", matches: 104, winner: true, topscorer: true, paid: true, points: 745, prevPos: 16 },
  { name: "Reboss", matches: 72, winner: true, topscorer: true, paid: true, points: 620, prevPos: 33 },
  { name: "Mobicontrol", matches: 53, winner: true, topscorer: true, paid: true, points: 760, prevPos: 23 },
  { name: "Brokkenpiloot", matches: 24, winner: true, topscorer: true, paid: true, points: 675, prevPos: 29 },
  { name: "Katinkadeb", matches: 72, winner: true, topscorer: true, paid: true, points: 565, prevPos: 39 },
  { name: "BornBjorg", matches: 24, winner: true, topscorer: true, paid: true, points: 980, prevPos: 3 },
  { name: "Fseton", matches: 24, winner: true, topscorer: true, paid: true, points: 695, prevPos: 30 },
  { name: "Raymond de Haas", matches: 14, winner: true, topscorer: true, paid: true, points: 460, prevPos: 46 },
  { name: "ScheidsTon", matches: 0, winner: false, topscorer: false, paid: true, points: 0, prevPos: 51 },
  { name: "THEGOAT37", matches: 31, winner: true, topscorer: true, paid: true, points: 690, prevPos: 16 },
  { name: "WesleyMerwe", matches: 27, winner: true, topscorer: true, paid: true, points: 575, prevPos: 42 },
  { name: "Daisy010", matches: 26, winner: true, topscorer: true, paid: true, points: 640, prevPos: 48 },
  { name: "Erol_Ulu", matches: 72, winner: true, topscorer: true, paid: true, points: 980, prevPos: 3 },
  { name: "Givano", matches: 72, winner: true, topscorer: true, paid: true, points: 610, prevPos: 44 },
  { name: "VanderLans", matches: 15, winner: true, topscorer: true, paid: true, points: 980, prevPos: 5 },
  { name: "Trauner_in_Oranje", matches: 12, winner: true, topscorer: true, paid: true, points: 735, prevPos: 22 },
  { name: "Keepertje", matches: 72, winner: true, topscorer: true, paid: true, points: 460, prevPos: 50 },
  { name: "John0504", matches: 72, winner: true, topscorer: true, paid: true, points: 475, prevPos: 49 },
  { name: "Rugnummer67", matches: 16, winner: true, topscorer: true, paid: true, points: 555, prevPos: 42 },
  { name: "Norman.P", matches: 13, winner: true, topscorer: true, paid: true, points: 1135, prevPos: 1 },
  { name: "StanleyBoessen", matches: 72, winner: false, topscorer: false, paid: true, points: 705, prevPos: 15 },
  { name: "GonnyDebode", matches: 72, winner: true, topscorer: true, paid: true, points: 600, prevPos: 33 },
  { name: "Marlayne", matches: 33, winner: true, topscorer: true, paid: true, points: 645, prevPos: 28 },
  { name: "Jules-", matches: 72, winner: true, topscorer: true, paid: true, points: 640, prevPos: 30 },
  { name: "Harro1", matches: 72, winner: true, topscorer: true, paid: true, points: 650, prevPos: 23 },
  { name: "JRHJNB", matches: 72, winner: true, topscorer: true, paid: true, points: 700, prevPos: 21 },
  { name: "JoycevanRiet", matches: 72, winner: true, topscorer: true, paid: true, points: 0, prevPos: 51 },
  { name: "Heer", matches: 72, winner: true, topscorer: true, paid: true, points: 775, prevPos: 13 },
  { name: "Pepijndh", matches: 0, winner: false, topscorer: false, paid: true, points: 0, prevPos: 51 },
  { name: "Cornelis2026", matches: 29, winner: true, topscorer: true, paid: true, points: 505, prevPos: 37 },
  { name: "Wkkipje", matches: 19, winner: true, topscorer: true, paid: true, points: 740, prevPos: 19 },
  { name: "MaureenGLA", matches: 72, winner: true, topscorer: true, paid: true, points: 695, prevPos: 26 },
  { name: "GeorgeV.", matches: 72, winner: true, topscorer: true, paid: true, points: 1080, prevPos: 10 },
  { name: "ikgajuichen", matches: 104, winner: true, topscorer: true, paid: true, points: 905, prevPos: 8 },
  { name: "JanCandiano", matches: 72, winner: true, topscorer: true, paid: true, points: 585, prevPos: 45 },
  { name: "Bo.", matches: 72, winner: true, topscorer: true, paid: true, points: 545, prevPos: 33 },
  { name: "Koninkie", matches: 72, winner: true, topscorer: true, paid: true, points: 865, prevPos: 12 },
  { name: "Martijnmeestervoorspeller", matches: 72, winner: true, topscorer: true, paid: true, points: 920, prevPos: 6 },
  { name: "Crazy Dutchman", matches: 72, winner: true, topscorer: true, paid: true, points: 920, prevPos: 6 },
  { name: "RoanTuit(messi)", matches: 13, winner: true, topscorer: true, paid: true, points: 700, prevPos: 25 },
  { name: "Christopheramboz", matches: 17, winner: true, topscorer: true, paid: true, points: 1025, prevPos: 2 },
  { name: "Frenk010fr", matches: 0, winner: false, topscorer: false, paid: true, points: 0, prevPos: 51 },
  { name: "WillemCo", matches: 13, winner: false, topscorer: false, paid: true, points: 740, prevPos: 41 },
