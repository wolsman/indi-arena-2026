...
window.POOL_META = {
  ...
  totalPlayers: 52,
  capacityMax: 75,
  syncedAt: "2026-06-18T18:31:33.347Z",
...
window.POOL_PLAYERS = [
  { name: "Wolsman", matches: 104, winner: true, topscorer: true, paid: true, points: 1525, prevPos: 21 },
  { name: "Kleine Flo", matches: 72, winner: true, topscorer: true, paid: true, points: 1295, prevPos: 37 },
  { name: "Bertjuh", matches: 72, winner: true, topscorer: true, paid: true, points: 1465, prevPos: 25 },
  { name: "Bobcorn", matches: 72, winner: true, topscorer: true, paid: true, points: 1565, prevPos: 33 },
  { name: "UedaTopscorer", matches: 72, winner: true, topscorer: true, paid: true, points: 1060, prevPos: 49 },
  { name: "Oppie1978", matches: 37, winner: true, topscorer: true, paid: true, points: 1830, prevPos: 12 },
  ...
  { name: "Mauricio1980", matches: 72, winner: true, topscorer: true, paid: true, points: 1435, prevPos: 30 },
  { name: "AlinevanVuuren", matches: 72, winner: true, topscorer: true, paid: true, points: 1525, prevPos: 23 },
  { name: "Wisselbeker", matches: 32, winner: true, topscorer: true, paid: true, points: 1825, prevPos: 5 },
  { name: "Robertosxs", matches: 104, winner: true, topscorer: true, paid: true, points: 1540, prevPos: 27 },
  { name: "Reboss", matches: 72, winner: true, topscorer: true, paid: true, points: 1170, prevPos: 46 },
  { name: "Mobicontrol-Xavier", matches: 53, winner: true, topscorer: true, paid: true, points: 1570, prevPos: 16 },
  { name: "Brokkenpiloot", matches: 53, winner: true, topscorer: true, paid: true, points: 1705, prevPos: 23 },
  { name: "Katinkadeb", matches: 72, winner: true, topscorer: true, paid: true, points: 1570, prevPos: 19 },
  { name: "BornBjorg", matches: 24, winner: true, topscorer: true, paid: true, points: 1710, prevPos: 7 },
  { name: "Fseton", matches: 45, winner: true, topscorer: true, paid: true, points: 1445, prevPos: 26 },
  { name: "Raymond de Haas", matches: 42, winner: true, topscorer: true, paid: true, points: 1390, prevPos: 45 },
  { name: "THEGOAT37", matches: 45, winner: true, topscorer: true, paid: true, points: 1560, prevPos: 18 },
  { name: "WesleyMerwe", matches: 31, winner: true, topscorer: true, paid: true, points: 1220, prevPos: 43 },
  { name: "Daisy010", matches: 40, winner: true, topscorer: true, paid: true, points: 1535, prevPos: 22 },
  { name: "Erol_Ulu", matches: 72, winner: true, topscorer: true, paid: true, points: 1850, prevPos: 3 },
  { name: "Givano", matches: 72, winner: true, topscorer: true, paid: true, points: 1905, prevPos: 8 },
  { name: "JanvdL", matches: 27, winner: true, topscorer: true, paid: true, points: 1895, prevPos: 2 },
  { name: "Trauner_in_Oranje", matches: 28, winner: true, topscorer: true, paid: true, points: 1345, prevPos: 36 },
  { name: "Keepertje", matches: 72, winner: true, topscorer: true, paid: true, points: 1045, prevPos: 48 },
  { name: "John0504", matches: 72, winner: true, topscorer: true, paid: true, points: 1105, prevPos: 47 },
  { name: "Rugnummer67", matches: 33, winner: true, topscorer: true, paid: true, points: 1775, prevPos: 14 },
  { name: "Norman.P", matches: 26, winner: true, topscorer: true, paid: true, points: 1665, prevPos: 9 },
  { name: "StanleyBoessen", matches: 72, winner: false, topscorer: false, paid: true, points: 1465, prevPos: 39 },
  { name: "GonnyDebode", matches: 72, winner: true, topscorer: true, paid: true, points: 1335, prevPos: 35 },
  { name: "Marlayne", matches: 37, winner: true, topscorer: true, paid: true, points: 1270, prevPos: 41 },
  { name: "Jules-", matches: 72, winner: true, topscorer: true, paid: true, points: 1370, prevPos: 32 },
  { name: "Harro1", matches: 72, winner: true, topscorer: true, paid: true, points: 1285, prevPos: 39 },
  { name: "JRHJNB", matches: 72, winner: true, topscorer: true, paid: true, points: 1375, prevPos: 34 },
  { name: "JoycevanRiet", matches: 72, winner: true, topscorer: true, paid: true, points: 1220, prevPos: 44 },
  { name: "Heer", matches: 72, winner: true, topscorer: true, paid: true, points: 1690, prevPos: 13 },
  { name: "Cornelis2026", matches: 42, winner: true, topscorer: true, paid: true, points: 1325, prevPos: 42 },
  { name: "Wkkipje", matches: 24, winner: true, topscorer: true, paid: true, points: 1510, prevPos: 31 },
  { name: "MaureenGLA", matches: 72, winner: true, topscorer: true, paid: true, points: 1425, prevPos: 28 },
  { name: "GeorgeV.", matches: 72, winner: true, topscorer: true, paid: true, points: 1915, prevPos: 6 },
  { name: "ikgajuichen", matches: 104, winner: true, topscorer: true, paid: true, points: 1865, prevPos: 9 },
  { name: "JanCandiano", matches: 72, winner: true, topscorer: true, paid: true, points: 1550, prevPos: 20 },
  { name: "Bo.", matches: 72, winner: true, topscorer: true, paid: true, points: 1220, prevPos: 50 },
  { name: "Koninkie", matches: 72, winner: true, topscorer: true, paid: true, points: 1775, prevPos: 14 },
  { name: "Martijnmeestervoorspeller", matches: 72, winner: true, topscorer: true, paid: true, points: 1845, prevPos: 4 },
  { name: "Crazy Dutchman", matches: 72, winner: true, topscorer: true, paid: true, points: 2195, prevPos: 1 },
  { name: "RoanTuit(messi)", matches: 23, winner: true, topscorer: true, paid: true, points: 1290, prevPos: 38 },
  { name: "Christopheramboz", matches: 34, winner: true, topscorer: true, paid: true, points: 1660, prevPos: 11 },
  { name: "WillemCo", matches: 30, winner: false, topscorer: false, paid: true, points: 1420, prevPos: 29 },
